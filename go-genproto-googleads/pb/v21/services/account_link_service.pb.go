...
var file_google_ads_googleads_v21_services_account_link_service_proto_rawDesc = []byte{
...
var (
	...
	file_google_ads_googleads_v21_services_account_link_service_proto_rawDescData = file_google_ads_googleads_v21_services_account_link_service_proto_rawDesc
)
...
func file_google_ads_googleads_v21_services_account_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_account_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_account_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v21_services_account_link_service_proto_rawDescData)
	})
...
func file_google_ads_googleads_v21_services_account_link_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v21_services_account_link_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_google_ads_googleads_v21_services_account_link_service_proto_rawDesc = nil
...
func (c *accountLinkServiceClient) CreateAccountLink(ctx context.Context, in *CreateAccountLinkRequest, opts ...grpc.CallOption) (*CreateAccountLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v21.services.AccountLinkService/CreateAccountLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountLinkServiceClient) MutateAccountLink(ctx context.Context, in *MutateAccountLinkRequest, opts ...grpc.CallOption) (*MutateAccountLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v21.services.AccountLinkService/MutateAccountLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AccountLinkService_CreateAccountLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v21.services.AccountLinkService/CreateAccountLink",
	}
...
func _AccountLinkService_MutateAccountLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v21.services.AccountLinkService/MutateAccountLink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
