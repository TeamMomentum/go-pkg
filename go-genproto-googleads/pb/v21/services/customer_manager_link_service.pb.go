...
var file_google_ads_googleads_v21_services_customer_manager_link_service_proto_rawDesc = []byte{
...
var (
	...
	file_google_ads_googleads_v21_services_customer_manager_link_service_proto_rawDescData = file_google_ads_googleads_v21_services_customer_manager_link_service_proto_rawDesc
)
...
func file_google_ads_googleads_v21_services_customer_manager_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_customer_manager_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_customer_manager_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v21_services_customer_manager_link_service_proto_rawDescData)
	})
...
func file_google_ads_googleads_v21_services_customer_manager_link_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v21_services_customer_manager_link_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_google_ads_googleads_v21_services_customer_manager_link_service_proto_rawDesc = nil
...
func (c *customerManagerLinkServiceClient) MutateCustomerManagerLink(ctx context.Context, in *MutateCustomerManagerLinkRequest, opts ...grpc.CallOption) (*MutateCustomerManagerLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v21.services.CustomerManagerLinkService/MutateCustomerManagerLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerManagerLinkServiceClient) MoveManagerLink(ctx context.Context, in *MoveManagerLinkRequest, opts ...grpc.CallOption) (*MoveManagerLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v21.services.CustomerManagerLinkService/MoveManagerLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerManagerLinkService_MutateCustomerManagerLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v21.services.CustomerManagerLinkService/MutateCustomerManagerLink",
	}
...
func _CustomerManagerLinkService_MoveManagerLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v21.services.CustomerManagerLinkService/MoveManagerLink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
