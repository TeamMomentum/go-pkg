...
var file_google_ads_googleads_v21_services_conversion_upload_service_proto_rawDesc = []byte{
...
var (
	...
	file_google_ads_googleads_v21_services_conversion_upload_service_proto_rawDescData = file_google_ads_googleads_v21_services_conversion_upload_service_proto_rawDesc
)
...
func file_google_ads_googleads_v21_services_conversion_upload_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_conversion_upload_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_conversion_upload_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v21_services_conversion_upload_service_proto_rawDescData)
	})
...
func file_google_ads_googleads_v21_services_conversion_upload_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v21_services_conversion_upload_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_google_ads_googleads_v21_services_conversion_upload_service_proto_rawDesc = nil
...
func (c *conversionUploadServiceClient) UploadClickConversions(ctx context.Context, in *UploadClickConversionsRequest, opts ...grpc.CallOption) (*UploadClickConversionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v21.services.ConversionUploadService/UploadClickConversions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *conversionUploadServiceClient) UploadCallConversions(ctx context.Context, in *UploadCallConversionsRequest, opts ...grpc.CallOption) (*UploadCallConversionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v21.services.ConversionUploadService/UploadCallConversions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConversionUploadService_UploadClickConversions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v21.services.ConversionUploadService/UploadClickConversions",
	}
...
func _ConversionUploadService_UploadCallConversions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v21.services.ConversionUploadService/UploadCallConversions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
