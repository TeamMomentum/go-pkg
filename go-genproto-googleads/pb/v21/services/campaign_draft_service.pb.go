...
var file_google_ads_googleads_v21_services_campaign_draft_service_proto_rawDesc = []byte{
...
var (
	...
	file_google_ads_googleads_v21_services_campaign_draft_service_proto_rawDescData = file_google_ads_googleads_v21_services_campaign_draft_service_proto_rawDesc
)
...
func file_google_ads_googleads_v21_services_campaign_draft_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v21_services_campaign_draft_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v21_services_campaign_draft_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v21_services_campaign_draft_service_proto_rawDescData)
	})
...
func file_google_ads_googleads_v21_services_campaign_draft_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v21_services_campaign_draft_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_google_ads_googleads_v21_services_campaign_draft_service_proto_rawDesc = nil
...
func (c *campaignDraftServiceClient) MutateCampaignDrafts(ctx context.Context, in *MutateCampaignDraftsRequest, opts ...grpc.CallOption) (*MutateCampaignDraftsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v21.services.CampaignDraftService/MutateCampaignDrafts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campaignDraftServiceClient) PromoteCampaignDraft(ctx context.Context, in *PromoteCampaignDraftRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v21.services.CampaignDraftService/PromoteCampaignDraft", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *campaignDraftServiceClient) ListCampaignDraftAsyncErrors(ctx context.Context, in *ListCampaignDraftAsyncErrorsRequest, opts ...grpc.CallOption) (*ListCampaignDraftAsyncErrorsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v21.services.CampaignDraftService/ListCampaignDraftAsyncErrors", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignDraftService_MutateCampaignDrafts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v21.services.CampaignDraftService/MutateCampaignDrafts",
	}
...
func _CampaignDraftService_PromoteCampaignDraft_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v21.services.CampaignDraftService/PromoteCampaignDraft",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CampaignDraftService_ListCampaignDraftAsyncErrors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v21.services.CampaignDraftService/ListCampaignDraftAsyncErrors",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
