...
func (x *ProductLink) Reset() {
	*x = ProductLink{}
	mi := &file_google_ads_googleads_v18_resources_product_link_proto_msgTypes[0]
...
func (*ProductLink) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v18_resources_product_link_proto_rawDescGZIP(), []int{0}
}
...
func (x *DataPartnerIdentifier) Reset() {
	*x = DataPartnerIdentifier{}
	mi := &file_google_ads_googleads_v18_resources_product_link_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DataPartnerIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v18_resources_product_link_proto_rawDescGZIP(), []int{1}
}
...
func (x *GoogleAdsIdentifier) Reset() {
	*x = GoogleAdsIdentifier{}
	mi := &file_google_ads_googleads_v18_resources_product_link_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GoogleAdsIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v18_resources_product_link_proto_rawDescGZIP(), []int{2}
}
...
func (x *MerchantCenterIdentifier) Reset() {
	*x = MerchantCenterIdentifier{}
	mi := &file_google_ads_googleads_v18_resources_product_link_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MerchantCenterIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v18_resources_product_link_proto_rawDescGZIP(), []int{3}
}
...
func (x *AdvertisingPartnerIdentifier) Reset() {
	*x = AdvertisingPartnerIdentifier{}
	mi := &file_google_ads_googleads_v18_resources_product_link_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdvertisingPartnerIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v18_resources_product_link_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v18_resources_product_link_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v18_resources_product_link_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v18_resources_product_link_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v18_resources_product_link_proto_rawDescData = file_google_ads_googleads_v18_resources_product_link_proto_rawDesc
)

func file_google_ads_googleads_v18_resources_product_link_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v18_resources_product_link_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v18_resources_product_link_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v18_resources_product_link_proto_rawDescData)
	})
	return file_google_ads_googleads_v18_resources_product_link_proto_rawDescData
}

var file_google_ads_googleads_v18_resources_product_link_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v18_resources_product_link_proto_goTypes = []any{
...
var file_google_ads_googleads_v18_resources_product_link_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v18_resources_product_link_proto_init() }
func file_google_ads_googleads_v18_resources_product_link_proto_init() {
	if File_google_ads_googleads_v18_resources_product_link_proto != nil {
		return
	}
	file_google_ads_googleads_v18_resources_product_link_proto_msgTypes[0].OneofWrappers = []any{
		(*ProductLink_DataPartner)(nil),
		(*ProductLink_GoogleAds)(nil),
		(*ProductLink_MerchantCenter)(nil),
		(*ProductLink_AdvertisingPartner)(nil),
	}
	file_google_ads_googleads_v18_resources_product_link_proto_msgTypes[1].OneofWrappers = []any{}
	file_google_ads_googleads_v18_resources_product_link_proto_msgTypes[2].OneofWrappers = []any{}
	file_google_ads_googleads_v18_resources_product_link_proto_msgTypes[3].OneofWrappers = []any{}
	file_google_ads_googleads_v18_resources_product_link_proto_msgTypes[4].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v18_resources_product_link_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v18_resources_product_link_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v18_resources_product_link_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v18_resources_product_link_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v18_resources_product_link_proto = out.File
	file_google_ads_googleads_v18_resources_product_link_proto_rawDesc = nil
	file_google_ads_googleads_v18_resources_product_link_proto_goTypes = nil
	file_google_ads_googleads_v18_resources_product_link_proto_depIdxs = nil
}
