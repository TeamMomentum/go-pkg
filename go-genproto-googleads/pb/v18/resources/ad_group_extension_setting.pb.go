...
func (x *AdGroupExtensionSetting) Reset() {
	*x = AdGroupExtensionSetting{}
	mi := &file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_msgTypes[0]
...
func (*AdGroupExtensionSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v18_resources_ad_group_extension_setting_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDescData = file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDesc
)

func file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDescData)
	})
	return file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDescData
}

var file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_goTypes = []any{
...
var file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_init() }
func file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_init() {
	if File_google_ads_googleads_v18_resources_ad_group_extension_setting_proto != nil {
		return
	}
	file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v18_resources_ad_group_extension_setting_proto = out.File
	file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_rawDesc = nil
	file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_goTypes = nil
	file_google_ads_googleads_v18_resources_ad_group_extension_setting_proto_depIdxs = nil
}
