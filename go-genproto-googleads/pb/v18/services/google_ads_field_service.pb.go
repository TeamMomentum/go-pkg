...
func (x *GetGoogleAdsFieldRequest) Reset() {
	*x = GetGoogleAdsFieldRequest{}
	mi := &file_google_ads_googleads_v18_services_google_ads_field_service_proto_msgTypes[0]
...
func (*GetGoogleAdsFieldRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SearchGoogleAdsFieldsRequest) Reset() {
	*x = SearchGoogleAdsFieldsRequest{}
	mi := &file_google_ads_googleads_v18_services_google_ads_field_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchGoogleAdsFieldsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *SearchGoogleAdsFieldsResponse) Reset() {
	*x = SearchGoogleAdsFieldsResponse{}
	mi := &file_google_ads_googleads_v18_services_google_ads_field_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SearchGoogleAdsFieldsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v18_services_google_ads_field_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x3a, 0x01, 0x2a, 0x22, 0x1b, 0x2f, 0x76, 0x31, 0x38, 0x2f, 0x67, 0x6f, 0x6f, 0x67,
...
var (
	file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDescData = file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDesc
)

func file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDescData
}

var file_google_ads_googleads_v18_services_google_ads_field_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v18_services_google_ads_field_service_proto_goTypes = []any{
...
var file_google_ads_googleads_v18_services_google_ads_field_service_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v18_services_google_ads_field_service_proto_init() }
func file_google_ads_googleads_v18_services_google_ads_field_service_proto_init() {
	if File_google_ads_googleads_v18_services_google_ads_field_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v18_services_google_ads_field_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v18_services_google_ads_field_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v18_services_google_ads_field_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v18_services_google_ads_field_service_proto = out.File
	file_google_ads_googleads_v18_services_google_ads_field_service_proto_rawDesc = nil
	file_google_ads_googleads_v18_services_google_ads_field_service_proto_goTypes = nil
	file_google_ads_googleads_v18_services_google_ads_field_service_proto_depIdxs = nil
}
