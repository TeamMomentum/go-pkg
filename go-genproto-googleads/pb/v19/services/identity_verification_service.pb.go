...
var file_google_ads_googleads_v19_services_identity_verification_service_proto_rawDesc = []byte{
...
var (
	...
	file_google_ads_googleads_v19_services_identity_verification_service_proto_rawDescData = file_google_ads_googleads_v19_services_identity_verification_service_proto_rawDesc
)
...
func file_google_ads_googleads_v19_services_identity_verification_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_services_identity_verification_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_services_identity_verification_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v19_services_identity_verification_service_proto_rawDescData)
	})
...
func file_google_ads_googleads_v19_services_identity_verification_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v19_services_identity_verification_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_google_ads_googleads_v19_services_identity_verification_service_proto_rawDesc = nil
...
func (c *identityVerificationServiceClient) StartIdentityVerification(ctx context.Context, in *StartIdentityVerificationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v19.services.IdentityVerificationService/StartIdentityVerification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityVerificationServiceClient) GetIdentityVerification(ctx context.Context, in *GetIdentityVerificationRequest, opts ...grpc.CallOption) (*GetIdentityVerificationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v19.services.IdentityVerificationService/GetIdentityVerification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _IdentityVerificationService_StartIdentityVerification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v19.services.IdentityVerificationService/StartIdentityVerification",
	}
...
func _IdentityVerificationService_GetIdentityVerification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v19.services.IdentityVerificationService/GetIdentityVerification",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
