...
var file_google_ads_googleads_v19_services_local_services_lead_service_proto_rawDesc = []byte{
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x48, 0x3a, 0x01, 0x2a, 0x22, 0x43, 0x2f, 0x76, 0x31, 0x39, 0x2f,
...
var (
	...
	file_google_ads_googleads_v19_services_local_services_lead_service_proto_rawDescData = file_google_ads_googleads_v19_services_local_services_lead_service_proto_rawDesc
)
...
func file_google_ads_googleads_v19_services_local_services_lead_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v19_services_local_services_lead_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v19_services_local_services_lead_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v19_services_local_services_lead_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v19_services_local_services_lead_service_proto_rawDescData
}

var file_google_ads_googleads_v19_services_local_services_lead_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_google_ads_googleads_v19_services_local_services_lead_service_proto_depIdxs = []int32{
	...
	4, // 2: google.ads.googleads.v19.services.ConversationOrError.partial_failure_error:type_name -> google.rpc.Status
	0, // 3: google.ads.googleads.v19.services.LocalServicesLeadService.AppendLeadConversation:input_type -> google.ads.googleads.v19.services.AppendLeadConversationRequest
	1, // 4: google.ads.googleads.v19.services.LocalServicesLeadService.AppendLeadConversation:output_type -> google.ads.googleads.v19.services.AppendLeadConversationResponse
...
func file_google_ads_googleads_v19_services_local_services_lead_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v19_services_local_services_lead_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_google_ads_googleads_v19_services_local_services_lead_service_proto_rawDesc = nil
...
func (c *localServicesLeadServiceClient) AppendLeadConversation(ctx context.Context, in *AppendLeadConversationRequest, opts ...grpc.CallOption) (*AppendLeadConversationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v19.services.LocalServicesLeadService/AppendLeadConversation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LocalServicesLeadService_AppendLeadConversation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v19.services.LocalServicesLeadService/AppendLeadConversation",
	}
