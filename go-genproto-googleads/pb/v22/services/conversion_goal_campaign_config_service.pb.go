...
func (x *MutateConversionGoalCampaignConfigsRequest) Reset() {
	*x = MutateConversionGoalCampaignConfigsRequest{}
	mi := &file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_msgTypes[0]
...
func (*MutateConversionGoalCampaignConfigsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConversionGoalCampaignConfigOperation) Reset() {
	*x = ConversionGoalCampaignConfigOperation{}
	mi := &file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionGoalCampaignConfigOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateConversionGoalCampaignConfigsResponse) Reset() {
	*x = MutateConversionGoalCampaignConfigsResponse{}
	mi := &file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateConversionGoalCampaignConfigsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateConversionGoalCampaignConfigResult) Reset() {
	*x = MutateConversionGoalCampaignConfigResult{}
	mi := &file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateConversionGoalCampaignConfigResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDescData = file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDesc
)

func file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDescData
}

var file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_goTypes = []any{
...
var file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_depIdxs = []int32{
...
func file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_init() {
	if File_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto != nil {
		return
	}
	file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_goTypes,
	...
	File_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto = out.File
	file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_rawDesc = nil
	file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_goTypes = nil
	file_google_ads_googleads_v22_services_conversion_goal_campaign_config_service_proto_depIdxs = nil
}
...
func (c *conversionGoalCampaignConfigServiceClient) MutateConversionGoalCampaignConfigs(ctx context.Context, in *MutateConversionGoalCampaignConfigsRequest, opts ...grpc.CallOption) (*MutateConversionGoalCampaignConfigsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v22.services.ConversionGoalCampaignConfigService/MutateConversionGoalCampaignConfigs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConversionGoalCampaignConfigService_MutateConversionGoalCampaignConfigs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v22.services.ConversionGoalCampaignConfigService/MutateConversionGoalCampaignConfigs",
	}
