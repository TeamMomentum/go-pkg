...
func (x *UploadUserDataRequest) Reset() {
	*x = UploadUserDataRequest{}
	mi := &file_google_ads_googleads_v22_services_user_data_service_proto_msgTypes[0]
...
func (*UploadUserDataRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_user_data_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *UserDataOperation) Reset() {
	*x = UserDataOperation{}
	mi := &file_google_ads_googleads_v22_services_user_data_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserDataOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_user_data_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *UploadUserDataResponse) Reset() {
	*x = UploadUserDataResponse{}
	mi := &file_google_ads_googleads_v22_services_user_data_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UploadUserDataResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_user_data_service_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v22_services_user_data_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v22_services_user_data_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v22_services_user_data_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v22_services_user_data_service_proto_rawDescData = file_google_ads_googleads_v22_services_user_data_service_proto_rawDesc
)

func file_google_ads_googleads_v22_services_user_data_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v22_services_user_data_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v22_services_user_data_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v22_services_user_data_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v22_services_user_data_service_proto_rawDescData
}

var file_google_ads_googleads_v22_services_user_data_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v22_services_user_data_service_proto_goTypes = []any{
...
var file_google_ads_googleads_v22_services_user_data_service_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v22_services_user_data_service_proto_init() }
func file_google_ads_googleads_v22_services_user_data_service_proto_init() {
	if File_google_ads_googleads_v22_services_user_data_service_proto != nil {
		return
	}
	file_google_ads_googleads_v22_services_user_data_service_proto_msgTypes[0].OneofWrappers = []any{
		(*UploadUserDataRequest_CustomerMatchUserListMetadata)(nil),
	}
	file_google_ads_googleads_v22_services_user_data_service_proto_msgTypes[1].OneofWrappers = []any{
		(*UserDataOperation_Create)(nil),
		(*UserDataOperation_Remove)(nil),
	}
	file_google_ads_googleads_v22_services_user_data_service_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v22_services_user_data_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v22_services_user_data_service_proto_goTypes,
	...
	File_google_ads_googleads_v22_services_user_data_service_proto = out.File
	file_google_ads_googleads_v22_services_user_data_service_proto_rawDesc = nil
	file_google_ads_googleads_v22_services_user_data_service_proto_goTypes = nil
	file_google_ads_googleads_v22_services_user_data_service_proto_depIdxs = nil
}
...
func (c *userDataServiceClient) UploadUserData(ctx context.Context, in *UploadUserDataRequest, opts ...grpc.CallOption) (*UploadUserDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v22.services.UserDataService/UploadUserData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserDataService_UploadUserData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v22.services.UserDataService/UploadUserData",
	}
