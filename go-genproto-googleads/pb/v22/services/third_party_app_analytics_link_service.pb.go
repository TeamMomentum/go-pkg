...
func (x *RegenerateShareableLinkIdRequest) Reset() {
	*x = RegenerateShareableLinkIdRequest{}
	mi := &file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_msgTypes[0]
...
func (*RegenerateShareableLinkIdRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *RegenerateShareableLinkIdResponse) Reset() {
	*x = RegenerateShareableLinkIdResponse{}
	mi := &file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegenerateShareableLinkIdResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDescGZIP(), []int{1}
}

var File_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDescData = file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDesc
)

func file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDescData
}

var file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_goTypes = []any{
...
var file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_depIdxs = []int32{
...
func file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_init() {
	if File_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		...
		DependencyIndexes: file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto = out.File
	file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_rawDesc = nil
	file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_goTypes = nil
	file_google_ads_googleads_v22_services_third_party_app_analytics_link_service_proto_depIdxs = nil
}
...
func (c *thirdPartyAppAnalyticsLinkServiceClient) RegenerateShareableLinkId(ctx context.Context, in *RegenerateShareableLinkIdRequest, opts ...grpc.CallOption) (*RegenerateShareableLinkIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v22.services.ThirdPartyAppAnalyticsLinkService/RegenerateShareableLinkId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ThirdPartyAppAnalyticsLinkService_RegenerateShareableLinkId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v22.services.ThirdPartyAppAnalyticsLinkService/RegenerateShareableLinkId",
	}
