...
func (x *SuggestBrandsRequest) Reset() {
	*x = SuggestBrandsRequest{}
	mi := &file_google_ads_googleads_v22_services_brand_suggestion_service_proto_msgTypes[0]
...
func (*SuggestBrandsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SuggestBrandsResponse) Reset() {
	*x = SuggestBrandsResponse{}
	mi := &file_google_ads_googleads_v22_services_brand_suggestion_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SuggestBrandsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *BrandSuggestion) Reset() {
	*x = BrandSuggestion{}
	mi := &file_google_ads_googleads_v22_services_brand_suggestion_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BrandSuggestion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v22_services_brand_suggestion_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDescData = file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDesc
)

func file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDescData
}

var file_google_ads_googleads_v22_services_brand_suggestion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v22_services_brand_suggestion_service_proto_goTypes = []any{
...
var file_google_ads_googleads_v22_services_brand_suggestion_service_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v22_services_brand_suggestion_service_proto_init() }
func file_google_ads_googleads_v22_services_brand_suggestion_service_proto_init() {
	if File_google_ads_googleads_v22_services_brand_suggestion_service_proto != nil {
		return
	}
	file_google_ads_googleads_v22_services_brand_suggestion_service_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		...
		DependencyIndexes: file_google_ads_googleads_v22_services_brand_suggestion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v22_services_brand_suggestion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v22_services_brand_suggestion_service_proto = out.File
	file_google_ads_googleads_v22_services_brand_suggestion_service_proto_rawDesc = nil
	file_google_ads_googleads_v22_services_brand_suggestion_service_proto_goTypes = nil
	file_google_ads_googleads_v22_services_brand_suggestion_service_proto_depIdxs = nil
}
...
func (c *brandSuggestionServiceClient) SuggestBrands(ctx context.Context, in *SuggestBrandsRequest, opts ...grpc.CallOption) (*SuggestBrandsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v22.services.BrandSuggestionService/SuggestBrands", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BrandSuggestionService_SuggestBrands_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v22.services.BrandSuggestionService/SuggestBrands",
	}
