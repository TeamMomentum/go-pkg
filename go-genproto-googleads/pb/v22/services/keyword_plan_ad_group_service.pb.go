...
func (x *MutateKeywordPlanAdGroupsRequest) Reset() {
	*x = MutateKeywordPlanAdGroupsRequest{}
	mi := &file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_msgTypes[0]
...
func (*MutateKeywordPlanAdGroupsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordPlanAdGroupOperation) Reset() {
	*x = KeywordPlanAdGroupOperation{}
	mi := &file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordPlanAdGroupOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateKeywordPlanAdGroupsResponse) Reset() {
	*x = MutateKeywordPlanAdGroupsResponse{}
	mi := &file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlanAdGroupsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateKeywordPlanAdGroupResult) Reset() {
	*x = MutateKeywordPlanAdGroupResult{}
	mi := &file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlanAdGroupResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDescData = file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDesc
)

func file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDescData
}

var file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_goTypes = []any{
...
var file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_init() }
func file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_init() {
	if File_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto != nil {
		return
	}
	file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto = out.File
	file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_rawDesc = nil
	file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_goTypes = nil
	file_google_ads_googleads_v22_services_keyword_plan_ad_group_service_proto_depIdxs = nil
}
...
func (c *keywordPlanAdGroupServiceClient) MutateKeywordPlanAdGroups(ctx context.Context, in *MutateKeywordPlanAdGroupsRequest, opts ...grpc.CallOption) (*MutateKeywordPlanAdGroupsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v22.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _KeywordPlanAdGroupService_MutateKeywordPlanAdGroups_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v22.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups",
	}
