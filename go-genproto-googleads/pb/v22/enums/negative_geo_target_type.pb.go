...
func (NegativeGeoTargetTypeEnum_NegativeGeoTargetType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_enumTypes[0].Descriptor()
}

func (NegativeGeoTargetTypeEnum_NegativeGeoTargetType) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_enumTypes[0]
}
...
func (NegativeGeoTargetTypeEnum_NegativeGeoTargetType) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *NegativeGeoTargetTypeEnum) Reset() {
	*x = NegativeGeoTargetTypeEnum{}
	mi := &file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_msgTypes[0]
...
func (*NegativeGeoTargetTypeEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v22_enums_negative_geo_target_type_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDescData = file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDesc
)

func file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDescData)
	})
	return file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDescData
}

var file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_goTypes = []any{
...
var file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_init() }
func file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_init() {
	if File_google_ads_googleads_v22_enums_negative_geo_target_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		...
		MessageInfos:      file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v22_enums_negative_geo_target_type_proto = out.File
	file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_rawDesc = nil
	file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_goTypes = nil
	file_google_ads_googleads_v22_enums_negative_geo_target_type_proto_depIdxs = nil
}
