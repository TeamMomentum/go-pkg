...
func (x *ProductLinkInvitation) Reset() {
	*x = ProductLinkInvitation{}
	mi := &file_google_ads_googleads_v22_resources_product_link_invitation_proto_msgTypes[0]
...
func (*ProductLinkInvitation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDescGZIP(), []int{0}
}
...
func (x *HotelCenterLinkInvitationIdentifier) Reset() {
	*x = HotelCenterLinkInvitationIdentifier{}
	mi := &file_google_ads_googleads_v22_resources_product_link_invitation_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HotelCenterLinkInvitationIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDescGZIP(), []int{1}
}
...
func (x *MerchantCenterLinkInvitationIdentifier) Reset() {
	*x = MerchantCenterLinkInvitationIdentifier{}
	mi := &file_google_ads_googleads_v22_resources_product_link_invitation_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MerchantCenterLinkInvitationIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDescGZIP(), []int{2}
}
...
func (x *AdvertisingPartnerLinkInvitationIdentifier) Reset() {
	*x = AdvertisingPartnerLinkInvitationIdentifier{}
	mi := &file_google_ads_googleads_v22_resources_product_link_invitation_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdvertisingPartnerLinkInvitationIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v22_resources_product_link_invitation_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDescData = file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDesc
)

func file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDescData)
	})
	return file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDescData
}

var file_google_ads_googleads_v22_resources_product_link_invitation_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v22_resources_product_link_invitation_proto_goTypes = []any{
...
var file_google_ads_googleads_v22_resources_product_link_invitation_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v22_resources_product_link_invitation_proto_init() }
func file_google_ads_googleads_v22_resources_product_link_invitation_proto_init() {
	if File_google_ads_googleads_v22_resources_product_link_invitation_proto != nil {
		return
	}
	file_google_ads_googleads_v22_resources_product_link_invitation_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_google_ads_googleads_v22_resources_product_link_invitation_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v22_resources_product_link_invitation_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v22_resources_product_link_invitation_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v22_resources_product_link_invitation_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v22_resources_product_link_invitation_proto = out.File
	file_google_ads_googleads_v22_resources_product_link_invitation_proto_rawDesc = nil
	file_google_ads_googleads_v22_resources_product_link_invitation_proto_goTypes = nil
	file_google_ads_googleads_v22_resources_product_link_invitation_proto_depIdxs = nil
}
