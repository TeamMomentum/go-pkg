...
var file_google_ads_googleads_v16_common_ad_asset_proto_goTypes = []any{
...
func file_google_ads_googleads_v16_common_ad_asset_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[0].OneofWrappers = []any{}
	file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[1].OneofWrappers = []any{}
	file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[2].OneofWrappers = []any{}
	file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[3].OneofWrappers = []any{}
	file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[4].OneofWrappers = []any{}
	file_google_ads_googleads_v16_common_ad_asset_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
