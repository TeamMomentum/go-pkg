...
var file_google_ads_googleads_v16_common_asset_set_types_proto_goTypes = []any{
...
func file_google_ads_googleads_v16_common_asset_set_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[9].Exporter = func(v any, i int) any {
	...
	file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[0].OneofWrappers = []any{
		(*LocationSet_BusinessProfileLocationSet)(nil),
		(*LocationSet_ChainLocationSet)(nil),
		(*LocationSet_MapsLocationSet)(nil),
	}
	file_google_ads_googleads_v16_common_asset_set_types_proto_msgTypes[7].OneofWrappers = []any{}
	type x struct{}
