...
func (x *ChangeStatus) Reset() {
	*x = ChangeStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v16_resources_change_status_proto_msgTypes[0]
...
func (*ChangeStatus) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v16_resources_change_status_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v16_resources_change_status_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v16_resources_change_status_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v16_resources_change_status_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v16_resources_change_status_proto_rawDescData = file_google_ads_googleads_v16_resources_change_status_proto_rawDesc
)

func file_google_ads_googleads_v16_resources_change_status_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v16_resources_change_status_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v16_resources_change_status_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v16_resources_change_status_proto_rawDescData)
	})
	return file_google_ads_googleads_v16_resources_change_status_proto_rawDescData
}

var file_google_ads_googleads_v16_resources_change_status_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v16_resources_change_status_proto_goTypes = []any{
...
var file_google_ads_googleads_v16_resources_change_status_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v16_resources_change_status_proto_init() }
func file_google_ads_googleads_v16_resources_change_status_proto_init() {
	if File_google_ads_googleads_v16_resources_change_status_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v16_resources_change_status_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_google_ads_googleads_v16_resources_change_status_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v16_resources_change_status_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v16_resources_change_status_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v16_resources_change_status_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v16_resources_change_status_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v16_resources_change_status_proto = out.File
	file_google_ads_googleads_v16_resources_change_status_proto_rawDesc = nil
	file_google_ads_googleads_v16_resources_change_status_proto_goTypes = nil
	file_google_ads_googleads_v16_resources_change_status_proto_depIdxs = nil
}
