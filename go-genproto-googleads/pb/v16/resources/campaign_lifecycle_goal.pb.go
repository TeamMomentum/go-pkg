...
func (x *CampaignLifecycleGoal) Reset() {
	*x = CampaignLifecycleGoal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_msgTypes[0]
...
func (*CampaignLifecycleGoal) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerAcquisitionGoalSettings) Reset() {
	*x = CustomerAcquisitionGoalSettings{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomerAcquisitionGoalSettings) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDescData = file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDesc
)

func file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDescData)
	})
	return file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDescData
}

var file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_goTypes = []any{
...
var file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_init() }
func file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_init() {
	if File_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_goTypes,
	...
	File_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto = out.File
	file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_rawDesc = nil
	file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_goTypes = nil
	file_google_ads_googleads_v16_resources_campaign_lifecycle_goal_proto_depIdxs = nil
}
