...
var file_google_ads_googleads_v16_enums_location_group_radius_units_proto_goTypes = []any{
...
func file_google_ads_googleads_v16_enums_location_group_radius_units_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v16_enums_location_group_radius_units_proto_msgTypes[0].Exporter = func(v any, i int) any {
