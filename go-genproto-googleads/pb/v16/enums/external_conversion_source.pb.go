...
var file_google_ads_googleads_v16_enums_external_conversion_source_proto_goTypes = []any{
...
func file_google_ads_googleads_v16_enums_external_conversion_source_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v16_enums_external_conversion_source_proto_msgTypes[0].Exporter = func(v any, i int) any {
