...
var file_google_ads_googleads_v20_common_custom_parameter_proto_rawDesc = []byte{
	...
	0x32, 0x30, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x22, 0x55, 0x0a, 0x0f, 0x43, 0x75, 0x73,
...
var (
	...
	file_google_ads_googleads_v20_common_custom_parameter_proto_rawDescData = file_google_ads_googleads_v20_common_custom_parameter_proto_rawDesc
)
...
func file_google_ads_googleads_v20_common_custom_parameter_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_common_custom_parameter_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_common_custom_parameter_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v20_common_custom_parameter_proto_rawDescData)
	})
...
func file_google_ads_googleads_v20_common_custom_parameter_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v20_common_custom_parameter_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_google_ads_googleads_v20_common_custom_parameter_proto_rawDesc = nil
