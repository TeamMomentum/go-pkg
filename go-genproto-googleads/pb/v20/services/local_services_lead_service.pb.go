...
var file_google_ads_googleads_v20_services_local_services_lead_service_proto_rawDesc = []byte{
...
var (
	...
	file_google_ads_googleads_v20_services_local_services_lead_service_proto_rawDescData = file_google_ads_googleads_v20_services_local_services_lead_service_proto_rawDesc
)
...
func file_google_ads_googleads_v20_services_local_services_lead_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_services_local_services_lead_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_services_local_services_lead_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v20_services_local_services_lead_service_proto_rawDescData)
	})
...
func file_google_ads_googleads_v20_services_local_services_lead_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v20_services_local_services_lead_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_google_ads_googleads_v20_services_local_services_lead_service_proto_rawDesc = nil
...
func (c *localServicesLeadServiceClient) AppendLeadConversation(ctx context.Context, in *AppendLeadConversationRequest, opts ...grpc.CallOption) (*AppendLeadConversationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v20.services.LocalServicesLeadService/AppendLeadConversation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localServicesLeadServiceClient) ProvideLeadFeedback(ctx context.Context, in *ProvideLeadFeedbackRequest, opts ...grpc.CallOption) (*ProvideLeadFeedbackResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v20.services.LocalServicesLeadService/ProvideLeadFeedback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LocalServicesLeadService_AppendLeadConversation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v20.services.LocalServicesLeadService/AppendLeadConversation",
	}
...
func _LocalServicesLeadService_ProvideLeadFeedback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v20.services.LocalServicesLeadService/ProvideLeadFeedback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
