...
var file_google_ads_googleads_v20_enums_product_channel_exclusivity_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x30, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1e, 0x50,
...
var (
	...
	file_google_ads_googleads_v20_enums_product_channel_exclusivity_proto_rawDescData = file_google_ads_googleads_v20_enums_product_channel_exclusivity_proto_rawDesc
)
...
func file_google_ads_googleads_v20_enums_product_channel_exclusivity_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v20_enums_product_channel_exclusivity_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v20_enums_product_channel_exclusivity_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v20_enums_product_channel_exclusivity_proto_rawDescData)
	})
...
func file_google_ads_googleads_v20_enums_product_channel_exclusivity_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v20_enums_product_channel_exclusivity_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_google_ads_googleads_v20_enums_product_channel_exclusivity_proto_rawDesc = nil
