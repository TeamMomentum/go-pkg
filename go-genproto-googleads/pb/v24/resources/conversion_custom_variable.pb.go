...
type ConversionCustomVariable struct {
	...
	Status enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v24.enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus" json:"status,omitempty"`
...
func (x *ConversionCustomVariable) Reset() {
	*x = ConversionCustomVariable{}
	mi := &file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_msgTypes[0]
...
func (*ConversionCustomVariable) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v24_resources_conversion_custom_variable_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDescData = file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_goTypes = []any{
	(*ConversionCustomVariable)(nil),                                             // 0: google.ads.googleads.v24.resources.ConversionCustomVariable
	(enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus)(0), // 1: google.ads.googleads.v24.enums.ConversionCustomVariableStatusEnum.ConversionCustomVariableStatus
}
var file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.ConversionCustomVariable.status:type_name -> google.ads.googleads.v24.enums.ConversionCustomVariableStatusEnum.ConversionCustomVariableStatus
...
func init() { file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_init() }
func file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_init() {
	if File_google_ads_googleads_v24_resources_conversion_custom_variable_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_conversion_custom_variable_proto = out.File
	file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_conversion_custom_variable_proto_depIdxs = nil
}
