...
func (x *SmartCampaignSetting) Reset() {
	*x = SmartCampaignSetting{}
	mi := &file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_msgTypes[0]
...
func (*SmartCampaignSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDescGZIP(), []int{0}
}
...
func (x *SmartCampaignSetting_PhoneNumber) Reset() {
	*x = SmartCampaignSetting_PhoneNumber{}
	mi := &file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SmartCampaignSetting_PhoneNumber) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SmartCampaignSetting_AdOptimizedBusinessProfileSetting) Reset() {
	*x = SmartCampaignSetting_AdOptimizedBusinessProfileSetting{}
	mi := &file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SmartCampaignSetting_AdOptimizedBusinessProfileSetting) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDescGZIP(), []int{0, 1}
}
...
var File_google_ads_googleads_v24_resources_smart_campaign_setting_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDescData = file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_goTypes = []any{
	(*SmartCampaignSetting)(nil),                                   // 0: google.ads.googleads.v24.resources.SmartCampaignSetting
	(*SmartCampaignSetting_PhoneNumber)(nil),                       // 1: google.ads.googleads.v24.resources.SmartCampaignSetting.PhoneNumber
	(*SmartCampaignSetting_AdOptimizedBusinessProfileSetting)(nil), // 2: google.ads.googleads.v24.resources.SmartCampaignSetting.AdOptimizedBusinessProfileSetting
}
var file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.SmartCampaignSetting.phone_number:type_name -> google.ads.googleads.v24.resources.SmartCampaignSetting.PhoneNumber
	2, // 1: google.ads.googleads.v24.resources.SmartCampaignSetting.ad_optimized_business_profile_setting:type_name -> google.ads.googleads.v24.resources.SmartCampaignSetting.AdOptimizedBusinessProfileSetting
...
func init() { file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_init() }
func file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_init() {
	if File_google_ads_googleads_v24_resources_smart_campaign_setting_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_msgTypes[1].OneofWrappers = []any{}
	file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_smart_campaign_setting_proto = out.File
	file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_smart_campaign_setting_proto_depIdxs = nil
}
