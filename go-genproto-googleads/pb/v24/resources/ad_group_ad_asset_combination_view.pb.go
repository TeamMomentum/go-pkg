...
func (x *AdGroupAdAssetCombinationView) Reset() {
	*x = AdGroupAdAssetCombinationView{}
	mi := &file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_msgTypes[0]
...
func (*AdGroupAdAssetCombinationView) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x22,
...
var (
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDescData = file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_goTypes = []any{
	(*AdGroupAdAssetCombinationView)(nil), // 0: google.ads.googleads.v24.resources.AdGroupAdAssetCombinationView
	(*common.AssetUsage)(nil),             // 1: google.ads.googleads.v24.common.AssetUsage
}
var file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.AdGroupAdAssetCombinationView.served_assets:type_name -> google.ads.googleads.v24.common.AssetUsage
...
func init() { file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_init() }
func file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_init() {
	if File_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto = out.File
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_combination_view_proto_depIdxs = nil
}
