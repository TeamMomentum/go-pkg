...
func (x *BiddingDataExclusion) Reset() {
	*x = BiddingDataExclusion{}
	mi := &file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_msgTypes[0]
...
func (*BiddingDataExclusion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v24_resources_bidding_data_exclusion_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDescData = file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_goTypes = []any{
	(*BiddingDataExclusion)(nil),                                 // 0: google.ads.googleads.v24.resources.BiddingDataExclusion
...
var file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.BiddingDataExclusion.scope:type_name -> google.ads.googleads.v24.enums.SeasonalityEventScopeEnum.SeasonalityEventScope
	2, // 1: google.ads.googleads.v24.resources.BiddingDataExclusion.status:type_name -> google.ads.googleads.v24.enums.SeasonalityEventStatusEnum.SeasonalityEventStatus
	3, // 2: google.ads.googleads.v24.resources.BiddingDataExclusion.devices:type_name -> google.ads.googleads.v24.enums.DeviceEnum.Device
	4, // 3: google.ads.googleads.v24.resources.BiddingDataExclusion.advertising_channel_types:type_name -> google.ads.googleads.v24.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType
...
func init() { file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_init() }
func file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_init() {
	if File_google_ads_googleads_v24_resources_bidding_data_exclusion_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_bidding_data_exclusion_proto = out.File
	file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_bidding_data_exclusion_proto_depIdxs = nil
}
