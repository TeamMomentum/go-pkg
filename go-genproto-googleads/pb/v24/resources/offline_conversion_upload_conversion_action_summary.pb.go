...
type OfflineConversionUploadConversionActionSummary struct {
	...
	// stats.
	Status enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v24.enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus" json:"status,omitempty"`
...
func (x *OfflineConversionUploadConversionActionSummary) Reset() {
	*x = OfflineConversionUploadConversionActionSummary{}
	mi := &file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_msgTypes[0]
...
func (*OfflineConversionUploadConversionActionSummary) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x34, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x6f, 0x66,
	...
	0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4f, 0x66, 0x66, 0x6c, 0x69, 0x6e,
...
var (
	file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescData = file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_goTypes = []any{
	(*OfflineConversionUploadConversionActionSummary)(nil),                             // 0: google.ads.googleads.v24.resources.OfflineConversionUploadConversionActionSummary
	(enums.OfflineEventUploadClientEnum_OfflineEventUploadClient)(0),                   // 1: google.ads.googleads.v24.enums.OfflineEventUploadClientEnum.OfflineEventUploadClient
	(enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus)(0), // 2: google.ads.googleads.v24.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus
	(*OfflineConversionSummary)(nil),                                                   // 3: google.ads.googleads.v24.resources.OfflineConversionSummary
	(*OfflineConversionAlert)(nil),                                                     // 4: google.ads.googleads.v24.resources.OfflineConversionAlert
}
var file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.OfflineConversionUploadConversionActionSummary.client:type_name -> google.ads.googleads.v24.enums.OfflineEventUploadClientEnum.OfflineEventUploadClient
	2, // 1: google.ads.googleads.v24.resources.OfflineConversionUploadConversionActionSummary.status:type_name -> google.ads.googleads.v24.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus
	3, // 2: google.ads.googleads.v24.resources.OfflineConversionUploadConversionActionSummary.daily_summaries:type_name -> google.ads.googleads.v24.resources.OfflineConversionSummary
	3, // 3: google.ads.googleads.v24.resources.OfflineConversionUploadConversionActionSummary.job_summaries:type_name -> google.ads.googleads.v24.resources.OfflineConversionSummary
	4, // 4: google.ads.googleads.v24.resources.OfflineConversionUploadConversionActionSummary.alerts:type_name -> google.ads.googleads.v24.resources.OfflineConversionAlert
...
func init() {
	file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_init()
}
func file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_init() {
	if File_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto = out.File
	file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_offline_conversion_upload_conversion_action_summary_proto_depIdxs = nil
}
