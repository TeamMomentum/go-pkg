...
type BillingSetup struct {
	...
	Status enums.BillingSetupStatusEnum_BillingSetupStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v24.enums.BillingSetupStatusEnum_BillingSetupStatus" json:"status,omitempty"`
...
func (x *BillingSetup) Reset() {
	*x = BillingSetup{}
	mi := &file_google_ads_googleads_v24_resources_billing_setup_proto_msgTypes[0]
...
func (*BillingSetup) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_billing_setup_proto_rawDescGZIP(), []int{0}
}
...
type BillingSetup_StartTimeType struct {
	...
	StartTimeType enums.TimeTypeEnum_TimeType `protobuf:"varint,10,opt,name=start_time_type,json=startTimeType,proto3,enum=google.ads.googleads.v24.enums.TimeTypeEnum_TimeType,oneof"`
}
...
type BillingSetup_EndTimeType struct {
	...
	EndTimeType enums.TimeTypeEnum_TimeType `protobuf:"varint,14,opt,name=end_time_type,json=endTimeType,proto3,enum=google.ads.googleads.v24.enums.TimeTypeEnum_TimeType,oneof"`
}
...
func (x *BillingSetup_PaymentsAccountInfo) Reset() {
	*x = BillingSetup_PaymentsAccountInfo{}
	mi := &file_google_ads_googleads_v24_resources_billing_setup_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BillingSetup_PaymentsAccountInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_billing_setup_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_google_ads_googleads_v24_resources_billing_setup_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_billing_setup_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x39, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x62, 0x69, 0x6c,
...
var (
	file_google_ads_googleads_v24_resources_billing_setup_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_billing_setup_proto_rawDescData = file_google_ads_googleads_v24_resources_billing_setup_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_billing_setup_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_billing_setup_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_billing_setup_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_billing_setup_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_billing_setup_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_billing_setup_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v24_resources_billing_setup_proto_goTypes = []any{
	(*BillingSetup)(nil),                                 // 0: google.ads.googleads.v24.resources.BillingSetup
	(*BillingSetup_PaymentsAccountInfo)(nil),             // 1: google.ads.googleads.v24.resources.BillingSetup.PaymentsAccountInfo
	(enums.BillingSetupStatusEnum_BillingSetupStatus)(0), // 2: google.ads.googleads.v24.enums.BillingSetupStatusEnum.BillingSetupStatus
	(enums.TimeTypeEnum_TimeType)(0),                     // 3: google.ads.googleads.v24.enums.TimeTypeEnum.TimeType
}
var file_google_ads_googleads_v24_resources_billing_setup_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v24.resources.BillingSetup.status:type_name -> google.ads.googleads.v24.enums.BillingSetupStatusEnum.BillingSetupStatus
	1, // 1: google.ads.googleads.v24.resources.BillingSetup.payments_account_info:type_name -> google.ads.googleads.v24.resources.BillingSetup.PaymentsAccountInfo
	3, // 2: google.ads.googleads.v24.resources.BillingSetup.start_time_type:type_name -> google.ads.googleads.v24.enums.TimeTypeEnum.TimeType
	3, // 3: google.ads.googleads.v24.resources.BillingSetup.end_time_type:type_name -> google.ads.googleads.v24.enums.TimeTypeEnum.TimeType
...
func init() { file_google_ads_googleads_v24_resources_billing_setup_proto_init() }
func file_google_ads_googleads_v24_resources_billing_setup_proto_init() {
	if File_google_ads_googleads_v24_resources_billing_setup_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_billing_setup_proto_msgTypes[0].OneofWrappers = []any{
		(*BillingSetup_StartDateTime)(nil),
		(*BillingSetup_StartTimeType)(nil),
		(*BillingSetup_EndDateTime)(nil),
		(*BillingSetup_EndTimeType)(nil),
	}
	file_google_ads_googleads_v24_resources_billing_setup_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_billing_setup_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_billing_setup_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_billing_setup_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_billing_setup_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_billing_setup_proto = out.File
	file_google_ads_googleads_v24_resources_billing_setup_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_billing_setup_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_billing_setup_proto_depIdxs = nil
}
