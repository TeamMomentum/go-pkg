...
type AdGroupBidModifier struct {
	...
	BidModifierSource enums.BidModifierSourceEnum_BidModifierSource `protobuf:"varint,10,opt,name=bid_modifier_source,json=bidModifierSource,proto3,enum=google.ads.googleads.v24.enums.BidModifierSourceEnum_BidModifierSource" json:"bid_modifier_source,omitempty"`
...
func (x *AdGroupBidModifier) Reset() {
	*x = AdGroupBidModifier{}
	mi := &file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_msgTypes[0]
...
func (*AdGroupBidModifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x42, 0x69, 0x64, 0x4d,
...
var (
	file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDescData = file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_goTypes = []any{
	(*AdGroupBidModifier)(nil),                         // 0: google.ads.googleads.v24.resources.AdGroupBidModifier
	(enums.BidModifierSourceEnum_BidModifierSource)(0), // 1: google.ads.googleads.v24.enums.BidModifierSourceEnum.BidModifierSource
	(*common.HotelDateSelectionTypeInfo)(nil),          // 2: google.ads.googleads.v24.common.HotelDateSelectionTypeInfo
	(*common.HotelAdvanceBookingWindowInfo)(nil),       // 3: google.ads.googleads.v24.common.HotelAdvanceBookingWindowInfo
	(*common.HotelLengthOfStayInfo)(nil),               // 4: google.ads.googleads.v24.common.HotelLengthOfStayInfo
	(*common.HotelCheckInDayInfo)(nil),                 // 5: google.ads.googleads.v24.common.HotelCheckInDayInfo
	(*common.DeviceInfo)(nil),                          // 6: google.ads.googleads.v24.common.DeviceInfo
	(*common.HotelCheckInDateRangeInfo)(nil),           // 7: google.ads.googleads.v24.common.HotelCheckInDateRangeInfo
}
var file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.AdGroupBidModifier.bid_modifier_source:type_name -> google.ads.googleads.v24.enums.BidModifierSourceEnum.BidModifierSource
	2, // 1: google.ads.googleads.v24.resources.AdGroupBidModifier.hotel_date_selection_type:type_name -> google.ads.googleads.v24.common.HotelDateSelectionTypeInfo
	3, // 2: google.ads.googleads.v24.resources.AdGroupBidModifier.hotel_advance_booking_window:type_name -> google.ads.googleads.v24.common.HotelAdvanceBookingWindowInfo
	4, // 3: google.ads.googleads.v24.resources.AdGroupBidModifier.hotel_length_of_stay:type_name -> google.ads.googleads.v24.common.HotelLengthOfStayInfo
	5, // 4: google.ads.googleads.v24.resources.AdGroupBidModifier.hotel_check_in_day:type_name -> google.ads.googleads.v24.common.HotelCheckInDayInfo
	6, // 5: google.ads.googleads.v24.resources.AdGroupBidModifier.device:type_name -> google.ads.googleads.v24.common.DeviceInfo
	7, // 6: google.ads.googleads.v24.resources.AdGroupBidModifier.hotel_check_in_date_range:type_name -> google.ads.googleads.v24.common.HotelCheckInDateRangeInfo
...
func init() { file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_init() }
func file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_init() {
	if File_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto = out.File
	file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_ad_group_bid_modifier_proto_depIdxs = nil
}
