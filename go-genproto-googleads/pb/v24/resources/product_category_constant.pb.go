...
type ProductCategoryConstant struct {
	...
	Level enums.ProductCategoryLevelEnum_ProductCategoryLevel `protobuf:"varint,4,opt,name=level,proto3,enum=google.ads.googleads.v24.enums.ProductCategoryLevelEnum_ProductCategoryLevel" json:"level,omitempty"`
	// Output only. State of the product category.
	State enums.ProductCategoryStateEnum_ProductCategoryState `protobuf:"varint,5,opt,name=state,proto3,enum=google.ads.googleads.v24.enums.ProductCategoryStateEnum_ProductCategoryState" json:"state,omitempty"`
...
func (x *ProductCategoryConstant) Reset() {
	*x = ProductCategoryConstant{}
	mi := &file_google_ads_googleads_v24_resources_product_category_constant_proto_msgTypes[0]
...
func (*ProductCategoryConstant) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDescGZIP(), []int{0}
}
...
func (x *ProductCategoryConstant_ProductCategoryLocalization) Reset() {
	*x = ProductCategoryConstant_ProductCategoryLocalization{}
	mi := &file_google_ads_googleads_v24_resources_product_category_constant_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProductCategoryConstant_ProductCategoryLocalization) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_google_ads_googleads_v24_resources_product_category_constant_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74,
...
var (
	file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDescData = file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_product_category_constant_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v24_resources_product_category_constant_proto_goTypes = []any{
	(*ProductCategoryConstant)(nil),                             // 0: google.ads.googleads.v24.resources.ProductCategoryConstant
	(*ProductCategoryConstant_ProductCategoryLocalization)(nil), // 1: google.ads.googleads.v24.resources.ProductCategoryConstant.ProductCategoryLocalization
	(enums.ProductCategoryLevelEnum_ProductCategoryLevel)(0),    // 2: google.ads.googleads.v24.enums.ProductCategoryLevelEnum.ProductCategoryLevel
	(enums.ProductCategoryStateEnum_ProductCategoryState)(0),    // 3: google.ads.googleads.v24.enums.ProductCategoryStateEnum.ProductCategoryState
}
var file_google_ads_googleads_v24_resources_product_category_constant_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v24.resources.ProductCategoryConstant.level:type_name -> google.ads.googleads.v24.enums.ProductCategoryLevelEnum.ProductCategoryLevel
	3, // 1: google.ads.googleads.v24.resources.ProductCategoryConstant.state:type_name -> google.ads.googleads.v24.enums.ProductCategoryStateEnum.ProductCategoryState
	1, // 2: google.ads.googleads.v24.resources.ProductCategoryConstant.localizations:type_name -> google.ads.googleads.v24.resources.ProductCategoryConstant.ProductCategoryLocalization
...
func init() { file_google_ads_googleads_v24_resources_product_category_constant_proto_init() }
func file_google_ads_googleads_v24_resources_product_category_constant_proto_init() {
	if File_google_ads_googleads_v24_resources_product_category_constant_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_product_category_constant_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_product_category_constant_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_product_category_constant_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_product_category_constant_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_product_category_constant_proto = out.File
	file_google_ads_googleads_v24_resources_product_category_constant_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_product_category_constant_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_product_category_constant_proto_depIdxs = nil
}
