...
type AssetSetTypeView struct {
	...
	AssetSetType enums.AssetSetTypeEnum_AssetSetType `protobuf:"varint,3,opt,name=asset_set_type,json=assetSetType,proto3,enum=google.ads.googleads.v24.enums.AssetSetTypeEnum_AssetSetType" json:"asset_set_type,omitempty"`
}

func (x *AssetSetTypeView) Reset() {
	*x = AssetSetTypeView{}
	mi := &file_google_ads_googleads_v24_resources_asset_set_type_view_proto_msgTypes[0]
...
func (*AssetSetTypeView) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v24_resources_asset_set_type_view_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDescData = file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_asset_set_type_view_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_asset_set_type_view_proto_goTypes = []any{
	(*AssetSetTypeView)(nil),                 // 0: google.ads.googleads.v24.resources.AssetSetTypeView
	(enums.AssetSetTypeEnum_AssetSetType)(0), // 1: google.ads.googleads.v24.enums.AssetSetTypeEnum.AssetSetType
}
var file_google_ads_googleads_v24_resources_asset_set_type_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.AssetSetTypeView.asset_set_type:type_name -> google.ads.googleads.v24.enums.AssetSetTypeEnum.AssetSetType
...
func init() { file_google_ads_googleads_v24_resources_asset_set_type_view_proto_init() }
func file_google_ads_googleads_v24_resources_asset_set_type_view_proto_init() {
	if File_google_ads_googleads_v24_resources_asset_set_type_view_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_asset_set_type_view_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_asset_set_type_view_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_asset_set_type_view_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_asset_set_type_view_proto = out.File
	file_google_ads_googleads_v24_resources_asset_set_type_view_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_asset_set_type_view_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_asset_set_type_view_proto_depIdxs = nil
}
