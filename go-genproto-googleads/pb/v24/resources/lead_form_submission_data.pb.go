...
func (x *LeadFormSubmissionData) Reset() {
	*x = LeadFormSubmissionData{}
	mi := &file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_msgTypes[0]
...
func (*LeadFormSubmissionData) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDescGZIP(), []int{0}
}
...
type LeadFormSubmissionField struct {
	...
	FieldType enums.LeadFormFieldUserInputTypeEnum_LeadFormFieldUserInputType `protobuf:"varint,1,opt,name=field_type,json=fieldType,proto3,enum=google.ads.googleads.v24.enums.LeadFormFieldUserInputTypeEnum_LeadFormFieldUserInputType" json:"field_type,omitempty"`
...
func (x *LeadFormSubmissionField) Reset() {
	*x = LeadFormSubmissionField{}
	mi := &file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LeadFormSubmissionField) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomLeadFormSubmissionField) Reset() {
	*x = CustomLeadFormSubmissionField{}
	mi := &file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomLeadFormSubmissionField) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v24_resources_lead_form_submission_data_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x65, 0x61, 0x64, 0x5f, 0x66, 0x6f,
...
var (
	file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDescData = file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_goTypes = []any{
	(*LeadFormSubmissionData)(nil),                                       // 0: google.ads.googleads.v24.resources.LeadFormSubmissionData
	(*LeadFormSubmissionField)(nil),                                      // 1: google.ads.googleads.v24.resources.LeadFormSubmissionField
	(*CustomLeadFormSubmissionField)(nil),                                // 2: google.ads.googleads.v24.resources.CustomLeadFormSubmissionField
	(enums.LeadFormFieldUserInputTypeEnum_LeadFormFieldUserInputType)(0), // 3: google.ads.googleads.v24.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType
}
var file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.LeadFormSubmissionData.lead_form_submission_fields:type_name -> google.ads.googleads.v24.resources.LeadFormSubmissionField
	2, // 1: google.ads.googleads.v24.resources.LeadFormSubmissionData.custom_lead_form_submission_fields:type_name -> google.ads.googleads.v24.resources.CustomLeadFormSubmissionField
	3, // 2: google.ads.googleads.v24.resources.LeadFormSubmissionField.field_type:type_name -> google.ads.googleads.v24.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType
...
func init() { file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_init() }
func file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_init() {
	if File_google_ads_googleads_v24_resources_lead_form_submission_data_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_lead_form_submission_data_proto = out.File
	file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_lead_form_submission_data_proto_depIdxs = nil
}
