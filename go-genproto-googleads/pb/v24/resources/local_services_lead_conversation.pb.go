...
type LocalServicesLeadConversation struct {
	...
	// SMS, etc.
	ConversationChannel enums.LocalServicesLeadConversationTypeEnum_ConversationType `protobuf:"varint,3,opt,name=conversation_channel,json=conversationChannel,proto3,enum=google.ads.googleads.v24.enums.LocalServicesLeadConversationTypeEnum_ConversationType" json:"conversation_channel,omitempty"`
	// Output only. Type of participant in the lead conversation, ADVERTISER or
	// CONSUMER.
	ParticipantType enums.LocalServicesParticipantTypeEnum_ParticipantType `protobuf:"varint,4,opt,name=participant_type,json=participantType,proto3,enum=google.ads.googleads.v24.enums.LocalServicesParticipantTypeEnum_ParticipantType" json:"participant_type,omitempty"`
...
func (x *LocalServicesLeadConversation) Reset() {
	*x = LocalServicesLeadConversation{}
	mi := &file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_msgTypes[0]
...
func (*LocalServicesLeadConversation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDescGZIP(), []int{0}
}
...
func (x *PhoneCallDetails) Reset() {
	*x = PhoneCallDetails{}
	mi := &file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PhoneCallDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDescGZIP(), []int{1}
}
...
func (x *MessageDetails) Reset() {
	*x = MessageDetails{}
	mi := &file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MessageDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v24_resources_local_services_lead_conversation_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x50,
	...
	0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x22, 0x4c, 0x6f,
...
var (
	file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDescData = file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_goTypes = []any{
	(*LocalServicesLeadConversation)(nil),                             // 0: google.ads.googleads.v24.resources.LocalServicesLeadConversation
	(*PhoneCallDetails)(nil),                                          // 1: google.ads.googleads.v24.resources.PhoneCallDetails
	(*MessageDetails)(nil),                                            // 2: google.ads.googleads.v24.resources.MessageDetails
	(enums.LocalServicesLeadConversationTypeEnum_ConversationType)(0), // 3: google.ads.googleads.v24.enums.LocalServicesLeadConversationTypeEnum.ConversationType
	(enums.LocalServicesParticipantTypeEnum_ParticipantType)(0),       // 4: google.ads.googleads.v24.enums.LocalServicesParticipantTypeEnum.ParticipantType
}
var file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_depIdxs = []int32{
	3, // 0: google.ads.googleads.v24.resources.LocalServicesLeadConversation.conversation_channel:type_name -> google.ads.googleads.v24.enums.LocalServicesLeadConversationTypeEnum.ConversationType
	4, // 1: google.ads.googleads.v24.resources.LocalServicesLeadConversation.participant_type:type_name -> google.ads.googleads.v24.enums.LocalServicesParticipantTypeEnum.ParticipantType
	1, // 2: google.ads.googleads.v24.resources.LocalServicesLeadConversation.phone_call_details:type_name -> google.ads.googleads.v24.resources.PhoneCallDetails
	2, // 3: google.ads.googleads.v24.resources.LocalServicesLeadConversation.message_details:type_name -> google.ads.googleads.v24.resources.MessageDetails
...
func init() { file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_init() }
func file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_init() {
	if File_google_ads_googleads_v24_resources_local_services_lead_conversation_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_local_services_lead_conversation_proto = out.File
	file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_local_services_lead_conversation_proto_depIdxs = nil
}
