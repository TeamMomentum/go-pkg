...
type AdGroupCriterionCustomizer struct {
	...
	Status enums.CustomizerValueStatusEnum_CustomizerValueStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v24.enums.CustomizerValueStatusEnum_CustomizerValueStatus" json:"status,omitempty"`
...
func (x *AdGroupCriterionCustomizer) Reset() {
	*x = AdGroupCriterionCustomizer{}
	mi := &file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_msgTypes[0]
...
func (*AdGroupCriterionCustomizer) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x36, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x63, 0x75,
...
var (
	file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDescData = file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_goTypes = []any{
	(*AdGroupCriterionCustomizer)(nil),                         // 0: google.ads.googleads.v24.resources.AdGroupCriterionCustomizer
	(enums.CustomizerValueStatusEnum_CustomizerValueStatus)(0), // 1: google.ads.googleads.v24.enums.CustomizerValueStatusEnum.CustomizerValueStatus
	(*common.CustomizerValue)(nil),                             // 2: google.ads.googleads.v24.common.CustomizerValue
}
var file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.AdGroupCriterionCustomizer.status:type_name -> google.ads.googleads.v24.enums.CustomizerValueStatusEnum.CustomizerValueStatus
	2, // 1: google.ads.googleads.v24.resources.AdGroupCriterionCustomizer.value:type_name -> google.ads.googleads.v24.common.CustomizerValue
...
func init() { file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_init() }
func file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_init() {
	if File_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto = out.File
	file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_ad_group_criterion_customizer_proto_depIdxs = nil
}
