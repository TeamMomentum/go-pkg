...
type AccountLink struct {
	...
	Status enums.AccountLinkStatusEnum_AccountLinkStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v24.enums.AccountLinkStatusEnum_AccountLinkStatus" json:"status,omitempty"`
	// Output only. The type of the linked account.
	Type enums.LinkedAccountTypeEnum_LinkedAccountType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v24.enums.LinkedAccountTypeEnum_LinkedAccountType" json:"type,omitempty"`
...
func (x *AccountLink) Reset() {
	*x = AccountLink{}
	mi := &file_google_ads_googleads_v24_resources_account_link_proto_msgTypes[0]
...
func (*AccountLink) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_account_link_proto_rawDescGZIP(), []int{0}
}
...
type ThirdPartyAppAnalyticsLinkIdentifier struct {
	...
	// party app analytics link. It is unable to be modified after the creation of
	// the link.
	AppVendor enums.MobileAppVendorEnum_MobileAppVendor `protobuf:"varint,3,opt,name=app_vendor,json=appVendor,proto3,enum=google.ads.googleads.v24.enums.MobileAppVendorEnum_MobileAppVendor" json:"app_vendor,omitempty"`
}

func (x *ThirdPartyAppAnalyticsLinkIdentifier) Reset() {
	*x = ThirdPartyAppAnalyticsLinkIdentifier{}
	mi := &file_google_ads_googleads_v24_resources_account_link_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ThirdPartyAppAnalyticsLinkIdentifier) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_account_link_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v24_resources_account_link_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_account_link_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4c, 0x69, 0x6e, 0x6b, 0x65, 0x64, 0x41,
	...
	0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e,
	0x76, 0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x10, 0x41,
...
var (
	file_google_ads_googleads_v24_resources_account_link_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_account_link_proto_rawDescData = file_google_ads_googleads_v24_resources_account_link_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_account_link_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_account_link_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_account_link_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_account_link_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_account_link_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_account_link_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v24_resources_account_link_proto_goTypes = []any{
	(*AccountLink)(nil),                                // 0: google.ads.googleads.v24.resources.AccountLink
	(*ThirdPartyAppAnalyticsLinkIdentifier)(nil),       // 1: google.ads.googleads.v24.resources.ThirdPartyAppAnalyticsLinkIdentifier
	(enums.AccountLinkStatusEnum_AccountLinkStatus)(0), // 2: google.ads.googleads.v24.enums.AccountLinkStatusEnum.AccountLinkStatus
	(enums.LinkedAccountTypeEnum_LinkedAccountType)(0), // 3: google.ads.googleads.v24.enums.LinkedAccountTypeEnum.LinkedAccountType
	(enums.MobileAppVendorEnum_MobileAppVendor)(0),     // 4: google.ads.googleads.v24.enums.MobileAppVendorEnum.MobileAppVendor
}
var file_google_ads_googleads_v24_resources_account_link_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v24.resources.AccountLink.status:type_name -> google.ads.googleads.v24.enums.AccountLinkStatusEnum.AccountLinkStatus
	3, // 1: google.ads.googleads.v24.resources.AccountLink.type:type_name -> google.ads.googleads.v24.enums.LinkedAccountTypeEnum.LinkedAccountType
	1, // 2: google.ads.googleads.v24.resources.AccountLink.third_party_app_analytics:type_name -> google.ads.googleads.v24.resources.ThirdPartyAppAnalyticsLinkIdentifier
	4, // 3: google.ads.googleads.v24.resources.ThirdPartyAppAnalyticsLinkIdentifier.app_vendor:type_name -> google.ads.googleads.v24.enums.MobileAppVendorEnum.MobileAppVendor
...
func init() { file_google_ads_googleads_v24_resources_account_link_proto_init() }
func file_google_ads_googleads_v24_resources_account_link_proto_init() {
	if File_google_ads_googleads_v24_resources_account_link_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_account_link_proto_msgTypes[0].OneofWrappers = []any{
		(*AccountLink_ThirdPartyAppAnalytics)(nil),
	}
	file_google_ads_googleads_v24_resources_account_link_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_account_link_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_account_link_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_account_link_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_account_link_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_account_link_proto = out.File
	file_google_ads_googleads_v24_resources_account_link_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_account_link_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_account_link_proto_depIdxs = nil
}
