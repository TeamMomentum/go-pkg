...
type AdGroupAdAssetView struct {
	...
	PerformanceLabel enums.AssetPerformanceLabelEnum_AssetPerformanceLabel `protobuf:"varint,4,opt,name=performance_label,json=performanceLabel,proto3,enum=google.ads.googleads.v24.enums.AssetPerformanceLabelEnum_AssetPerformanceLabel" json:"performance_label,omitempty"`
	// Output only. Pinned field.
	PinnedField enums.ServedAssetFieldTypeEnum_ServedAssetFieldType `protobuf:"varint,11,opt,name=pinned_field,json=pinnedField,proto3,enum=google.ads.googleads.v24.enums.ServedAssetFieldTypeEnum_ServedAssetFieldType" json:"pinned_field,omitempty"`
	// Output only. Source of the ad group ad asset.
	Source enums.AssetSourceEnum_AssetSource `protobuf:"varint,12,opt,name=source,proto3,enum=google.ads.googleads.v24.enums.AssetSourceEnum_AssetSource" json:"source,omitempty"`
}

func (x *AdGroupAdAssetView) Reset() {
	*x = AdGroupAdAssetView{}
	mi := &file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_msgTypes[0]
...
func (*AdGroupAdAssetView) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupAdAssetPolicySummary) Reset() {
	*x = AdGroupAdAssetPolicySummary{}
	mi := &file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdGroupAdAssetPolicySummary) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f, 0x73,
	...
	0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2f, 0x76,
	0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x5f,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32,
	0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x50, 0x65, 0x72,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x50, 0x6f,
...
var (
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDescData = file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_goTypes = []any{
	(*AdGroupAdAssetView)(nil),                                 // 0: google.ads.googleads.v24.resources.AdGroupAdAssetView
	(*AdGroupAdAssetPolicySummary)(nil),                        // 1: google.ads.googleads.v24.resources.AdGroupAdAssetPolicySummary
	(enums.AssetFieldTypeEnum_AssetFieldType)(0),               // 2: google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType
	(enums.AssetPerformanceLabelEnum_AssetPerformanceLabel)(0), // 3: google.ads.googleads.v24.enums.AssetPerformanceLabelEnum.AssetPerformanceLabel
	(enums.ServedAssetFieldTypeEnum_ServedAssetFieldType)(0),   // 4: google.ads.googleads.v24.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType
	(enums.AssetSourceEnum_AssetSource)(0),                     // 5: google.ads.googleads.v24.enums.AssetSourceEnum.AssetSource
	(*common.PolicyTopicEntry)(nil),                            // 6: google.ads.googleads.v24.common.PolicyTopicEntry
	(enums.PolicyReviewStatusEnum_PolicyReviewStatus)(0),       // 7: google.ads.googleads.v24.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	(enums.PolicyApprovalStatusEnum_PolicyApprovalStatus)(0),   // 8: google.ads.googleads.v24.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
}
var file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v24.resources.AdGroupAdAssetView.field_type:type_name -> google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType
	1, // 1: google.ads.googleads.v24.resources.AdGroupAdAssetView.policy_summary:type_name -> google.ads.googleads.v24.resources.AdGroupAdAssetPolicySummary
	3, // 2: google.ads.googleads.v24.resources.AdGroupAdAssetView.performance_label:type_name -> google.ads.googleads.v24.enums.AssetPerformanceLabelEnum.AssetPerformanceLabel
	4, // 3: google.ads.googleads.v24.resources.AdGroupAdAssetView.pinned_field:type_name -> google.ads.googleads.v24.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType
	5, // 4: google.ads.googleads.v24.resources.AdGroupAdAssetView.source:type_name -> google.ads.googleads.v24.enums.AssetSourceEnum.AssetSource
	6, // 5: google.ads.googleads.v24.resources.AdGroupAdAssetPolicySummary.policy_topic_entries:type_name -> google.ads.googleads.v24.common.PolicyTopicEntry
	7, // 6: google.ads.googleads.v24.resources.AdGroupAdAssetPolicySummary.review_status:type_name -> google.ads.googleads.v24.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	8, // 7: google.ads.googleads.v24.resources.AdGroupAdAssetPolicySummary.approval_status:type_name -> google.ads.googleads.v24.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
...
func init() { file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_init() }
func file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_init() {
	if File_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto = out.File
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_ad_group_ad_asset_view_proto_depIdxs = nil
}
