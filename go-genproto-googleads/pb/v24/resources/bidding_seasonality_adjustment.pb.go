...
type BiddingSeasonalityAdjustment struct {
	...
	Scope enums.SeasonalityEventScopeEnum_SeasonalityEventScope `protobuf:"varint,3,opt,name=scope,proto3,enum=google.ads.googleads.v24.enums.SeasonalityEventScopeEnum_SeasonalityEventScope" json:"scope,omitempty"`
	// Output only. The status of the seasonality adjustment.
	Status enums.SeasonalityEventStatusEnum_SeasonalityEventStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v24.enums.SeasonalityEventStatusEnum_SeasonalityEventStatus" json:"status,omitempty"`
	...
	// adjustment.
	Devices []enums.DeviceEnum_Device `protobuf:"varint,9,rep,packed,name=devices,proto3,enum=google.ads.googleads.v24.enums.DeviceEnum_Device" json:"devices,omitempty"`
...
func (*BiddingSeasonalityAdjustment) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x3d, 0x67,
	...
	0x64, 0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x64, 0x65, 0x76,
	...
	0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x73, 0x65, 0x61, 0x73, 0x6f, 0x6e,
	...
	0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x61,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x44, 0x65,
...
var (
	file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDescData = file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_goTypes = []any{
	(*BiddingSeasonalityAdjustment)(nil),                         // 0: google.ads.googleads.v24.resources.BiddingSeasonalityAdjustment
	(enums.SeasonalityEventScopeEnum_SeasonalityEventScope)(0),   // 1: google.ads.googleads.v24.enums.SeasonalityEventScopeEnum.SeasonalityEventScope
	(enums.SeasonalityEventStatusEnum_SeasonalityEventStatus)(0), // 2: google.ads.googleads.v24.enums.SeasonalityEventStatusEnum.SeasonalityEventStatus
	(enums.DeviceEnum_Device)(0),                                 // 3: google.ads.googleads.v24.enums.DeviceEnum.Device
...
var file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.BiddingSeasonalityAdjustment.scope:type_name -> google.ads.googleads.v24.enums.SeasonalityEventScopeEnum.SeasonalityEventScope
	2, // 1: google.ads.googleads.v24.resources.BiddingSeasonalityAdjustment.status:type_name -> google.ads.googleads.v24.enums.SeasonalityEventStatusEnum.SeasonalityEventStatus
	3, // 2: google.ads.googleads.v24.resources.BiddingSeasonalityAdjustment.devices:type_name -> google.ads.googleads.v24.enums.DeviceEnum.Device
	4, // 3: google.ads.googleads.v24.resources.BiddingSeasonalityAdjustment.advertising_channel_types:type_name -> google.ads.googleads.v24.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType
...
func init() { file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_init() }
func file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_init() {
	if File_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto = out.File
	file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_bidding_seasonality_adjustment_proto_depIdxs = nil
}
