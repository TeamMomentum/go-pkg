...
type LocalServicesLead struct {
	...
	LeadType enums.LocalServicesLeadTypeEnum_LeadType `protobuf:"varint,6,opt,name=lead_type,json=leadType,proto3,enum=google.ads.googleads.v24.enums.LocalServicesLeadTypeEnum_LeadType" json:"lead_type,omitempty"`
	// Output only. Current status of lead.
	LeadStatus enums.LocalServicesLeadStatusEnum_LeadStatus `protobuf:"varint,7,opt,name=lead_status,json=leadStatus,proto3,enum=google.ads.googleads.v24.enums.LocalServicesLeadStatusEnum_LeadStatus" json:"lead_status,omitempty"`
...
func (x *LocalServicesLead) Reset() {
	*x = LocalServicesLead{}
	mi := &file_google_ads_googleads_v24_resources_local_services_lead_proto_msgTypes[0]
...
func (*LocalServicesLead) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDescGZIP(), []int{0}
}
...
func (x *ContactDetails) Reset() {
	*x = ContactDetails{}
	mi := &file_google_ads_googleads_v24_resources_local_services_lead_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ContactDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDescGZIP(), []int{1}
}
...
func (x *Note) Reset() {
	*x = Note{}
	mi := &file_google_ads_googleads_v24_resources_local_services_lead_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Note) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDescGZIP(), []int{2}
}
...
type CreditDetails struct {
	...
	CreditState enums.LocalServicesCreditStateEnum_CreditState `protobuf:"varint,1,opt,name=credit_state,json=creditState,proto3,enum=google.ads.googleads.v24.enums.LocalServicesCreditStateEnum_CreditState" json:"credit_state,omitempty"`
...
func (x *CreditDetails) Reset() {
	*x = CreditDetails{}
	mi := &file_google_ads_googleads_v24_resources_local_services_lead_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreditDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_resources_local_services_lead_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x6f, 0x63, 0x61, 0x6c,
	...
	0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x53,
	...
	0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4e, 0x6f, 0x74,
...
var (
	file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDescData = file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_local_services_lead_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_resources_local_services_lead_proto_goTypes = []any{
	(*LocalServicesLead)(nil),                           // 0: google.ads.googleads.v24.resources.LocalServicesLead
	(*ContactDetails)(nil),                              // 1: google.ads.googleads.v24.resources.ContactDetails
	(*Note)(nil),                                        // 2: google.ads.googleads.v24.resources.Note
	(*CreditDetails)(nil),                               // 3: google.ads.googleads.v24.resources.CreditDetails
	(enums.LocalServicesLeadTypeEnum_LeadType)(0),       // 4: google.ads.googleads.v24.enums.LocalServicesLeadTypeEnum.LeadType
	(enums.LocalServicesLeadStatusEnum_LeadStatus)(0),   // 5: google.ads.googleads.v24.enums.LocalServicesLeadStatusEnum.LeadStatus
	(enums.LocalServicesCreditStateEnum_CreditState)(0), // 6: google.ads.googleads.v24.enums.LocalServicesCreditStateEnum.CreditState
}
var file_google_ads_googleads_v24_resources_local_services_lead_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.LocalServicesLead.contact_details:type_name -> google.ads.googleads.v24.resources.ContactDetails
	4, // 1: google.ads.googleads.v24.resources.LocalServicesLead.lead_type:type_name -> google.ads.googleads.v24.enums.LocalServicesLeadTypeEnum.LeadType
	5, // 2: google.ads.googleads.v24.resources.LocalServicesLead.lead_status:type_name -> google.ads.googleads.v24.enums.LocalServicesLeadStatusEnum.LeadStatus
	2, // 3: google.ads.googleads.v24.resources.LocalServicesLead.note:type_name -> google.ads.googleads.v24.resources.Note
	3, // 4: google.ads.googleads.v24.resources.LocalServicesLead.credit_details:type_name -> google.ads.googleads.v24.resources.CreditDetails
	6, // 5: google.ads.googleads.v24.resources.CreditDetails.credit_state:type_name -> google.ads.googleads.v24.enums.LocalServicesCreditStateEnum.CreditState
...
func init() { file_google_ads_googleads_v24_resources_local_services_lead_proto_init() }
func file_google_ads_googleads_v24_resources_local_services_lead_proto_init() {
	if File_google_ads_googleads_v24_resources_local_services_lead_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_local_services_lead_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_local_services_lead_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_local_services_lead_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_local_services_lead_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_local_services_lead_proto = out.File
	file_google_ads_googleads_v24_resources_local_services_lead_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_local_services_lead_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_local_services_lead_proto_depIdxs = nil
}
