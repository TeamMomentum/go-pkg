...
type AccountBudgetProposal struct {
	...
	ProposalType enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType `protobuf:"varint,4,opt,name=proposal_type,json=proposalType,proto3,enum=google.ads.googleads.v24.enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType" json:"proposal_type,omitempty"`
	// Output only. The status of this proposal.
	// When a new proposal is created, the status defaults to PENDING.
	Status enums.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus `protobuf:"varint,15,opt,name=status,proto3,enum=google.ads.googleads.v24.enums.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus" json:"status,omitempty"`
...
func (x *AccountBudgetProposal) Reset() {
	*x = AccountBudgetProposal{}
	mi := &file_google_ads_googleads_v24_resources_account_budget_proposal_proto_msgTypes[0]
...
func (*AccountBudgetProposal) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDescGZIP(), []int{0}
}
...
type AccountBudgetProposal_ProposedStartTimeType struct {
	...
	// example, NOW.
	ProposedStartTimeType enums.TimeTypeEnum_TimeType `protobuf:"varint,7,opt,name=proposed_start_time_type,json=proposedStartTimeType,proto3,enum=google.ads.googleads.v24.enums.TimeTypeEnum_TimeType,oneof"`
}
...
type AccountBudgetProposal_ApprovedEndTimeType struct {
	...
	// example, FOREVER.
	ApprovedEndTimeType enums.TimeTypeEnum_TimeType `protobuf:"varint,22,opt,name=approved_end_time_type,json=approvedEndTimeType,proto3,enum=google.ads.googleads.v24.enums.TimeTypeEnum_TimeType,oneof"`
}
...
type AccountBudgetProposal_ProposedSpendingLimitType struct {
	...
	// example, INFINITE.
	ProposedSpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,11,opt,name=proposed_spending_limit_type,json=proposedSpendingLimitType,proto3,enum=google.ads.googleads.v24.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
type AccountBudgetProposal_ApprovedSpendingLimitType struct {
	...
	// example, INFINITE.
	ApprovedSpendingLimitType enums.SpendingLimitTypeEnum_SpendingLimitType `protobuf:"varint,24,opt,name=approved_spending_limit_type,json=approvedSpendingLimitType,proto3,enum=google.ads.googleads.v24.enums.SpendingLimitTypeEnum_SpendingLimitType,oneof"`
}
...
var File_google_ads_googleads_v24_resources_account_budget_proposal_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDesc = []byte{
	...
	0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x63, 0x63, 0x6f,
	...
	0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x74, 0x79,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x54, 0x69,
...
var (
	file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDescData = file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_account_budget_proposal_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_account_budget_proposal_proto_goTypes = []any{
	(*AccountBudgetProposal)(nil),                                          // 0: google.ads.googleads.v24.resources.AccountBudgetProposal
	(enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType)(0),     // 1: google.ads.googleads.v24.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType
	(enums.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus)(0), // 2: google.ads.googleads.v24.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus
...
var file_google_ads_googleads_v24_resources_account_budget_proposal_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.AccountBudgetProposal.proposal_type:type_name -> google.ads.googleads.v24.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType
	2, // 1: google.ads.googleads.v24.resources.AccountBudgetProposal.status:type_name -> google.ads.googleads.v24.enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus
	3, // 2: google.ads.googleads.v24.resources.AccountBudgetProposal.proposed_start_time_type:type_name -> google.ads.googleads.v24.enums.TimeTypeEnum.TimeType
	3, // 3: google.ads.googleads.v24.resources.AccountBudgetProposal.proposed_end_time_type:type_name -> google.ads.googleads.v24.enums.TimeTypeEnum.TimeType
	3, // 4: google.ads.googleads.v24.resources.AccountBudgetProposal.approved_end_time_type:type_name -> google.ads.googleads.v24.enums.TimeTypeEnum.TimeType
	4, // 5: google.ads.googleads.v24.resources.AccountBudgetProposal.proposed_spending_limit_type:type_name -> google.ads.googleads.v24.enums.SpendingLimitTypeEnum.SpendingLimitType
	4, // 6: google.ads.googleads.v24.resources.AccountBudgetProposal.approved_spending_limit_type:type_name -> google.ads.googleads.v24.enums.SpendingLimitTypeEnum.SpendingLimitType
...
func init() { file_google_ads_googleads_v24_resources_account_budget_proposal_proto_init() }
func file_google_ads_googleads_v24_resources_account_budget_proposal_proto_init() {
	if File_google_ads_googleads_v24_resources_account_budget_proposal_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_account_budget_proposal_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_account_budget_proposal_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_account_budget_proposal_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_account_budget_proposal_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_account_budget_proposal_proto = out.File
	file_google_ads_googleads_v24_resources_account_budget_proposal_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_account_budget_proposal_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_account_budget_proposal_proto_depIdxs = nil
}
