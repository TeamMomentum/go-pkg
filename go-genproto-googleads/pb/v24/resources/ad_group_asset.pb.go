...
type AdGroupAsset struct {
	...
	Source enums.AssetSourceEnum_AssetSource `protobuf:"varint,6,opt,name=source,proto3,enum=google.ads.googleads.v24.enums.AssetSourceEnum_AssetSource" json:"source,omitempty"`
	...
	PrimaryStatus enums.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus `protobuf:"varint,7,opt,name=primary_status,json=primaryStatus,proto3,enum=google.ads.googleads.v24.enums.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus" json:"primary_status,omitempty"`
...
func (x *AdGroupAsset) Reset() {
	*x = AdGroupAsset{}
	mi := &file_google_ads_googleads_v24_resources_ad_group_asset_proto_msgTypes[0]
...
func (*AdGroupAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v24_resources_ad_group_asset_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e,
	0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x46,
	...
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x11,
...
var (
	file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDescData = file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_ad_group_asset_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_ad_group_asset_proto_goTypes = []any{
	(*AdGroupAsset)(nil),                                                     // 0: google.ads.googleads.v24.resources.AdGroupAsset
...
var file_google_ads_googleads_v24_resources_ad_group_asset_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.AdGroupAsset.field_type:type_name -> google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType
	2, // 1: google.ads.googleads.v24.resources.AdGroupAsset.source:type_name -> google.ads.googleads.v24.enums.AssetSourceEnum.AssetSource
	3, // 2: google.ads.googleads.v24.resources.AdGroupAsset.status:type_name -> google.ads.googleads.v24.enums.AssetLinkStatusEnum.AssetLinkStatus
	4, // 3: google.ads.googleads.v24.resources.AdGroupAsset.primary_status:type_name -> google.ads.googleads.v24.enums.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus
	5, // 4: google.ads.googleads.v24.resources.AdGroupAsset.primary_status_details:type_name -> google.ads.googleads.v24.common.AssetLinkPrimaryStatusDetails
	6, // 5: google.ads.googleads.v24.resources.AdGroupAsset.primary_status_reasons:type_name -> google.ads.googleads.v24.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason
...
func init() { file_google_ads_googleads_v24_resources_ad_group_asset_proto_init() }
func file_google_ads_googleads_v24_resources_ad_group_asset_proto_init() {
	if File_google_ads_googleads_v24_resources_ad_group_asset_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_ad_group_asset_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_ad_group_asset_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_ad_group_asset_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_ad_group_asset_proto = out.File
	file_google_ads_googleads_v24_resources_ad_group_asset_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_ad_group_asset_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_ad_group_asset_proto_depIdxs = nil
}
