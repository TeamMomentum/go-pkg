...
type AdGroupCriterionSimulation struct {
	...
	Type enums.SimulationTypeEnum_SimulationType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v24.enums.SimulationTypeEnum_SimulationType" json:"type,omitempty"`
	// Output only. How the simulation modifies the field.
	ModificationMethod enums.SimulationModificationMethodEnum_SimulationModificationMethod `protobuf:"varint,5,opt,name=modification_method,json=modificationMethod,proto3,enum=google.ads.googleads.v24.enums.SimulationModificationMethodEnum_SimulationModificationMethod" json:"modification_method,omitempty"`
...
func (x *AdGroupCriterionSimulation) Reset() {
	*x = AdGroupCriterionSimulation{}
	mi := &file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_msgTypes[0]
...
func (*AdGroupCriterionSimulation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x30, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x73, 0x69,
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x69, 0x6d,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x69, 0x6d, 0x75, 0x6c, 0x61, 0x74,
	...
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x70, 0x63, 0x42,
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x1f,
...
var (
	file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDescData = file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_goTypes = []any{
	(*AdGroupCriterionSimulation)(nil),                                       // 0: google.ads.googleads.v24.resources.AdGroupCriterionSimulation
	...
	(*common.PercentCpcBidSimulationPointList)(nil),                          // 4: google.ads.googleads.v24.common.PercentCpcBidSimulationPointList
}
var file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.AdGroupCriterionSimulation.type:type_name -> google.ads.googleads.v24.enums.SimulationTypeEnum.SimulationType
	2, // 1: google.ads.googleads.v24.resources.AdGroupCriterionSimulation.modification_method:type_name -> google.ads.googleads.v24.enums.SimulationModificationMethodEnum.SimulationModificationMethod
	3, // 2: google.ads.googleads.v24.resources.AdGroupCriterionSimulation.cpc_bid_point_list:type_name -> google.ads.googleads.v24.common.CpcBidSimulationPointList
	4, // 3: google.ads.googleads.v24.resources.AdGroupCriterionSimulation.percent_cpc_bid_point_list:type_name -> google.ads.googleads.v24.common.PercentCpcBidSimulationPointList
...
func init() { file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_init() }
func file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_init() {
	if File_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto = out.File
	file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_ad_group_criterion_simulation_proto_depIdxs = nil
}
