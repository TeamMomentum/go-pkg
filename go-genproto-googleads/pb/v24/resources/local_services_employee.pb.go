...
type LocalServicesEmployee struct {
	...
	Status enums.LocalServicesEmployeeStatusEnum_LocalServicesEmployeeStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v24.enums.LocalServicesEmployeeStatusEnum_LocalServicesEmployeeStatus" json:"status,omitempty"`
	// Output only. Employee type.
	Type enums.LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType `protobuf:"varint,5,opt,name=type,proto3,enum=google.ads.googleads.v24.enums.LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType" json:"type,omitempty"`
...
func (x *LocalServicesEmployee) Reset() {
	*x = LocalServicesEmployee{}
	mi := &file_google_ads_googleads_v24_resources_local_services_employee_proto_msgTypes[0]
...
func (*LocalServicesEmployee) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDescGZIP(), []int{0}
}
...
func (x *UniversityDegree) Reset() {
	*x = UniversityDegree{}
	mi := &file_google_ads_googleads_v24_resources_local_services_employee_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UniversityDegree) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDescGZIP(), []int{1}
}
...
func (x *Residency) Reset() {
	*x = Residency{}
	mi := &file_google_ads_googleads_v24_resources_local_services_employee_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Residency) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDescGZIP(), []int{2}
}
...
func (x *Fellowship) Reset() {
	*x = Fellowship{}
	mi := &file_google_ads_googleads_v24_resources_local_services_employee_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Fellowship) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_resources_local_services_employee_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDesc = []byte{
	...
	0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x53, 0x65, 0x72,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32,
	0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x55, 0x6e, 0x69, 0x76,
...
var (
	file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDescData = file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_local_services_employee_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_resources_local_services_employee_proto_goTypes = []any{
	(*LocalServicesEmployee)(nil), // 0: google.ads.googleads.v24.resources.LocalServicesEmployee
	(*UniversityDegree)(nil),      // 1: google.ads.googleads.v24.resources.UniversityDegree
	(*Residency)(nil),             // 2: google.ads.googleads.v24.resources.Residency
	(*Fellowship)(nil),            // 3: google.ads.googleads.v24.resources.Fellowship
	(enums.LocalServicesEmployeeStatusEnum_LocalServicesEmployeeStatus)(0), // 4: google.ads.googleads.v24.enums.LocalServicesEmployeeStatusEnum.LocalServicesEmployeeStatus
	(enums.LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType)(0),     // 5: google.ads.googleads.v24.enums.LocalServicesEmployeeTypeEnum.LocalServicesEmployeeType
}
var file_google_ads_googleads_v24_resources_local_services_employee_proto_depIdxs = []int32{
	4, // 0: google.ads.googleads.v24.resources.LocalServicesEmployee.status:type_name -> google.ads.googleads.v24.enums.LocalServicesEmployeeStatusEnum.LocalServicesEmployeeStatus
	5, // 1: google.ads.googleads.v24.resources.LocalServicesEmployee.type:type_name -> google.ads.googleads.v24.enums.LocalServicesEmployeeTypeEnum.LocalServicesEmployeeType
	1, // 2: google.ads.googleads.v24.resources.LocalServicesEmployee.university_degrees:type_name -> google.ads.googleads.v24.resources.UniversityDegree
	2, // 3: google.ads.googleads.v24.resources.LocalServicesEmployee.residencies:type_name -> google.ads.googleads.v24.resources.Residency
	3, // 4: google.ads.googleads.v24.resources.LocalServicesEmployee.fellowships:type_name -> google.ads.googleads.v24.resources.Fellowship
...
func init() { file_google_ads_googleads_v24_resources_local_services_employee_proto_init() }
func file_google_ads_googleads_v24_resources_local_services_employee_proto_init() {
	if File_google_ads_googleads_v24_resources_local_services_employee_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_local_services_employee_proto_msgTypes[0].OneofWrappers = []any{}
	file_google_ads_googleads_v24_resources_local_services_employee_proto_msgTypes[1].OneofWrappers = []any{}
	file_google_ads_googleads_v24_resources_local_services_employee_proto_msgTypes[2].OneofWrappers = []any{}
	file_google_ads_googleads_v24_resources_local_services_employee_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_local_services_employee_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_local_services_employee_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_local_services_employee_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_local_services_employee_proto = out.File
	file_google_ads_googleads_v24_resources_local_services_employee_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_local_services_employee_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_local_services_employee_proto_depIdxs = nil
}
