...
type KeywordPlanCampaign struct {
	...
	// This field is required and should not be empty when creating Keyword Plan
	// campaigns.
	KeywordPlanNetwork enums.KeywordPlanNetworkEnum_KeywordPlanNetwork `protobuf:"varint,6,opt,name=keyword_plan_network,json=keywordPlanNetwork,proto3,enum=google.ads.googleads.v24.enums.KeywordPlanNetworkEnum_KeywordPlanNetwork" json:"keyword_plan_network,omitempty"`
...
func (x *KeywordPlanCampaign) Reset() {
	*x = KeywordPlanCampaign{}
	mi := &file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_msgTypes[0]
...
func (*KeywordPlanCampaign) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordPlanGeoTarget) Reset() {
	*x = KeywordPlanGeoTarget{}
	mi := &file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordPlanGeoTarget) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v24_resources_keyword_plan_campaign_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDescData = file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_goTypes = []any{
	(*KeywordPlanCampaign)(nil),                          // 0: google.ads.googleads.v24.resources.KeywordPlanCampaign
	(*KeywordPlanGeoTarget)(nil),                         // 1: google.ads.googleads.v24.resources.KeywordPlanGeoTarget
	(enums.KeywordPlanNetworkEnum_KeywordPlanNetwork)(0), // 2: google.ads.googleads.v24.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
}
var file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v24.resources.KeywordPlanCampaign.keyword_plan_network:type_name -> google.ads.googleads.v24.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
	1, // 1: google.ads.googleads.v24.resources.KeywordPlanCampaign.geo_targets:type_name -> google.ads.googleads.v24.resources.KeywordPlanGeoTarget
...
func init() { file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_init() }
func file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_init() {
	if File_google_ads_googleads_v24_resources_keyword_plan_campaign_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_msgTypes[0].OneofWrappers = []any{}
	file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_keyword_plan_campaign_proto = out.File
	file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_keyword_plan_campaign_proto_depIdxs = nil
}
