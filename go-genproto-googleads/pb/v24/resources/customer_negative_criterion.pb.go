...
type CustomerNegativeCriterion struct {
	...
	Type enums.CriterionTypeEnum_CriterionType `protobuf:"varint,3,opt,name=type,proto3,enum=google.ads.googleads.v24.enums.CriterionTypeEnum_CriterionType" json:"type,omitempty"`
...
func (x *CustomerNegativeCriterion) Reset() {
	*x = CustomerNegativeCriterion{}
	mi := &file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_msgTypes[0]
...
func (*CustomerNegativeCriterion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerNegativeCriterion) GetPlacementList() *common.PlacementListInfo {
	if x, ok := x.GetCriterion().(*CustomerNegativeCriterion_PlacementList); ok {
...
var File_google_ads_googleads_v24_resources_customer_negative_criterion_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x63, 0x72, 0x69, 0x74,
	...
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4d, 0x6f, 0x62, 0x69,
	...
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x49, 0x70, 0x42,
...
var (
	file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDescData = file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_goTypes = []any{
	(*CustomerNegativeCriterion)(nil),          // 0: google.ads.googleads.v24.resources.CustomerNegativeCriterion
	(enums.CriterionTypeEnum_CriterionType)(0), // 1: google.ads.googleads.v24.enums.CriterionTypeEnum.CriterionType
	(*common.ContentLabelInfo)(nil),            // 2: google.ads.googleads.v24.common.ContentLabelInfo
	(*common.MobileApplicationInfo)(nil),       // 3: google.ads.googleads.v24.common.MobileApplicationInfo
	(*common.MobileAppCategoryInfo)(nil),       // 4: google.ads.googleads.v24.common.MobileAppCategoryInfo
	(*common.PlacementInfo)(nil),               // 5: google.ads.googleads.v24.common.PlacementInfo
	(*common.YouTubeVideoInfo)(nil),            // 6: google.ads.googleads.v24.common.YouTubeVideoInfo
	(*common.YouTubeChannelInfo)(nil),          // 7: google.ads.googleads.v24.common.YouTubeChannelInfo
	(*common.NegativeKeywordListInfo)(nil),     // 8: google.ads.googleads.v24.common.NegativeKeywordListInfo
	(*common.IpBlockInfo)(nil),                 // 9: google.ads.googleads.v24.common.IpBlockInfo
	(*common.PlacementListInfo)(nil),           // 10: google.ads.googleads.v24.common.PlacementListInfo
}
var file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_depIdxs = []int32{
	1,  // 0: google.ads.googleads.v24.resources.CustomerNegativeCriterion.type:type_name -> google.ads.googleads.v24.enums.CriterionTypeEnum.CriterionType
	2,  // 1: google.ads.googleads.v24.resources.CustomerNegativeCriterion.content_label:type_name -> google.ads.googleads.v24.common.ContentLabelInfo
	3,  // 2: google.ads.googleads.v24.resources.CustomerNegativeCriterion.mobile_application:type_name -> google.ads.googleads.v24.common.MobileApplicationInfo
	4,  // 3: google.ads.googleads.v24.resources.CustomerNegativeCriterion.mobile_app_category:type_name -> google.ads.googleads.v24.common.MobileAppCategoryInfo
	5,  // 4: google.ads.googleads.v24.resources.CustomerNegativeCriterion.placement:type_name -> google.ads.googleads.v24.common.PlacementInfo
	6,  // 5: google.ads.googleads.v24.resources.CustomerNegativeCriterion.youtube_video:type_name -> google.ads.googleads.v24.common.YouTubeVideoInfo
	7,  // 6: google.ads.googleads.v24.resources.CustomerNegativeCriterion.youtube_channel:type_name -> google.ads.googleads.v24.common.YouTubeChannelInfo
	8,  // 7: google.ads.googleads.v24.resources.CustomerNegativeCriterion.negative_keyword_list:type_name -> google.ads.googleads.v24.common.NegativeKeywordListInfo
	9,  // 8: google.ads.googleads.v24.resources.CustomerNegativeCriterion.ip_block:type_name -> google.ads.googleads.v24.common.IpBlockInfo
	10, // 9: google.ads.googleads.v24.resources.CustomerNegativeCriterion.placement_list:type_name -> google.ads.googleads.v24.common.PlacementListInfo
...
func init() { file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_init() }
func file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_init() {
	if File_google_ads_googleads_v24_resources_customer_negative_criterion_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_customer_negative_criterion_proto = out.File
	file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_customer_negative_criterion_proto_depIdxs = nil
}
