...
type ConversionValueRule struct {
	...
	Status enums.ConversionValueRuleStatusEnum_ConversionValueRuleStatus `protobuf:"varint,8,opt,name=status,proto3,enum=google.ads.googleads.v24.enums.ConversionValueRuleStatusEnum_ConversionValueRuleStatus" json:"status,omitempty"`
}

func (x *ConversionValueRule) Reset() {
	*x = ConversionValueRule{}
	mi := &file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes[0]
...
func (*ConversionValueRule) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescGZIP(), []int{0}
}
...
type ConversionValueRule_ValueRuleAction struct {
	...
	Operation enums.ValueRuleOperationEnum_ValueRuleOperation `protobuf:"varint,1,opt,name=operation,proto3,enum=google.ads.googleads.v24.enums.ValueRuleOperationEnum_ValueRuleOperation" json:"operation,omitempty"`
...
func (x *ConversionValueRule_ValueRuleAction) Reset() {
	*x = ConversionValueRule_ValueRuleAction{}
	mi := &file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionValueRule_ValueRuleAction) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescGZIP(), []int{0, 0}
}
...
type ConversionValueRule_ValueRuleGeoLocationCondition struct {
	...
	GeoMatchType enums.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType `protobuf:"varint,4,opt,name=geo_match_type,json=geoMatchType,proto3,enum=google.ads.googleads.v24.enums.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType" json:"geo_match_type,omitempty"`
}

func (x *ConversionValueRule_ValueRuleGeoLocationCondition) Reset() {
	*x = ConversionValueRule_ValueRuleGeoLocationCondition{}
	mi := &file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionValueRule_ValueRuleGeoLocationCondition) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescGZIP(), []int{0, 1}
}
...
type ConversionValueRule_ValueRuleDeviceCondition struct {
	...
	DeviceTypes []enums.ValueRuleDeviceTypeEnum_ValueRuleDeviceType `protobuf:"varint,1,rep,packed,name=device_types,json=deviceTypes,proto3,enum=google.ads.googleads.v24.enums.ValueRuleDeviceTypeEnum_ValueRuleDeviceType" json:"device_types,omitempty"`
}

func (x *ConversionValueRule_ValueRuleDeviceCondition) Reset() {
	*x = ConversionValueRule_ValueRuleDeviceCondition{}
	mi := &file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionValueRule_ValueRuleDeviceCondition) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *ConversionValueRule_ValueRuleAudienceCondition) Reset() {
	*x = ConversionValueRule_ValueRuleAudienceCondition{}
	mi := &file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionValueRule_ValueRuleAudienceCondition) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescGZIP(), []int{0, 3}
}
...
func (x *ConversionValueRule_ValueRuleItineraryCondition) Reset() {
	*x = ConversionValueRule_ValueRuleItineraryCondition{}
	mi := &file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionValueRule_ValueRuleItineraryCondition) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescGZIP(), []int{0, 4}
}
...
func (x *ConversionValueRule_ValueRuleItineraryAdvanceBookingWindow) Reset() {
	*x = ConversionValueRule_ValueRuleItineraryAdvanceBookingWindow{}
	mi := &file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionValueRule_ValueRuleItineraryAdvanceBookingWindow) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescGZIP(), []int{0, 5}
}
...
func (x *ConversionValueRule_ValueRuleItineraryTravelLength) Reset() {
	*x = ConversionValueRule_ValueRuleItineraryTravelLength{}
	mi := &file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionValueRule_ValueRuleItineraryTravelLength) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescGZIP(), []int{0, 6}
}
...
func (x *ConversionValueRule_ValueRuleItineraryTravelStartDay) Reset() {
	*x = ConversionValueRule_ValueRuleItineraryTravelStartDay{}
	mi := &file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionValueRule_ValueRuleItineraryTravelStartDay) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescGZIP(), []int{0, 7}
}
...
var File_google_ads_googleads_v24_resources_conversion_value_rule_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x76, 0x61,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x56,
	...
	0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x6f, 0x6e,
	...
	0x76, 0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x6f,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32,
	0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x18, 0x43, 0x6f, 0x6e,
	0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x75, 0x6c, 0x65,
	...
	0x73, 0x2e, 0x56, 0x32, 0x34, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0xca,
	0x02, 0x22, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x5c, 0x56, 0x32, 0x34, 0x5c, 0x52, 0x65, 0x73, 0x6f, 0x75,
	...
	0x32, 0x34, 0x3a, 0x3a, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x62, 0x06, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescData = file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_google_ads_googleads_v24_resources_conversion_value_rule_proto_goTypes = []any{
	(*ConversionValueRule)(nil),                                                // 0: google.ads.googleads.v24.resources.ConversionValueRule
	(*ConversionValueRule_ValueRuleAction)(nil),                                // 1: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleAction
	(*ConversionValueRule_ValueRuleGeoLocationCondition)(nil),                  // 2: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleGeoLocationCondition
	(*ConversionValueRule_ValueRuleDeviceCondition)(nil),                       // 3: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleDeviceCondition
	(*ConversionValueRule_ValueRuleAudienceCondition)(nil),                     // 4: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleAudienceCondition
	(*ConversionValueRule_ValueRuleItineraryCondition)(nil),                    // 5: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleItineraryCondition
	(*ConversionValueRule_ValueRuleItineraryAdvanceBookingWindow)(nil),         // 6: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleItineraryAdvanceBookingWindow
	(*ConversionValueRule_ValueRuleItineraryTravelLength)(nil),                 // 7: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleItineraryTravelLength
	(*ConversionValueRule_ValueRuleItineraryTravelStartDay)(nil),               // 8: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleItineraryTravelStartDay
	(enums.ConversionValueRuleStatusEnum_ConversionValueRuleStatus)(0),         // 9: google.ads.googleads.v24.enums.ConversionValueRuleStatusEnum.ConversionValueRuleStatus
	(enums.ValueRuleOperationEnum_ValueRuleOperation)(0),                       // 10: google.ads.googleads.v24.enums.ValueRuleOperationEnum.ValueRuleOperation
	(enums.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType)(0), // 11: google.ads.googleads.v24.enums.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType
	(enums.ValueRuleDeviceTypeEnum_ValueRuleDeviceType)(0),                     // 12: google.ads.googleads.v24.enums.ValueRuleDeviceTypeEnum.ValueRuleDeviceType
}
var file_google_ads_googleads_v24_resources_conversion_value_rule_proto_depIdxs = []int32{
	1,  // 0: google.ads.googleads.v24.resources.ConversionValueRule.action:type_name -> google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleAction
	2,  // 1: google.ads.googleads.v24.resources.ConversionValueRule.geo_location_condition:type_name -> google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleGeoLocationCondition
	3,  // 2: google.ads.googleads.v24.resources.ConversionValueRule.device_condition:type_name -> google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleDeviceCondition
	4,  // 3: google.ads.googleads.v24.resources.ConversionValueRule.audience_condition:type_name -> google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleAudienceCondition
	5,  // 4: google.ads.googleads.v24.resources.ConversionValueRule.itinerary_condition:type_name -> google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleItineraryCondition
	9,  // 5: google.ads.googleads.v24.resources.ConversionValueRule.status:type_name -> google.ads.googleads.v24.enums.ConversionValueRuleStatusEnum.ConversionValueRuleStatus
	10, // 6: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleAction.operation:type_name -> google.ads.googleads.v24.enums.ValueRuleOperationEnum.ValueRuleOperation
	11, // 7: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleGeoLocationCondition.excluded_geo_match_type:type_name -> google.ads.googleads.v24.enums.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType
	11, // 8: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleGeoLocationCondition.geo_match_type:type_name -> google.ads.googleads.v24.enums.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType
	12, // 9: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleDeviceCondition.device_types:type_name -> google.ads.googleads.v24.enums.ValueRuleDeviceTypeEnum.ValueRuleDeviceType
	6,  // 10: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleItineraryCondition.advance_booking_window:type_name -> google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleItineraryAdvanceBookingWindow
	7,  // 11: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleItineraryCondition.travel_length:type_name -> google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleItineraryTravelLength
	8,  // 12: google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleItineraryCondition.travel_start_day:type_name -> google.ads.googleads.v24.resources.ConversionValueRule.ValueRuleItineraryTravelStartDay
...
func init() { file_google_ads_googleads_v24_resources_conversion_value_rule_proto_init() }
func file_google_ads_googleads_v24_resources_conversion_value_rule_proto_init() {
	if File_google_ads_googleads_v24_resources_conversion_value_rule_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_conversion_value_rule_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_conversion_value_rule_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_conversion_value_rule_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_conversion_value_rule_proto = out.File
	file_google_ads_googleads_v24_resources_conversion_value_rule_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_conversion_value_rule_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_conversion_value_rule_proto_depIdxs = nil
}
