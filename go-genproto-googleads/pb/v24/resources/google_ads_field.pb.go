...
type GoogleAdsField struct {
	...
	Category enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory `protobuf:"varint,3,opt,name=category,proto3,enum=google.ads.googleads.v24.enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory" json:"category,omitempty"`
	...
	DataType enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType `protobuf:"varint,12,opt,name=data_type,json=dataType,proto3,enum=google.ads.googleads.v24.enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType" json:"data_type,omitempty"`
...
func (x *GoogleAdsField) Reset() {
	*x = GoogleAdsField{}
	mi := &file_google_ads_googleads_v24_resources_google_ads_field_proto_msgTypes[0]
...
func (*GoogleAdsField) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDescGZIP(), []int{0}
}
...
var File_google_ads_googleads_v24_resources_google_ads_field_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x13,
...
var (
	file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDescData = file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_google_ads_field_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_resources_google_ads_field_proto_goTypes = []any{
	(*GoogleAdsField)(nil), // 0: google.ads.googleads.v24.resources.GoogleAdsField
	(enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory)(0), // 1: google.ads.googleads.v24.enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory
	(enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType)(0), // 2: google.ads.googleads.v24.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType
}
var file_google_ads_googleads_v24_resources_google_ads_field_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.GoogleAdsField.category:type_name -> google.ads.googleads.v24.enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory
	2, // 1: google.ads.googleads.v24.resources.GoogleAdsField.data_type:type_name -> google.ads.googleads.v24.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType
...
func init() { file_google_ads_googleads_v24_resources_google_ads_field_proto_init() }
func file_google_ads_googleads_v24_resources_google_ads_field_proto_init() {
	if File_google_ads_googleads_v24_resources_google_ads_field_proto != nil {
		return
	}
	file_google_ads_googleads_v24_resources_google_ads_field_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_google_ads_field_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_google_ads_field_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_google_ads_field_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_google_ads_field_proto = out.File
	file_google_ads_googleads_v24_resources_google_ads_field_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_google_ads_field_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_google_ads_field_proto_depIdxs = nil
}
