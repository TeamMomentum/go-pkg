...
func (x *AssetGroupTopCombinationView) Reset() {
	*x = AssetGroupTopCombinationView{}
	mi := &file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_msgTypes[0]
...
func (*AssetGroupTopCombinationView) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetGroupAssetCombinationData) Reset() {
	*x = AssetGroupAssetCombinationData{}
	mi := &file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AssetGroupAssetCombinationData) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDescData = file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDesc
)

func file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDescData
}

var file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_goTypes = []any{
	(*AssetGroupTopCombinationView)(nil),   // 0: google.ads.googleads.v24.resources.AssetGroupTopCombinationView
	(*AssetGroupAssetCombinationData)(nil), // 1: google.ads.googleads.v24.resources.AssetGroupAssetCombinationData
	(*common.AssetUsage)(nil),              // 2: google.ads.googleads.v24.common.AssetUsage
}
var file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.resources.AssetGroupTopCombinationView.asset_group_top_combinations:type_name -> google.ads.googleads.v24.resources.AssetGroupAssetCombinationData
	2, // 1: google.ads.googleads.v24.resources.AssetGroupAssetCombinationData.asset_combination_served_assets:type_name -> google.ads.googleads.v24.common.AssetUsage
...
func init() { file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_init() }
func file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_init() {
	if File_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto = out.File
	file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_rawDesc = nil
	file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_goTypes = nil
	file_google_ads_googleads_v24_resources_asset_group_top_combination_view_proto_depIdxs = nil
}
