...
func (x *MutateCustomerLabelsRequest) Reset() {
	*x = MutateCustomerLabelsRequest{}
	mi := &file_google_ads_googleads_v24_services_customer_label_service_proto_msgTypes[0]
...
func (*MutateCustomerLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerLabelOperation) Reset() {
	*x = CustomerLabelOperation{}
	mi := &file_google_ads_googleads_v24_services_customer_label_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerLabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerLabelsResponse) Reset() {
	*x = MutateCustomerLabelsResponse{}
	mi := &file_google_ads_googleads_v24_services_customer_label_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerLabelResult) Reset() {
	*x = MutateCustomerLabelResult{}
	mi := &file_google_ads_googleads_v24_services_customer_label_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_label_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_customer_label_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_customer_label_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_services_customer_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_customer_label_service_proto_rawDescData = file_google_ads_googleads_v24_services_customer_label_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_customer_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_customer_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_customer_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_customer_label_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_customer_label_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_customer_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_customer_label_service_proto_goTypes = []any{
	(*MutateCustomerLabelsRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateCustomerLabelsRequest
	(*CustomerLabelOperation)(nil),       // 1: google.ads.googleads.v24.services.CustomerLabelOperation
	(*MutateCustomerLabelsResponse)(nil), // 2: google.ads.googleads.v24.services.MutateCustomerLabelsResponse
	(*MutateCustomerLabelResult)(nil),    // 3: google.ads.googleads.v24.services.MutateCustomerLabelResult
	(*resources.CustomerLabel)(nil),      // 4: google.ads.googleads.v24.resources.CustomerLabel
	(*status.Status)(nil),                // 5: google.rpc.Status
}
var file_google_ads_googleads_v24_services_customer_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCustomerLabelsRequest.operations:type_name -> google.ads.googleads.v24.services.CustomerLabelOperation
	4, // 1: google.ads.googleads.v24.services.CustomerLabelOperation.create:type_name -> google.ads.googleads.v24.resources.CustomerLabel
	5, // 2: google.ads.googleads.v24.services.MutateCustomerLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 3: google.ads.googleads.v24.services.MutateCustomerLabelsResponse.results:type_name -> google.ads.googleads.v24.services.MutateCustomerLabelResult
	0, // 4: google.ads.googleads.v24.services.CustomerLabelService.MutateCustomerLabels:input_type -> google.ads.googleads.v24.services.MutateCustomerLabelsRequest
	2, // 5: google.ads.googleads.v24.services.CustomerLabelService.MutateCustomerLabels:output_type -> google.ads.googleads.v24.services.MutateCustomerLabelsResponse
...
func init() { file_google_ads_googleads_v24_services_customer_label_service_proto_init() }
func file_google_ads_googleads_v24_services_customer_label_service_proto_init() {
	if File_google_ads_googleads_v24_services_customer_label_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_customer_label_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_customer_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_customer_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_customer_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_customer_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_customer_label_service_proto = out.File
	file_google_ads_googleads_v24_services_customer_label_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_customer_label_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_customer_label_service_proto_depIdxs = nil
}
...
func (c *customerLabelServiceClient) MutateCustomerLabels(ctx context.Context, in *MutateCustomerLabelsRequest, opts ...grpc.CallOption) (*MutateCustomerLabelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomerLabelService/MutateCustomerLabels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerLabelService_MutateCustomerLabels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomerLabelService/MutateCustomerLabels",
	}
