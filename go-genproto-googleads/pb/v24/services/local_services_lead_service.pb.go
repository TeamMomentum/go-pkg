...
func (x *AppendLeadConversationRequest) Reset() {
	*x = AppendLeadConversationRequest{}
	mi := &file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes[0]
...
func (*AppendLeadConversationRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AppendLeadConversationResponse) Reset() {
	*x = AppendLeadConversationResponse{}
	mi := &file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AppendLeadConversationResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *Conversation) Reset() {
	*x = Conversation{}
	mi := &file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Conversation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *ConversationOrError) Reset() {
	*x = ConversationOrError{}
	mi := &file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversationOrError) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescGZIP(), []int{3}
}
...
type SurveySatisfied struct {
	...
	SurveySatisfiedReason enums.LocalServicesLeadSurveySatisfiedReasonEnum_SurveySatisfiedReason `protobuf:"varint,1,opt,name=survey_satisfied_reason,json=surveySatisfiedReason,proto3,enum=google.ads.googleads.v24.enums.LocalServicesLeadSurveySatisfiedReasonEnum_SurveySatisfiedReason" json:"survey_satisfied_reason,omitempty"`
...
func (x *SurveySatisfied) Reset() {
	*x = SurveySatisfied{}
	mi := &file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SurveySatisfied) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescGZIP(), []int{4}
}
...
type SurveyDissatisfied struct {
	...
	SurveyDissatisfiedReason enums.LocalServicesLeadSurveyDissatisfiedReasonEnum_SurveyDissatisfiedReason `protobuf:"varint,1,opt,name=survey_dissatisfied_reason,json=surveyDissatisfiedReason,proto3,enum=google.ads.googleads.v24.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum_SurveyDissatisfiedReason" json:"survey_dissatisfied_reason,omitempty"`
	// Optional. Provider's free form comments. This field is required when
...
func (x *SurveyDissatisfied) Reset() {
	*x = SurveyDissatisfied{}
	mi := &file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SurveyDissatisfied) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescGZIP(), []int{5}
}
...
type ProvideLeadFeedbackRequest struct {
	...
	SurveyAnswer enums.LocalServicesLeadSurveyAnswerEnum_SurveyAnswer `protobuf:"varint,2,opt,name=survey_answer,json=surveyAnswer,proto3,enum=google.ads.googleads.v24.enums.LocalServicesLeadSurveyAnswerEnum_SurveyAnswer" json:"survey_answer,omitempty"`
	// Details about various factors for being satisfied or dissatisfied with the
	// lead.
	//
	// Types that are assignable to SurveyDetails:
	//
...
func (x *ProvideLeadFeedbackRequest) Reset() {
	*x = ProvideLeadFeedbackRequest{}
	mi := &file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProvideLeadFeedbackRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescGZIP(), []int{6}
}
...
func (m *ProvideLeadFeedbackRequest) GetSurveyDetails() isProvideLeadFeedbackRequest_SurveyDetails {
	if m != nil {
		return m.SurveyDetails
	}
	return nil
}

func (x *ProvideLeadFeedbackRequest) GetSurveySatisfied() *SurveySatisfied {
	if x, ok := x.GetSurveyDetails().(*ProvideLeadFeedbackRequest_SurveySatisfied); ok {
...
func (x *ProvideLeadFeedbackRequest) GetSurveyDissatisfied() *SurveyDissatisfied {
	if x, ok := x.GetSurveyDetails().(*ProvideLeadFeedbackRequest_SurveyDissatisfied); ok {
...
type ProvideLeadFeedbackResponse struct {
	...
	CreditIssuanceDecision enums.LocalServicesLeadCreditIssuanceDecisionEnum_CreditIssuanceDecision `protobuf:"varint,1,opt,name=credit_issuance_decision,json=creditIssuanceDecision,proto3,enum=google.ads.googleads.v24.enums.LocalServicesLeadCreditIssuanceDecisionEnum_CreditIssuanceDecision" json:"credit_issuance_decision,omitempty"`
}

func (x *ProvideLeadFeedbackResponse) Reset() {
	*x = ProvideLeadFeedbackResponse{}
	mi := &file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProvideLeadFeedbackResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescGZIP(), []int{7}
}
...
var File_google_ads_googleads_v24_services_local_services_lead_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x5f, 0x73,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4c,
	...
	0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x75, 0x72,
	...
	0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x70, 0x70, 0x65,
	...
	0x3a, 0x01, 0x2a, 0x22, 0x43, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	...
	0x54, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x4e, 0x3a, 0x01, 0x2a, 0x22, 0x49, 0x2f, 0x76, 0x32, 0x34,
...
var (
	file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescData = file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_google_ads_googleads_v24_services_local_services_lead_service_proto_goTypes = []any{
	(*AppendLeadConversationRequest)(nil),  // 0: google.ads.googleads.v24.services.AppendLeadConversationRequest
	(*AppendLeadConversationResponse)(nil), // 1: google.ads.googleads.v24.services.AppendLeadConversationResponse
	(*Conversation)(nil),                   // 2: google.ads.googleads.v24.services.Conversation
	(*ConversationOrError)(nil),            // 3: google.ads.googleads.v24.services.ConversationOrError
	(*SurveySatisfied)(nil),                // 4: google.ads.googleads.v24.services.SurveySatisfied
	(*SurveyDissatisfied)(nil),             // 5: google.ads.googleads.v24.services.SurveyDissatisfied
	(*ProvideLeadFeedbackRequest)(nil),     // 6: google.ads.googleads.v24.services.ProvideLeadFeedbackRequest
	(*ProvideLeadFeedbackResponse)(nil),    // 7: google.ads.googleads.v24.services.ProvideLeadFeedbackResponse
	(*status.Status)(nil),                  // 8: google.rpc.Status
	(enums.LocalServicesLeadSurveySatisfiedReasonEnum_SurveySatisfiedReason)(0),       // 9: google.ads.googleads.v24.enums.LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason
	(enums.LocalServicesLeadSurveyDissatisfiedReasonEnum_SurveyDissatisfiedReason)(0), // 10: google.ads.googleads.v24.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason
	(enums.LocalServicesLeadSurveyAnswerEnum_SurveyAnswer)(0),                         // 11: google.ads.googleads.v24.enums.LocalServicesLeadSurveyAnswerEnum.SurveyAnswer
	(enums.LocalServicesLeadCreditIssuanceDecisionEnum_CreditIssuanceDecision)(0),     // 12: google.ads.googleads.v24.enums.LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision
}
var file_google_ads_googleads_v24_services_local_services_lead_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v24.services.AppendLeadConversationRequest.conversations:type_name -> google.ads.googleads.v24.services.Conversation
	3,  // 1: google.ads.googleads.v24.services.AppendLeadConversationResponse.responses:type_name -> google.ads.googleads.v24.services.ConversationOrError
	8,  // 2: google.ads.googleads.v24.services.ConversationOrError.partial_failure_error:type_name -> google.rpc.Status
	9,  // 3: google.ads.googleads.v24.services.SurveySatisfied.survey_satisfied_reason:type_name -> google.ads.googleads.v24.enums.LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason
	10, // 4: google.ads.googleads.v24.services.SurveyDissatisfied.survey_dissatisfied_reason:type_name -> google.ads.googleads.v24.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason
	11, // 5: google.ads.googleads.v24.services.ProvideLeadFeedbackRequest.survey_answer:type_name -> google.ads.googleads.v24.enums.LocalServicesLeadSurveyAnswerEnum.SurveyAnswer
	4,  // 6: google.ads.googleads.v24.services.ProvideLeadFeedbackRequest.survey_satisfied:type_name -> google.ads.googleads.v24.services.SurveySatisfied
	5,  // 7: google.ads.googleads.v24.services.ProvideLeadFeedbackRequest.survey_dissatisfied:type_name -> google.ads.googleads.v24.services.SurveyDissatisfied
	12, // 8: google.ads.googleads.v24.services.ProvideLeadFeedbackResponse.credit_issuance_decision:type_name -> google.ads.googleads.v24.enums.LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision
	0,  // 9: google.ads.googleads.v24.services.LocalServicesLeadService.AppendLeadConversation:input_type -> google.ads.googleads.v24.services.AppendLeadConversationRequest
	6,  // 10: google.ads.googleads.v24.services.LocalServicesLeadService.ProvideLeadFeedback:input_type -> google.ads.googleads.v24.services.ProvideLeadFeedbackRequest
	1,  // 11: google.ads.googleads.v24.services.LocalServicesLeadService.AppendLeadConversation:output_type -> google.ads.googleads.v24.services.AppendLeadConversationResponse
	7,  // 12: google.ads.googleads.v24.services.LocalServicesLeadService.ProvideLeadFeedback:output_type -> google.ads.googleads.v24.services.ProvideLeadFeedbackResponse
...
func init() { file_google_ads_googleads_v24_services_local_services_lead_service_proto_init() }
func file_google_ads_googleads_v24_services_local_services_lead_service_proto_init() {
	if File_google_ads_googleads_v24_services_local_services_lead_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes[3].OneofWrappers = []any{
		(*ConversationOrError_LocalServicesLeadConversation)(nil),
		(*ConversationOrError_PartialFailureError)(nil),
	}
	file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes[6].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_local_services_lead_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_local_services_lead_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_local_services_lead_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_local_services_lead_service_proto = out.File
	file_google_ads_googleads_v24_services_local_services_lead_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_local_services_lead_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_local_services_lead_service_proto_depIdxs = nil
}
...
func (c *localServicesLeadServiceClient) AppendLeadConversation(ctx context.Context, in *AppendLeadConversationRequest, opts ...grpc.CallOption) (*AppendLeadConversationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.LocalServicesLeadService/AppendLeadConversation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *localServicesLeadServiceClient) ProvideLeadFeedback(ctx context.Context, in *ProvideLeadFeedbackRequest, opts ...grpc.CallOption) (*ProvideLeadFeedbackResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.LocalServicesLeadService/ProvideLeadFeedback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedLocalServicesLeadServiceServer can be embedded to have forward compatible implementations.
...
func (*UnimplementedLocalServicesLeadServiceServer) AppendLeadConversation(context.Context, *AppendLeadConversationRequest) (*AppendLeadConversationResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method AppendLeadConversation not implemented")
}
func (*UnimplementedLocalServicesLeadServiceServer) ProvideLeadFeedback(context.Context, *ProvideLeadFeedbackRequest) (*ProvideLeadFeedbackResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method ProvideLeadFeedback not implemented")
}

func RegisterLocalServicesLeadServiceServer(s *grpc.Server, srv LocalServicesLeadServiceServer) {
	s.RegisterService(&_LocalServicesLeadService_serviceDesc, srv)
}
...
func _LocalServicesLeadService_AppendLeadConversation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.LocalServicesLeadService/AppendLeadConversation",
	}
...
func _LocalServicesLeadService_ProvideLeadFeedback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.LocalServicesLeadService/ProvideLeadFeedback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _LocalServicesLeadService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/local_services_lead_service.proto",
}
