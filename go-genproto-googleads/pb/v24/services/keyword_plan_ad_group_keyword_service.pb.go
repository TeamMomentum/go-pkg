...
func (x *MutateKeywordPlanAdGroupKeywordsRequest) Reset() {
	*x = MutateKeywordPlanAdGroupKeywordsRequest{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[0]
...
func (*MutateKeywordPlanAdGroupKeywordsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordPlanAdGroupKeywordOperation) Reset() {
	*x = KeywordPlanAdGroupKeywordOperation{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordPlanAdGroupKeywordOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateKeywordPlanAdGroupKeywordsResponse) Reset() {
	*x = MutateKeywordPlanAdGroupKeywordsResponse{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlanAdGroupKeywordsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateKeywordPlanAdGroupKeywordResult) Reset() {
	*x = MutateKeywordPlanAdGroupKeywordResult{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlanAdGroupKeywordResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4b, 0x65,
...
var (
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDescData = file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_goTypes = []any{
	(*MutateKeywordPlanAdGroupKeywordsRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordsRequest
	(*KeywordPlanAdGroupKeywordOperation)(nil),       // 1: google.ads.googleads.v24.services.KeywordPlanAdGroupKeywordOperation
	(*MutateKeywordPlanAdGroupKeywordsResponse)(nil), // 2: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordsResponse
	(*MutateKeywordPlanAdGroupKeywordResult)(nil),    // 3: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordResult
	(*fieldmaskpb.FieldMask)(nil),                    // 4: google.protobuf.FieldMask
	(*resources.KeywordPlanAdGroupKeyword)(nil),      // 5: google.ads.googleads.v24.resources.KeywordPlanAdGroupKeyword
	(*status.Status)(nil),                            // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordsRequest.operations:type_name -> google.ads.googleads.v24.services.KeywordPlanAdGroupKeywordOperation
	4, // 1: google.ads.googleads.v24.services.KeywordPlanAdGroupKeywordOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.KeywordPlanAdGroupKeywordOperation.create:type_name -> google.ads.googleads.v24.resources.KeywordPlanAdGroupKeyword
	5, // 3: google.ads.googleads.v24.services.KeywordPlanAdGroupKeywordOperation.update:type_name -> google.ads.googleads.v24.resources.KeywordPlanAdGroupKeyword
	6, // 4: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 5: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordsResponse.results:type_name -> google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordResult
	0, // 6: google.ads.googleads.v24.services.KeywordPlanAdGroupKeywordService.MutateKeywordPlanAdGroupKeywords:input_type -> google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordsRequest
	2, // 7: google.ads.googleads.v24.services.KeywordPlanAdGroupKeywordService.MutateKeywordPlanAdGroupKeywords:output_type -> google.ads.googleads.v24.services.MutateKeywordPlanAdGroupKeywordsResponse
...
func file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_init() {
	if File_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto = out.File
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_keyword_service_proto_depIdxs = nil
}
...
func (c *keywordPlanAdGroupKeywordServiceClient) MutateKeywordPlanAdGroupKeywords(ctx context.Context, in *MutateKeywordPlanAdGroupKeywordsRequest, opts ...grpc.CallOption) (*MutateKeywordPlanAdGroupKeywordsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.KeywordPlanAdGroupKeywordService/MutateKeywordPlanAdGroupKeywords", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _KeywordPlanAdGroupKeywordService_MutateKeywordPlanAdGroupKeywords_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.KeywordPlanAdGroupKeywordService/MutateKeywordPlanAdGroupKeywords",
	}
...
var _KeywordPlanAdGroupKeywordService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/keyword_plan_ad_group_keyword_service.proto",
}
