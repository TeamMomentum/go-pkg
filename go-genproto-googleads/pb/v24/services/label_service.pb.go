...
func (x *MutateLabelsRequest) Reset() {
	*x = MutateLabelsRequest{}
	mi := &file_google_ads_googleads_v24_services_label_service_proto_msgTypes[0]
...
func (*MutateLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *LabelOperation) Reset() {
	*x = LabelOperation{}
	mi := &file_google_ads_googleads_v24_services_label_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateLabelsResponse) Reset() {
	*x = MutateLabelsResponse{}
	mi := &file_google_ads_googleads_v24_services_label_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateLabelResult) Reset() {
	*x = MutateLabelResult{}
	mi := &file_google_ads_googleads_v24_services_label_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_label_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_label_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_label_service_proto_rawDesc = []byte{
	...
	0xd3, 0xe4, 0x93, 0x02, 0x31, 0x3a, 0x01, 0x2a, 0x22, 0x2c, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63,
...
var (
	file_google_ads_googleads_v24_services_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_label_service_proto_rawDescData = file_google_ads_googleads_v24_services_label_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_label_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_label_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_label_service_proto_goTypes = []any{
	(*MutateLabelsRequest)(nil),                            // 0: google.ads.googleads.v24.services.MutateLabelsRequest
	(*LabelOperation)(nil),                                 // 1: google.ads.googleads.v24.services.LabelOperation
	(*MutateLabelsResponse)(nil),                           // 2: google.ads.googleads.v24.services.MutateLabelsResponse
	(*MutateLabelResult)(nil),                              // 3: google.ads.googleads.v24.services.MutateLabelResult
	...
	(*resources.Label)(nil),                                // 6: google.ads.googleads.v24.resources.Label
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateLabelsRequest.operations:type_name -> google.ads.googleads.v24.services.LabelOperation
	4, // 1: google.ads.googleads.v24.services.MutateLabelsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.LabelOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.LabelOperation.create:type_name -> google.ads.googleads.v24.resources.Label
	6, // 4: google.ads.googleads.v24.services.LabelOperation.update:type_name -> google.ads.googleads.v24.resources.Label
	7, // 5: google.ads.googleads.v24.services.MutateLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateLabelsResponse.results:type_name -> google.ads.googleads.v24.services.MutateLabelResult
	6, // 7: google.ads.googleads.v24.services.MutateLabelResult.label:type_name -> google.ads.googleads.v24.resources.Label
	0, // 8: google.ads.googleads.v24.services.LabelService.MutateLabels:input_type -> google.ads.googleads.v24.services.MutateLabelsRequest
	2, // 9: google.ads.googleads.v24.services.LabelService.MutateLabels:output_type -> google.ads.googleads.v24.services.MutateLabelsResponse
...
func init() { file_google_ads_googleads_v24_services_label_service_proto_init() }
func file_google_ads_googleads_v24_services_label_service_proto_init() {
	if File_google_ads_googleads_v24_services_label_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_label_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_label_service_proto = out.File
	file_google_ads_googleads_v24_services_label_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_label_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_label_service_proto_depIdxs = nil
}
...
func (c *labelServiceClient) MutateLabels(ctx context.Context, in *MutateLabelsRequest, opts ...grpc.CallOption) (*MutateLabelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.LabelService/MutateLabels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LabelService_MutateLabels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.LabelService/MutateLabels",
	}
...
var _LabelService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/label_service.proto",
}
