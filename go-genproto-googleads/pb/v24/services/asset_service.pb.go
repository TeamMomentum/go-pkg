...
type MutateAssetsRequest struct {
	...
	ResponseContentType enums.ResponseContentTypeEnum_ResponseContentType `protobuf:"varint,3,opt,name=response_content_type,json=responseContentType,proto3,enum=google.ads.googleads.v24.enums.ResponseContentTypeEnum_ResponseContentType" json:"response_content_type,omitempty"`
...
func (x *MutateAssetsRequest) Reset() {
	*x = MutateAssetsRequest{}
	mi := &file_google_ads_googleads_v24_services_asset_service_proto_msgTypes[0]
...
func (*MutateAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetOperation) Reset() {
	*x = AssetOperation{}
	mi := &file_google_ads_googleads_v24_services_asset_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAssetsResponse) Reset() {
	*x = MutateAssetsResponse{}
	mi := &file_google_ads_googleads_v24_services_asset_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetResult) Reset() {
	*x = MutateAssetResult{}
	mi := &file_google_ads_googleads_v24_services_asset_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_asset_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_asset_service_proto_rawDesc = []byte{
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x31, 0x3a, 0x01, 0x2a, 0x22, 0x2c, 0x2f, 0x76, 0x32, 0x34, 0x2f,
...
var (
	file_google_ads_googleads_v24_services_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_asset_service_proto_rawDescData = file_google_ads_googleads_v24_services_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_asset_service_proto_goTypes = []any{
	(*MutateAssetsRequest)(nil),                            // 0: google.ads.googleads.v24.services.MutateAssetsRequest
	(*AssetOperation)(nil),                                 // 1: google.ads.googleads.v24.services.AssetOperation
	(*MutateAssetsResponse)(nil),                           // 2: google.ads.googleads.v24.services.MutateAssetsResponse
	(*MutateAssetResult)(nil),                              // 3: google.ads.googleads.v24.services.MutateAssetResult
	...
	(*resources.Asset)(nil),                                // 6: google.ads.googleads.v24.resources.Asset
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateAssetsRequest.operations:type_name -> google.ads.googleads.v24.services.AssetOperation
	4, // 1: google.ads.googleads.v24.services.MutateAssetsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.AssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.AssetOperation.create:type_name -> google.ads.googleads.v24.resources.Asset
	6, // 4: google.ads.googleads.v24.services.AssetOperation.update:type_name -> google.ads.googleads.v24.resources.Asset
	7, // 5: google.ads.googleads.v24.services.MutateAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateAssetsResponse.results:type_name -> google.ads.googleads.v24.services.MutateAssetResult
	6, // 7: google.ads.googleads.v24.services.MutateAssetResult.asset:type_name -> google.ads.googleads.v24.resources.Asset
	0, // 8: google.ads.googleads.v24.services.AssetService.MutateAssets:input_type -> google.ads.googleads.v24.services.MutateAssetsRequest
	2, // 9: google.ads.googleads.v24.services.AssetService.MutateAssets:output_type -> google.ads.googleads.v24.services.MutateAssetsResponse
...
func init() { file_google_ads_googleads_v24_services_asset_service_proto_init() }
func file_google_ads_googleads_v24_services_asset_service_proto_init() {
	if File_google_ads_googleads_v24_services_asset_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_asset_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_asset_service_proto = out.File
	file_google_ads_googleads_v24_services_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_asset_service_proto_depIdxs = nil
}
...
func (c *assetServiceClient) MutateAssets(ctx context.Context, in *MutateAssetsRequest, opts ...grpc.CallOption) (*MutateAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AssetService/MutateAssets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AssetService_MutateAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AssetService/MutateAssets",
	}
...
var _AssetService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/asset_service.proto",
}
