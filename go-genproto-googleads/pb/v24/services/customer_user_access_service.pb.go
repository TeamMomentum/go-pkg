...
func (x *MutateCustomerUserAccessRequest) Reset() {
	*x = MutateCustomerUserAccessRequest{}
	mi := &file_google_ads_googleads_v24_services_customer_user_access_service_proto_msgTypes[0]
...
func (*MutateCustomerUserAccessRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerUserAccessOperation) Reset() {
	*x = CustomerUserAccessOperation{}
	mi := &file_google_ads_googleads_v24_services_customer_user_access_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerUserAccessOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerUserAccessResponse) Reset() {
	*x = MutateCustomerUserAccessResponse{}
	mi := &file_google_ads_googleads_v24_services_customer_user_access_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerUserAccessResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerUserAccessResult) Reset() {
	*x = MutateCustomerUserAccessResult{}
	mi := &file_google_ads_googleads_v24_services_customer_user_access_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerUserAccessResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_customer_user_access_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x34, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x63, 0x75,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32,
	0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1e, 0x43, 0x75, 0x73, 0x74,
...
var (
	file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDescData = file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_customer_user_access_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_customer_user_access_service_proto_goTypes = []any{
	(*MutateCustomerUserAccessRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateCustomerUserAccessRequest
	(*CustomerUserAccessOperation)(nil),      // 1: google.ads.googleads.v24.services.CustomerUserAccessOperation
	(*MutateCustomerUserAccessResponse)(nil), // 2: google.ads.googleads.v24.services.MutateCustomerUserAccessResponse
	(*MutateCustomerUserAccessResult)(nil),   // 3: google.ads.googleads.v24.services.MutateCustomerUserAccessResult
	(*fieldmaskpb.FieldMask)(nil),            // 4: google.protobuf.FieldMask
	(*resources.CustomerUserAccess)(nil),     // 5: google.ads.googleads.v24.resources.CustomerUserAccess
}
var file_google_ads_googleads_v24_services_customer_user_access_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCustomerUserAccessRequest.operation:type_name -> google.ads.googleads.v24.services.CustomerUserAccessOperation
	4, // 1: google.ads.googleads.v24.services.CustomerUserAccessOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.CustomerUserAccessOperation.update:type_name -> google.ads.googleads.v24.resources.CustomerUserAccess
	3, // 3: google.ads.googleads.v24.services.MutateCustomerUserAccessResponse.result:type_name -> google.ads.googleads.v24.services.MutateCustomerUserAccessResult
	0, // 4: google.ads.googleads.v24.services.CustomerUserAccessService.MutateCustomerUserAccess:input_type -> google.ads.googleads.v24.services.MutateCustomerUserAccessRequest
	2, // 5: google.ads.googleads.v24.services.CustomerUserAccessService.MutateCustomerUserAccess:output_type -> google.ads.googleads.v24.services.MutateCustomerUserAccessResponse
...
func init() { file_google_ads_googleads_v24_services_customer_user_access_service_proto_init() }
func file_google_ads_googleads_v24_services_customer_user_access_service_proto_init() {
	if File_google_ads_googleads_v24_services_customer_user_access_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_customer_user_access_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_customer_user_access_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_customer_user_access_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_customer_user_access_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_customer_user_access_service_proto = out.File
	file_google_ads_googleads_v24_services_customer_user_access_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_customer_user_access_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_customer_user_access_service_proto_depIdxs = nil
}
...
func (c *customerUserAccessServiceClient) MutateCustomerUserAccess(ctx context.Context, in *MutateCustomerUserAccessRequest, opts ...grpc.CallOption) (*MutateCustomerUserAccessResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomerUserAccessService/MutateCustomerUserAccess", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerUserAccessService_MutateCustomerUserAccess_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomerUserAccessService/MutateCustomerUserAccess",
	}
...
var _CustomerUserAccessService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/customer_user_access_service.proto",
}
