...
func (x *MutateCampaignCustomizersRequest) Reset() {
	*x = MutateCampaignCustomizersRequest{}
	mi := &file_google_ads_googleads_v24_services_campaign_customizer_service_proto_msgTypes[0]
...
func (*MutateCampaignCustomizersRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignCustomizerOperation) Reset() {
	*x = CampaignCustomizerOperation{}
	mi := &file_google_ads_googleads_v24_services_campaign_customizer_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CampaignCustomizerOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignCustomizersResponse) Reset() {
	*x = MutateCampaignCustomizersResponse{}
	mi := &file_google_ads_googleads_v24_services_campaign_customizer_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignCustomizersResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignCustomizerResult) Reset() {
	*x = MutateCampaignCustomizerResult{}
	mi := &file_google_ads_googleads_v24_services_campaign_customizer_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignCustomizerResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_campaign_customizer_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDescData = file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_campaign_customizer_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_campaign_customizer_service_proto_goTypes = []any{
	(*MutateCampaignCustomizersRequest)(nil),               // 0: google.ads.googleads.v24.services.MutateCampaignCustomizersRequest
	(*CampaignCustomizerOperation)(nil),                    // 1: google.ads.googleads.v24.services.CampaignCustomizerOperation
	(*MutateCampaignCustomizersResponse)(nil),              // 2: google.ads.googleads.v24.services.MutateCampaignCustomizersResponse
	(*MutateCampaignCustomizerResult)(nil),                 // 3: google.ads.googleads.v24.services.MutateCampaignCustomizerResult
	...
	(*resources.CampaignCustomizer)(nil),                   // 5: google.ads.googleads.v24.resources.CampaignCustomizer
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_campaign_customizer_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCampaignCustomizersRequest.operations:type_name -> google.ads.googleads.v24.services.CampaignCustomizerOperation
	4, // 1: google.ads.googleads.v24.services.MutateCampaignCustomizersRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.CampaignCustomizerOperation.create:type_name -> google.ads.googleads.v24.resources.CampaignCustomizer
	3, // 3: google.ads.googleads.v24.services.MutateCampaignCustomizersResponse.results:type_name -> google.ads.googleads.v24.services.MutateCampaignCustomizerResult
	6, // 4: google.ads.googleads.v24.services.MutateCampaignCustomizersResponse.partial_failure_error:type_name -> google.rpc.Status
	5, // 5: google.ads.googleads.v24.services.MutateCampaignCustomizerResult.campaign_customizer:type_name -> google.ads.googleads.v24.resources.CampaignCustomizer
	0, // 6: google.ads.googleads.v24.services.CampaignCustomizerService.MutateCampaignCustomizers:input_type -> google.ads.googleads.v24.services.MutateCampaignCustomizersRequest
	2, // 7: google.ads.googleads.v24.services.CampaignCustomizerService.MutateCampaignCustomizers:output_type -> google.ads.googleads.v24.services.MutateCampaignCustomizersResponse
...
func init() { file_google_ads_googleads_v24_services_campaign_customizer_service_proto_init() }
func file_google_ads_googleads_v24_services_campaign_customizer_service_proto_init() {
	if File_google_ads_googleads_v24_services_campaign_customizer_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_campaign_customizer_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_campaign_customizer_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_campaign_customizer_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_campaign_customizer_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_campaign_customizer_service_proto = out.File
	file_google_ads_googleads_v24_services_campaign_customizer_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_campaign_customizer_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_campaign_customizer_service_proto_depIdxs = nil
}
...
func (c *campaignCustomizerServiceClient) MutateCampaignCustomizers(ctx context.Context, in *MutateCampaignCustomizersRequest, opts ...grpc.CallOption) (*MutateCampaignCustomizersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CampaignCustomizerService/MutateCampaignCustomizers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignCustomizerService_MutateCampaignCustomizers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CampaignCustomizerService/MutateCampaignCustomizers",
	}
...
var _CampaignCustomizerService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/campaign_customizer_service.proto",
}
