...
func (x *CreateAccountLinkRequest) Reset() {
	*x = CreateAccountLinkRequest{}
	mi := &file_google_ads_googleads_v24_services_account_link_service_proto_msgTypes[0]
...
func (*CreateAccountLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_account_link_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateAccountLinkResponse) Reset() {
	*x = CreateAccountLinkResponse{}
	mi := &file_google_ads_googleads_v24_services_account_link_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateAccountLinkResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_account_link_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAccountLinkRequest) Reset() {
	*x = MutateAccountLinkRequest{}
	mi := &file_google_ads_googleads_v24_services_account_link_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAccountLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_account_link_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *AccountLinkOperation) Reset() {
	*x = AccountLinkOperation{}
	mi := &file_google_ads_googleads_v24_services_account_link_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AccountLinkOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_account_link_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MutateAccountLinkResponse) Reset() {
	*x = MutateAccountLinkResponse{}
	mi := &file_google_ads_googleads_v24_services_account_link_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAccountLinkResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_account_link_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *MutateAccountLinkResult) Reset() {
	*x = MutateAccountLinkResult{}
	mi := &file_google_ads_googleads_v24_services_account_link_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAccountLinkResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_account_link_service_proto_rawDescGZIP(), []int{5}
}
...
var File_google_ads_googleads_v24_services_account_link_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_account_link_service_proto_rawDesc = []byte{
	...
	0x01, 0x2a, 0x22, 0x32, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65,
	...
	0x6e, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x37, 0x3a, 0x01, 0x2a, 0x22, 0x32, 0x2f, 0x76, 0x32, 0x34,
...
var (
	file_google_ads_googleads_v24_services_account_link_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_account_link_service_proto_rawDescData = file_google_ads_googleads_v24_services_account_link_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_account_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_account_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_account_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_account_link_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_account_link_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_account_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_google_ads_googleads_v24_services_account_link_service_proto_goTypes = []any{
	(*CreateAccountLinkRequest)(nil),  // 0: google.ads.googleads.v24.services.CreateAccountLinkRequest
	(*CreateAccountLinkResponse)(nil), // 1: google.ads.googleads.v24.services.CreateAccountLinkResponse
	(*MutateAccountLinkRequest)(nil),  // 2: google.ads.googleads.v24.services.MutateAccountLinkRequest
	(*AccountLinkOperation)(nil),      // 3: google.ads.googleads.v24.services.AccountLinkOperation
	(*MutateAccountLinkResponse)(nil), // 4: google.ads.googleads.v24.services.MutateAccountLinkResponse
	(*MutateAccountLinkResult)(nil),   // 5: google.ads.googleads.v24.services.MutateAccountLinkResult
	(*resources.AccountLink)(nil),     // 6: google.ads.googleads.v24.resources.AccountLink
	(*fieldmaskpb.FieldMask)(nil),     // 7: google.protobuf.FieldMask
	(*status.Status)(nil),             // 8: google.rpc.Status
}
var file_google_ads_googleads_v24_services_account_link_service_proto_depIdxs = []int32{
	6, // 0: google.ads.googleads.v24.services.CreateAccountLinkRequest.account_link:type_name -> google.ads.googleads.v24.resources.AccountLink
	3, // 1: google.ads.googleads.v24.services.MutateAccountLinkRequest.operation:type_name -> google.ads.googleads.v24.services.AccountLinkOperation
	7, // 2: google.ads.googleads.v24.services.AccountLinkOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.AccountLinkOperation.update:type_name -> google.ads.googleads.v24.resources.AccountLink
	5, // 4: google.ads.googleads.v24.services.MutateAccountLinkResponse.result:type_name -> google.ads.googleads.v24.services.MutateAccountLinkResult
	8, // 5: google.ads.googleads.v24.services.MutateAccountLinkResponse.partial_failure_error:type_name -> google.rpc.Status
	0, // 6: google.ads.googleads.v24.services.AccountLinkService.CreateAccountLink:input_type -> google.ads.googleads.v24.services.CreateAccountLinkRequest
	2, // 7: google.ads.googleads.v24.services.AccountLinkService.MutateAccountLink:input_type -> google.ads.googleads.v24.services.MutateAccountLinkRequest
	1, // 8: google.ads.googleads.v24.services.AccountLinkService.CreateAccountLink:output_type -> google.ads.googleads.v24.services.CreateAccountLinkResponse
	4, // 9: google.ads.googleads.v24.services.AccountLinkService.MutateAccountLink:output_type -> google.ads.googleads.v24.services.MutateAccountLinkResponse
...
func init() { file_google_ads_googleads_v24_services_account_link_service_proto_init() }
func file_google_ads_googleads_v24_services_account_link_service_proto_init() {
	if File_google_ads_googleads_v24_services_account_link_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_account_link_service_proto_msgTypes[3].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_account_link_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_account_link_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_account_link_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_account_link_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_account_link_service_proto = out.File
	file_google_ads_googleads_v24_services_account_link_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_account_link_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_account_link_service_proto_depIdxs = nil
}
...
func (c *accountLinkServiceClient) CreateAccountLink(ctx context.Context, in *CreateAccountLinkRequest, opts ...grpc.CallOption) (*CreateAccountLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AccountLinkService/CreateAccountLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountLinkServiceClient) MutateAccountLink(ctx context.Context, in *MutateAccountLinkRequest, opts ...grpc.CallOption) (*MutateAccountLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AccountLinkService/MutateAccountLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AccountLinkService_CreateAccountLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AccountLinkService/CreateAccountLink",
	}
...
func _AccountLinkService_MutateAccountLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AccountLinkService/MutateAccountLink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _AccountLinkService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/account_link_service.proto",
}
