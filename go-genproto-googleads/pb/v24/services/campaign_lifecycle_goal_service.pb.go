...
func (x *ConfigureCampaignLifecycleGoalsRequest) Reset() {
	*x = ConfigureCampaignLifecycleGoalsRequest{}
	mi := &file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_msgTypes[0]
...
func (*ConfigureCampaignLifecycleGoalsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignLifecycleGoalOperation) Reset() {
	*x = CampaignLifecycleGoalOperation{}
	mi := &file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CampaignLifecycleGoalOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *ConfigureCampaignLifecycleGoalsResponse) Reset() {
	*x = ConfigureCampaignLifecycleGoalsResponse{}
	mi := &file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConfigureCampaignLifecycleGoalsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *ConfigureCampaignLifecycleGoalsResult) Reset() {
	*x = ConfigureCampaignLifecycleGoalsResult{}
	mi := &file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConfigureCampaignLifecycleGoalsResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDescData = file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_goTypes = []any{
	(*ConfigureCampaignLifecycleGoalsRequest)(nil),  // 0: google.ads.googleads.v24.services.ConfigureCampaignLifecycleGoalsRequest
	(*CampaignLifecycleGoalOperation)(nil),          // 1: google.ads.googleads.v24.services.CampaignLifecycleGoalOperation
	(*ConfigureCampaignLifecycleGoalsResponse)(nil), // 2: google.ads.googleads.v24.services.ConfigureCampaignLifecycleGoalsResponse
	(*ConfigureCampaignLifecycleGoalsResult)(nil),   // 3: google.ads.googleads.v24.services.ConfigureCampaignLifecycleGoalsResult
	(*fieldmaskpb.FieldMask)(nil),                   // 4: google.protobuf.FieldMask
	(*resources.CampaignLifecycleGoal)(nil),         // 5: google.ads.googleads.v24.resources.CampaignLifecycleGoal
}
var file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.ConfigureCampaignLifecycleGoalsRequest.operation:type_name -> google.ads.googleads.v24.services.CampaignLifecycleGoalOperation
	4, // 1: google.ads.googleads.v24.services.CampaignLifecycleGoalOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.CampaignLifecycleGoalOperation.create:type_name -> google.ads.googleads.v24.resources.CampaignLifecycleGoal
	5, // 3: google.ads.googleads.v24.services.CampaignLifecycleGoalOperation.update:type_name -> google.ads.googleads.v24.resources.CampaignLifecycleGoal
	3, // 4: google.ads.googleads.v24.services.ConfigureCampaignLifecycleGoalsResponse.result:type_name -> google.ads.googleads.v24.services.ConfigureCampaignLifecycleGoalsResult
	0, // 5: google.ads.googleads.v24.services.CampaignLifecycleGoalService.ConfigureCampaignLifecycleGoals:input_type -> google.ads.googleads.v24.services.ConfigureCampaignLifecycleGoalsRequest
	2, // 6: google.ads.googleads.v24.services.CampaignLifecycleGoalService.ConfigureCampaignLifecycleGoals:output_type -> google.ads.googleads.v24.services.ConfigureCampaignLifecycleGoalsResponse
...
func init() { file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_init() }
func file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_init() {
	if File_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto = out.File
	file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_campaign_lifecycle_goal_service_proto_depIdxs = nil
}
...
func (c *campaignLifecycleGoalServiceClient) ConfigureCampaignLifecycleGoals(ctx context.Context, in *ConfigureCampaignLifecycleGoalsRequest, opts ...grpc.CallOption) (*ConfigureCampaignLifecycleGoalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CampaignLifecycleGoalService/ConfigureCampaignLifecycleGoals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCampaignLifecycleGoalServiceServer can be embedded to have forward compatible implementations.
...
func RegisterCampaignLifecycleGoalServiceServer(s *grpc.Server, srv CampaignLifecycleGoalServiceServer) {
	s.RegisterService(&_CampaignLifecycleGoalService_serviceDesc, srv)
}
...
func _CampaignLifecycleGoalService_ConfigureCampaignLifecycleGoals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CampaignLifecycleGoalService/ConfigureCampaignLifecycleGoals",
	}
...
var _CampaignLifecycleGoalService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/campaign_lifecycle_goal_service.proto",
}
