...
func (x *MutateAdGroupCriterionLabelsRequest) Reset() {
	*x = MutateAdGroupCriterionLabelsRequest{}
	mi := &file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_msgTypes[0]
...
func (*MutateAdGroupCriterionLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupCriterionLabelOperation) Reset() {
	*x = AdGroupCriterionLabelOperation{}
	mi := &file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdGroupCriterionLabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupCriterionLabelsResponse) Reset() {
	*x = MutateAdGroupCriterionLabelsResponse{}
	mi := &file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupCriterionLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupCriterionLabelResult) Reset() {
	*x = MutateAdGroupCriterionLabelResult{}
	mi := &file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupCriterionLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDescData = file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_goTypes = []any{
	(*MutateAdGroupCriterionLabelsRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateAdGroupCriterionLabelsRequest
	(*AdGroupCriterionLabelOperation)(nil),       // 1: google.ads.googleads.v24.services.AdGroupCriterionLabelOperation
	(*MutateAdGroupCriterionLabelsResponse)(nil), // 2: google.ads.googleads.v24.services.MutateAdGroupCriterionLabelsResponse
	(*MutateAdGroupCriterionLabelResult)(nil),    // 3: google.ads.googleads.v24.services.MutateAdGroupCriterionLabelResult
	(*resources.AdGroupCriterionLabel)(nil),      // 4: google.ads.googleads.v24.resources.AdGroupCriterionLabel
	(*status.Status)(nil),                        // 5: google.rpc.Status
}
var file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateAdGroupCriterionLabelsRequest.operations:type_name -> google.ads.googleads.v24.services.AdGroupCriterionLabelOperation
	4, // 1: google.ads.googleads.v24.services.AdGroupCriterionLabelOperation.create:type_name -> google.ads.googleads.v24.resources.AdGroupCriterionLabel
	5, // 2: google.ads.googleads.v24.services.MutateAdGroupCriterionLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 3: google.ads.googleads.v24.services.MutateAdGroupCriterionLabelsResponse.results:type_name -> google.ads.googleads.v24.services.MutateAdGroupCriterionLabelResult
	0, // 4: google.ads.googleads.v24.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:input_type -> google.ads.googleads.v24.services.MutateAdGroupCriterionLabelsRequest
	2, // 5: google.ads.googleads.v24.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:output_type -> google.ads.googleads.v24.services.MutateAdGroupCriterionLabelsResponse
...
func init() { file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_init() }
func file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_init() {
	if File_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto = out.File
	file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_ad_group_criterion_label_service_proto_depIdxs = nil
}
...
func (c *adGroupCriterionLabelServiceClient) MutateAdGroupCriterionLabels(ctx context.Context, in *MutateAdGroupCriterionLabelsRequest, opts ...grpc.CallOption) (*MutateAdGroupCriterionLabelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdGroupCriterionLabelService_MutateAdGroupCriterionLabels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AdGroupCriterionLabelService/MutateAdGroupCriterionLabels",
	}
...
var _AdGroupCriterionLabelService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/ad_group_criterion_label_service.proto",
}
