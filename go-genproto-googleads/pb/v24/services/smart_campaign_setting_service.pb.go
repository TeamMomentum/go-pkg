...
func (x *GetSmartCampaignStatusRequest) Reset() {
	*x = GetSmartCampaignStatusRequest{}
	mi := &file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[0]
...
func (*GetSmartCampaignStatusRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{0}
}
...
type SmartCampaignNotEligibleDetails struct {
	...
	NotEligibleReason *enums.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason `protobuf:"varint,1,opt,name=not_eligible_reason,json=notEligibleReason,proto3,enum=google.ads.googleads.v24.enums.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason,oneof" json:"not_eligible_reason,omitempty"`
}

func (x *SmartCampaignNotEligibleDetails) Reset() {
	*x = SmartCampaignNotEligibleDetails{}
	mi := &file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SmartCampaignNotEligibleDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *SmartCampaignEligibleDetails) Reset() {
	*x = SmartCampaignEligibleDetails{}
	mi := &file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SmartCampaignEligibleDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *SmartCampaignPausedDetails) Reset() {
	*x = SmartCampaignPausedDetails{}
	mi := &file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SmartCampaignPausedDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *SmartCampaignRemovedDetails) Reset() {
	*x = SmartCampaignRemovedDetails{}
	mi := &file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SmartCampaignRemovedDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *SmartCampaignEndedDetails) Reset() {
	*x = SmartCampaignEndedDetails{}
	mi := &file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SmartCampaignEndedDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{5}
}
...
type GetSmartCampaignStatusResponse struct {
	...
	SmartCampaignStatus enums.SmartCampaignStatusEnum_SmartCampaignStatus `protobuf:"varint,1,opt,name=smart_campaign_status,json=smartCampaignStatus,proto3,enum=google.ads.googleads.v24.enums.SmartCampaignStatusEnum_SmartCampaignStatus" json:"smart_campaign_status,omitempty"`
...
func (x *GetSmartCampaignStatusResponse) Reset() {
	*x = GetSmartCampaignStatusResponse{}
	mi := &file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetSmartCampaignStatusResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{6}
}
...
func (x *MutateSmartCampaignSettingsRequest) Reset() {
	*x = MutateSmartCampaignSettingsRequest{}
	mi := &file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateSmartCampaignSettingsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{7}
}
...
func (x *SmartCampaignSettingOperation) Reset() {
	*x = SmartCampaignSettingOperation{}
	mi := &file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SmartCampaignSettingOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{8}
}
...
func (x *MutateSmartCampaignSettingsResponse) Reset() {
	*x = MutateSmartCampaignSettingsResponse{}
	mi := &file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateSmartCampaignSettingsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{9}
}
...
func (x *MutateSmartCampaignSettingResult) Reset() {
	*x = MutateSmartCampaignSettingResult{}
	mi := &file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateSmartCampaignSettingResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP(), []int{10}
}
...
var File_google_ads_googleads_v24_services_smart_campaign_setting_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x3a, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x72, 0x65, 0x73, 0x70,
	...
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x6d, 0x61, 0x72,
	...
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x6d, 0x61, 0x72, 0x74,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x52, 0x65, 0x73,
	...
	0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x47, 0x65, 0x74,
	...
	0x93, 0x02, 0x51, 0x12, 0x4f, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x7b, 0x72, 0x65, 0x73, 0x6f, 0x75,
	...
	0xe4, 0x93, 0x02, 0x40, 0x3a, 0x01, 0x2a, 0x22, 0x3b, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75,
	...
	0x32, 0x34, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x3b, 0x73, 0x65, 0x72, 0x76,
	...
	0x73, 0x2e, 0x56, 0x32, 0x34, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0xca, 0x02,
	0x21, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x41, 0x64, 0x73, 0x5c, 0x56, 0x32, 0x34, 0x5c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var (
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescData = file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_goTypes = []any{
	(*GetSmartCampaignStatusRequest)(nil),                                        // 0: google.ads.googleads.v24.services.GetSmartCampaignStatusRequest
	(*SmartCampaignNotEligibleDetails)(nil),                                      // 1: google.ads.googleads.v24.services.SmartCampaignNotEligibleDetails
	(*SmartCampaignEligibleDetails)(nil),                                         // 2: google.ads.googleads.v24.services.SmartCampaignEligibleDetails
	(*SmartCampaignPausedDetails)(nil),                                           // 3: google.ads.googleads.v24.services.SmartCampaignPausedDetails
	(*SmartCampaignRemovedDetails)(nil),                                          // 4: google.ads.googleads.v24.services.SmartCampaignRemovedDetails
	(*SmartCampaignEndedDetails)(nil),                                            // 5: google.ads.googleads.v24.services.SmartCampaignEndedDetails
	(*GetSmartCampaignStatusResponse)(nil),                                       // 6: google.ads.googleads.v24.services.GetSmartCampaignStatusResponse
	(*MutateSmartCampaignSettingsRequest)(nil),                                   // 7: google.ads.googleads.v24.services.MutateSmartCampaignSettingsRequest
	(*SmartCampaignSettingOperation)(nil),                                        // 8: google.ads.googleads.v24.services.SmartCampaignSettingOperation
	(*MutateSmartCampaignSettingsResponse)(nil),                                  // 9: google.ads.googleads.v24.services.MutateSmartCampaignSettingsResponse
	(*MutateSmartCampaignSettingResult)(nil),                                     // 10: google.ads.googleads.v24.services.MutateSmartCampaignSettingResult
	(enums.SmartCampaignNotEligibleReasonEnum_SmartCampaignNotEligibleReason)(0), // 11: google.ads.googleads.v24.enums.SmartCampaignNotEligibleReasonEnum.SmartCampaignNotEligibleReason
	(enums.SmartCampaignStatusEnum_SmartCampaignStatus)(0),                       // 12: google.ads.googleads.v24.enums.SmartCampaignStatusEnum.SmartCampaignStatus
	(enums.ResponseContentTypeEnum_ResponseContentType)(0),                       // 13: google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	(*resources.SmartCampaignSetting)(nil),                                       // 14: google.ads.googleads.v24.resources.SmartCampaignSetting
	(*fieldmaskpb.FieldMask)(nil),                                                // 15: google.protobuf.FieldMask
	(*status.Status)(nil),                                                        // 16: google.rpc.Status
}
var file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_depIdxs = []int32{
	11, // 0: google.ads.googleads.v24.services.SmartCampaignNotEligibleDetails.not_eligible_reason:type_name -> google.ads.googleads.v24.enums.SmartCampaignNotEligibleReasonEnum.SmartCampaignNotEligibleReason
	12, // 1: google.ads.googleads.v24.services.GetSmartCampaignStatusResponse.smart_campaign_status:type_name -> google.ads.googleads.v24.enums.SmartCampaignStatusEnum.SmartCampaignStatus
	1,  // 2: google.ads.googleads.v24.services.GetSmartCampaignStatusResponse.not_eligible_details:type_name -> google.ads.googleads.v24.services.SmartCampaignNotEligibleDetails
	2,  // 3: google.ads.googleads.v24.services.GetSmartCampaignStatusResponse.eligible_details:type_name -> google.ads.googleads.v24.services.SmartCampaignEligibleDetails
	3,  // 4: google.ads.googleads.v24.services.GetSmartCampaignStatusResponse.paused_details:type_name -> google.ads.googleads.v24.services.SmartCampaignPausedDetails
	4,  // 5: google.ads.googleads.v24.services.GetSmartCampaignStatusResponse.removed_details:type_name -> google.ads.googleads.v24.services.SmartCampaignRemovedDetails
	5,  // 6: google.ads.googleads.v24.services.GetSmartCampaignStatusResponse.ended_details:type_name -> google.ads.googleads.v24.services.SmartCampaignEndedDetails
	8,  // 7: google.ads.googleads.v24.services.MutateSmartCampaignSettingsRequest.operations:type_name -> google.ads.googleads.v24.services.SmartCampaignSettingOperation
	13, // 8: google.ads.googleads.v24.services.MutateSmartCampaignSettingsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	14, // 9: google.ads.googleads.v24.services.SmartCampaignSettingOperation.update:type_name -> google.ads.googleads.v24.resources.SmartCampaignSetting
	15, // 10: google.ads.googleads.v24.services.SmartCampaignSettingOperation.update_mask:type_name -> google.protobuf.FieldMask
	16, // 11: google.ads.googleads.v24.services.MutateSmartCampaignSettingsResponse.partial_failure_error:type_name -> google.rpc.Status
	10, // 12: google.ads.googleads.v24.services.MutateSmartCampaignSettingsResponse.results:type_name -> google.ads.googleads.v24.services.MutateSmartCampaignSettingResult
	14, // 13: google.ads.googleads.v24.services.MutateSmartCampaignSettingResult.smart_campaign_setting:type_name -> google.ads.googleads.v24.resources.SmartCampaignSetting
	0,  // 14: google.ads.googleads.v24.services.SmartCampaignSettingService.GetSmartCampaignStatus:input_type -> google.ads.googleads.v24.services.GetSmartCampaignStatusRequest
	7,  // 15: google.ads.googleads.v24.services.SmartCampaignSettingService.MutateSmartCampaignSettings:input_type -> google.ads.googleads.v24.services.MutateSmartCampaignSettingsRequest
	6,  // 16: google.ads.googleads.v24.services.SmartCampaignSettingService.GetSmartCampaignStatus:output_type -> google.ads.googleads.v24.services.GetSmartCampaignStatusResponse
	9,  // 17: google.ads.googleads.v24.services.SmartCampaignSettingService.MutateSmartCampaignSettings:output_type -> google.ads.googleads.v24.services.MutateSmartCampaignSettingsResponse
...
func init() { file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_init() }
func file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_init() {
	if File_google_ads_googleads_v24_services_smart_campaign_setting_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[1].OneofWrappers = []any{}
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[2].OneofWrappers = []any{}
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[3].OneofWrappers = []any{}
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[4].OneofWrappers = []any{}
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[5].OneofWrappers = []any{}
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes[6].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_smart_campaign_setting_service_proto = out.File
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_smart_campaign_setting_service_proto_depIdxs = nil
}
...
func (c *smartCampaignSettingServiceClient) GetSmartCampaignStatus(ctx context.Context, in *GetSmartCampaignStatusRequest, opts ...grpc.CallOption) (*GetSmartCampaignStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.SmartCampaignSettingService/GetSmartCampaignStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *smartCampaignSettingServiceClient) MutateSmartCampaignSettings(ctx context.Context, in *MutateSmartCampaignSettingsRequest, opts ...grpc.CallOption) (*MutateSmartCampaignSettingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.SmartCampaignSettingService/MutateSmartCampaignSettings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedSmartCampaignSettingServiceServer) GetSmartCampaignStatus(context.Context, *GetSmartCampaignStatusRequest) (*GetSmartCampaignStatusResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method GetSmartCampaignStatus not implemented")
}
...
func _SmartCampaignSettingService_GetSmartCampaignStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.SmartCampaignSettingService/GetSmartCampaignStatus",
	}
...
func _SmartCampaignSettingService_MutateSmartCampaignSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.SmartCampaignSettingService/MutateSmartCampaignSettings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _SmartCampaignSettingService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/smart_campaign_setting_service.proto",
}
