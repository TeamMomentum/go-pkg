...
func (x *MutateAdGroupCriteriaRequest) Reset() {
	*x = MutateAdGroupCriteriaRequest{}
	mi := &file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_msgTypes[0]
...
func (*MutateAdGroupCriteriaRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupCriterionOperation) Reset() {
	*x = AdGroupCriterionOperation{}
	mi := &file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdGroupCriterionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupCriteriaResponse) Reset() {
	*x = MutateAdGroupCriteriaResponse{}
	mi := &file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupCriteriaResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupCriterionResult) Reset() {
	*x = MutateAdGroupCriterionResult{}
	mi := &file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupCriterionResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_ad_group_criterion_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDesc = []byte{
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x3a, 0x3a, 0x01, 0x2a, 0x22, 0x35, 0x2f, 0x76, 0x32, 0x34, 0x2f,
...
var (
	file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDescData = file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_goTypes = []any{
	(*MutateAdGroupCriteriaRequest)(nil),                   // 0: google.ads.googleads.v24.services.MutateAdGroupCriteriaRequest
	(*AdGroupCriterionOperation)(nil),                      // 1: google.ads.googleads.v24.services.AdGroupCriterionOperation
	(*MutateAdGroupCriteriaResponse)(nil),                  // 2: google.ads.googleads.v24.services.MutateAdGroupCriteriaResponse
	(*MutateAdGroupCriterionResult)(nil),                   // 3: google.ads.googleads.v24.services.MutateAdGroupCriterionResult
	...
	(*common.PolicyViolationKey)(nil),                      // 6: google.ads.googleads.v24.common.PolicyViolationKey
	(*resources.AdGroupCriterion)(nil),                     // 7: google.ads.googleads.v24.resources.AdGroupCriterion
	(*status.Status)(nil),                                  // 8: google.rpc.Status
}
var file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_depIdxs = []int32{
	1,  // 0: google.ads.googleads.v24.services.MutateAdGroupCriteriaRequest.operations:type_name -> google.ads.googleads.v24.services.AdGroupCriterionOperation
	4,  // 1: google.ads.googleads.v24.services.MutateAdGroupCriteriaRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5,  // 2: google.ads.googleads.v24.services.AdGroupCriterionOperation.update_mask:type_name -> google.protobuf.FieldMask
	6,  // 3: google.ads.googleads.v24.services.AdGroupCriterionOperation.exempt_policy_violation_keys:type_name -> google.ads.googleads.v24.common.PolicyViolationKey
	7,  // 4: google.ads.googleads.v24.services.AdGroupCriterionOperation.create:type_name -> google.ads.googleads.v24.resources.AdGroupCriterion
	7,  // 5: google.ads.googleads.v24.services.AdGroupCriterionOperation.update:type_name -> google.ads.googleads.v24.resources.AdGroupCriterion
	8,  // 6: google.ads.googleads.v24.services.MutateAdGroupCriteriaResponse.partial_failure_error:type_name -> google.rpc.Status
	3,  // 7: google.ads.googleads.v24.services.MutateAdGroupCriteriaResponse.results:type_name -> google.ads.googleads.v24.services.MutateAdGroupCriterionResult
	7,  // 8: google.ads.googleads.v24.services.MutateAdGroupCriterionResult.ad_group_criterion:type_name -> google.ads.googleads.v24.resources.AdGroupCriterion
	0,  // 9: google.ads.googleads.v24.services.AdGroupCriterionService.MutateAdGroupCriteria:input_type -> google.ads.googleads.v24.services.MutateAdGroupCriteriaRequest
	2,  // 10: google.ads.googleads.v24.services.AdGroupCriterionService.MutateAdGroupCriteria:output_type -> google.ads.googleads.v24.services.MutateAdGroupCriteriaResponse
...
func init() { file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_init() }
func file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_init() {
	if File_google_ads_googleads_v24_services_ad_group_criterion_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_ad_group_criterion_service_proto = out.File
	file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_ad_group_criterion_service_proto_depIdxs = nil
}
...
func (c *adGroupCriterionServiceClient) MutateAdGroupCriteria(ctx context.Context, in *MutateAdGroupCriteriaRequest, opts ...grpc.CallOption) (*MutateAdGroupCriteriaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AdGroupCriterionService/MutateAdGroupCriteria", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdGroupCriterionService_MutateAdGroupCriteria_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AdGroupCriterionService/MutateAdGroupCriteria",
	}
...
var _AdGroupCriterionService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/ad_group_criterion_service.proto",
}
