...
func (x *MutateCampaignAssetsRequest) Reset() {
	*x = MutateCampaignAssetsRequest{}
	mi := &file_google_ads_googleads_v24_services_campaign_asset_service_proto_msgTypes[0]
...
func (*MutateCampaignAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignAssetOperation) Reset() {
	*x = CampaignAssetOperation{}
	mi := &file_google_ads_googleads_v24_services_campaign_asset_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CampaignAssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignAssetsResponse) Reset() {
	*x = MutateCampaignAssetsResponse{}
	mi := &file_google_ads_googleads_v24_services_campaign_asset_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignAssetResult) Reset() {
	*x = MutateCampaignAssetResult{}
	mi := &file_google_ads_googleads_v24_services_campaign_asset_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_campaign_asset_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDescData = file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_campaign_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_campaign_asset_service_proto_goTypes = []any{
	(*MutateCampaignAssetsRequest)(nil),                    // 0: google.ads.googleads.v24.services.MutateCampaignAssetsRequest
	(*CampaignAssetOperation)(nil),                         // 1: google.ads.googleads.v24.services.CampaignAssetOperation
	(*MutateCampaignAssetsResponse)(nil),                   // 2: google.ads.googleads.v24.services.MutateCampaignAssetsResponse
	(*MutateCampaignAssetResult)(nil),                      // 3: google.ads.googleads.v24.services.MutateCampaignAssetResult
	...
	(*resources.CampaignAsset)(nil),                        // 6: google.ads.googleads.v24.resources.CampaignAsset
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_campaign_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCampaignAssetsRequest.operations:type_name -> google.ads.googleads.v24.services.CampaignAssetOperation
	4, // 1: google.ads.googleads.v24.services.MutateCampaignAssetsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.CampaignAssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.CampaignAssetOperation.create:type_name -> google.ads.googleads.v24.resources.CampaignAsset
	6, // 4: google.ads.googleads.v24.services.CampaignAssetOperation.update:type_name -> google.ads.googleads.v24.resources.CampaignAsset
	7, // 5: google.ads.googleads.v24.services.MutateCampaignAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateCampaignAssetsResponse.results:type_name -> google.ads.googleads.v24.services.MutateCampaignAssetResult
	6, // 7: google.ads.googleads.v24.services.MutateCampaignAssetResult.campaign_asset:type_name -> google.ads.googleads.v24.resources.CampaignAsset
	0, // 8: google.ads.googleads.v24.services.CampaignAssetService.MutateCampaignAssets:input_type -> google.ads.googleads.v24.services.MutateCampaignAssetsRequest
	2, // 9: google.ads.googleads.v24.services.CampaignAssetService.MutateCampaignAssets:output_type -> google.ads.googleads.v24.services.MutateCampaignAssetsResponse
...
func init() { file_google_ads_googleads_v24_services_campaign_asset_service_proto_init() }
func file_google_ads_googleads_v24_services_campaign_asset_service_proto_init() {
	if File_google_ads_googleads_v24_services_campaign_asset_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_campaign_asset_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_campaign_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_campaign_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_campaign_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_campaign_asset_service_proto = out.File
	file_google_ads_googleads_v24_services_campaign_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_campaign_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_campaign_asset_service_proto_depIdxs = nil
}
...
func (c *campaignAssetServiceClient) MutateCampaignAssets(ctx context.Context, in *MutateCampaignAssetsRequest, opts ...grpc.CallOption) (*MutateCampaignAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CampaignAssetService/MutateCampaignAssets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignAssetService_MutateCampaignAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CampaignAssetService/MutateCampaignAssets",
	}
...
var _CampaignAssetService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/campaign_asset_service.proto",
}
