...
func (x *MutateAccountBudgetProposalRequest) Reset() {
	*x = MutateAccountBudgetProposalRequest{}
	mi := &file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_msgTypes[0]
...
func (*MutateAccountBudgetProposalRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AccountBudgetProposalOperation) Reset() {
	*x = AccountBudgetProposalOperation{}
	mi := &file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AccountBudgetProposalOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAccountBudgetProposalResponse) Reset() {
	*x = MutateAccountBudgetProposalResponse{}
	mi := &file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAccountBudgetProposalResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAccountBudgetProposalResult) Reset() {
	*x = MutateAccountBudgetProposalResult{}
	mi := &file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAccountBudgetProposalResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_account_budget_proposal_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDesc = []byte{
	...
	0x41, 0x3a, 0x01, 0x2a, 0x22, 0x3c, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f,
...
var (
	file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDescData = file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_goTypes = []any{
	(*MutateAccountBudgetProposalRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateAccountBudgetProposalRequest
	(*AccountBudgetProposalOperation)(nil),      // 1: google.ads.googleads.v24.services.AccountBudgetProposalOperation
	(*MutateAccountBudgetProposalResponse)(nil), // 2: google.ads.googleads.v24.services.MutateAccountBudgetProposalResponse
	(*MutateAccountBudgetProposalResult)(nil),   // 3: google.ads.googleads.v24.services.MutateAccountBudgetProposalResult
	(*fieldmaskpb.FieldMask)(nil),               // 4: google.protobuf.FieldMask
	(*resources.AccountBudgetProposal)(nil),     // 5: google.ads.googleads.v24.resources.AccountBudgetProposal
}
var file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateAccountBudgetProposalRequest.operation:type_name -> google.ads.googleads.v24.services.AccountBudgetProposalOperation
	4, // 1: google.ads.googleads.v24.services.AccountBudgetProposalOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.AccountBudgetProposalOperation.create:type_name -> google.ads.googleads.v24.resources.AccountBudgetProposal
	3, // 3: google.ads.googleads.v24.services.MutateAccountBudgetProposalResponse.result:type_name -> google.ads.googleads.v24.services.MutateAccountBudgetProposalResult
	0, // 4: google.ads.googleads.v24.services.AccountBudgetProposalService.MutateAccountBudgetProposal:input_type -> google.ads.googleads.v24.services.MutateAccountBudgetProposalRequest
	2, // 5: google.ads.googleads.v24.services.AccountBudgetProposalService.MutateAccountBudgetProposal:output_type -> google.ads.googleads.v24.services.MutateAccountBudgetProposalResponse
...
func init() { file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_init() }
func file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_init() {
	if File_google_ads_googleads_v24_services_account_budget_proposal_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_account_budget_proposal_service_proto = out.File
	file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_account_budget_proposal_service_proto_depIdxs = nil
}
...
func (c *accountBudgetProposalServiceClient) MutateAccountBudgetProposal(ctx context.Context, in *MutateAccountBudgetProposalRequest, opts ...grpc.CallOption) (*MutateAccountBudgetProposalResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AccountBudgetProposalService/MutateAccountBudgetProposal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AccountBudgetProposalService_MutateAccountBudgetProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AccountBudgetProposalService/MutateAccountBudgetProposal",
	}
...
var _AccountBudgetProposalService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/account_budget_proposal_service.proto",
}
