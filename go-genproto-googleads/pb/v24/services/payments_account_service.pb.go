...
func (x *ListPaymentsAccountsRequest) Reset() {
	*x = ListPaymentsAccountsRequest{}
	mi := &file_google_ads_googleads_v24_services_payments_account_service_proto_msgTypes[0]
...
func (*ListPaymentsAccountsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_payments_account_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ListPaymentsAccountsResponse) Reset() {
	*x = ListPaymentsAccountsResponse{}
	mi := &file_google_ads_googleads_v24_services_payments_account_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListPaymentsAccountsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_payments_account_service_proto_rawDescGZIP(), []int{1}
}
...
var File_google_ads_googleads_v24_services_payments_account_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_payments_account_service_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1b, 0x50,
...
var (
	file_google_ads_googleads_v24_services_payments_account_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_payments_account_service_proto_rawDescData = file_google_ads_googleads_v24_services_payments_account_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_payments_account_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_payments_account_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_payments_account_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_payments_account_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_payments_account_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_payments_account_service_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_google_ads_googleads_v24_services_payments_account_service_proto_goTypes = []any{
	(*ListPaymentsAccountsRequest)(nil),  // 0: google.ads.googleads.v24.services.ListPaymentsAccountsRequest
	(*ListPaymentsAccountsResponse)(nil), // 1: google.ads.googleads.v24.services.ListPaymentsAccountsResponse
	(*resources.PaymentsAccount)(nil),    // 2: google.ads.googleads.v24.resources.PaymentsAccount
}
var file_google_ads_googleads_v24_services_payments_account_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v24.services.ListPaymentsAccountsResponse.payments_accounts:type_name -> google.ads.googleads.v24.resources.PaymentsAccount
	0, // 1: google.ads.googleads.v24.services.PaymentsAccountService.ListPaymentsAccounts:input_type -> google.ads.googleads.v24.services.ListPaymentsAccountsRequest
	1, // 2: google.ads.googleads.v24.services.PaymentsAccountService.ListPaymentsAccounts:output_type -> google.ads.googleads.v24.services.ListPaymentsAccountsResponse
...
func init() { file_google_ads_googleads_v24_services_payments_account_service_proto_init() }
func file_google_ads_googleads_v24_services_payments_account_service_proto_init() {
	if File_google_ads_googleads_v24_services_payments_account_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_payments_account_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_payments_account_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_payments_account_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_payments_account_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_payments_account_service_proto = out.File
	file_google_ads_googleads_v24_services_payments_account_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_payments_account_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_payments_account_service_proto_depIdxs = nil
}
...
func (c *paymentsAccountServiceClient) ListPaymentsAccounts(ctx context.Context, in *ListPaymentsAccountsRequest, opts ...grpc.CallOption) (*ListPaymentsAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.PaymentsAccountService/ListPaymentsAccounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PaymentsAccountService_ListPaymentsAccounts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.PaymentsAccountService/ListPaymentsAccounts",
	}
...
var _PaymentsAccountService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/payments_account_service.proto",
}
