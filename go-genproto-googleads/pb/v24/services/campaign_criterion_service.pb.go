...
func (x *MutateCampaignCriteriaRequest) Reset() {
	*x = MutateCampaignCriteriaRequest{}
	mi := &file_google_ads_googleads_v24_services_campaign_criterion_service_proto_msgTypes[0]
...
func (*MutateCampaignCriteriaRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignCriterionOperation) Reset() {
	*x = CampaignCriterionOperation{}
	mi := &file_google_ads_googleads_v24_services_campaign_criterion_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CampaignCriterionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignCriteriaResponse) Reset() {
	*x = MutateCampaignCriteriaResponse{}
	mi := &file_google_ads_googleads_v24_services_campaign_criterion_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignCriteriaResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignCriterionResult) Reset() {
	*x = MutateCampaignCriterionResult{}
	mi := &file_google_ads_googleads_v24_services_campaign_criterion_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignCriterionResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_campaign_criterion_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDesc = []byte{
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1d,
	0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x43, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x6f,
...
var (
	file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDescData = file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_campaign_criterion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_campaign_criterion_service_proto_goTypes = []any{
	(*MutateCampaignCriteriaRequest)(nil),                  // 0: google.ads.googleads.v24.services.MutateCampaignCriteriaRequest
	(*CampaignCriterionOperation)(nil),                     // 1: google.ads.googleads.v24.services.CampaignCriterionOperation
	(*MutateCampaignCriteriaResponse)(nil),                 // 2: google.ads.googleads.v24.services.MutateCampaignCriteriaResponse
	(*MutateCampaignCriterionResult)(nil),                  // 3: google.ads.googleads.v24.services.MutateCampaignCriterionResult
	...
	(*resources.CampaignCriterion)(nil),                    // 6: google.ads.googleads.v24.resources.CampaignCriterion
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_campaign_criterion_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCampaignCriteriaRequest.operations:type_name -> google.ads.googleads.v24.services.CampaignCriterionOperation
	4, // 1: google.ads.googleads.v24.services.MutateCampaignCriteriaRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.CampaignCriterionOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.CampaignCriterionOperation.create:type_name -> google.ads.googleads.v24.resources.CampaignCriterion
	6, // 4: google.ads.googleads.v24.services.CampaignCriterionOperation.update:type_name -> google.ads.googleads.v24.resources.CampaignCriterion
	7, // 5: google.ads.googleads.v24.services.MutateCampaignCriteriaResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateCampaignCriteriaResponse.results:type_name -> google.ads.googleads.v24.services.MutateCampaignCriterionResult
	6, // 7: google.ads.googleads.v24.services.MutateCampaignCriterionResult.campaign_criterion:type_name -> google.ads.googleads.v24.resources.CampaignCriterion
	0, // 8: google.ads.googleads.v24.services.CampaignCriterionService.MutateCampaignCriteria:input_type -> google.ads.googleads.v24.services.MutateCampaignCriteriaRequest
	2, // 9: google.ads.googleads.v24.services.CampaignCriterionService.MutateCampaignCriteria:output_type -> google.ads.googleads.v24.services.MutateCampaignCriteriaResponse
...
func init() { file_google_ads_googleads_v24_services_campaign_criterion_service_proto_init() }
func file_google_ads_googleads_v24_services_campaign_criterion_service_proto_init() {
	if File_google_ads_googleads_v24_services_campaign_criterion_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_campaign_criterion_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_campaign_criterion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_campaign_criterion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_campaign_criterion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_campaign_criterion_service_proto = out.File
	file_google_ads_googleads_v24_services_campaign_criterion_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_campaign_criterion_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_campaign_criterion_service_proto_depIdxs = nil
}
...
func (c *campaignCriterionServiceClient) MutateCampaignCriteria(ctx context.Context, in *MutateCampaignCriteriaRequest, opts ...grpc.CallOption) (*MutateCampaignCriteriaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CampaignCriterionService/MutateCampaignCriteria", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignCriterionService_MutateCampaignCriteria_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CampaignCriterionService/MutateCampaignCriteria",
	}
...
var _CampaignCriterionService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/campaign_criterion_service.proto",
}
