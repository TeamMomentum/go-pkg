...
type StartIdentityVerificationRequest struct {
	...
	// verification.
	VerificationProgram enums.IdentityVerificationProgramEnum_IdentityVerificationProgram `protobuf:"varint,2,opt,name=verification_program,json=verificationProgram,proto3,enum=google.ads.googleads.v24.enums.IdentityVerificationProgramEnum_IdentityVerificationProgram" json:"verification_program,omitempty"`
}

func (x *StartIdentityVerificationRequest) Reset() {
	*x = StartIdentityVerificationRequest{}
	mi := &file_google_ads_googleads_v24_services_identity_verification_service_proto_msgTypes[0]
...
func (*StartIdentityVerificationRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *GetIdentityVerificationRequest) Reset() {
	*x = GetIdentityVerificationRequest{}
	mi := &file_google_ads_googleads_v24_services_identity_verification_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetIdentityVerificationRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetIdentityVerificationResponse) Reset() {
	*x = GetIdentityVerificationResponse{}
	mi := &file_google_ads_googleads_v24_services_identity_verification_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetIdentityVerificationResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescGZIP(), []int{2}
}
...
type IdentityVerification struct {
	...
	VerificationProgram enums.IdentityVerificationProgramEnum_IdentityVerificationProgram `protobuf:"varint,1,opt,name=verification_program,json=verificationProgram,proto3,enum=google.ads.googleads.v24.enums.IdentityVerificationProgramEnum_IdentityVerificationProgram" json:"verification_program,omitempty"`
...
func (x *IdentityVerification) Reset() {
	*x = IdentityVerification{}
	mi := &file_google_ads_googleads_v24_services_identity_verification_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IdentityVerification) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescGZIP(), []int{3}
}
...
type IdentityVerificationProgress struct {
	...
	ProgramStatus enums.IdentityVerificationProgramStatusEnum_IdentityVerificationProgramStatus `protobuf:"varint,1,opt,name=program_status,json=programStatus,proto3,enum=google.ads.googleads.v24.enums.IdentityVerificationProgramStatusEnum_IdentityVerificationProgramStatus" json:"program_status,omitempty"`
...
func (x *IdentityVerificationProgress) Reset() {
	*x = IdentityVerificationProgress{}
	mi := &file_google_ads_googleads_v24_services_identity_verification_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IdentityVerificationProgress) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *IdentityVerificationRequirement) Reset() {
	*x = IdentityVerificationRequirement{}
	mi := &file_google_ads_googleads_v24_services_identity_verification_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*IdentityVerificationRequirement) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescGZIP(), []int{5}
}
...
var File_google_ads_googleads_v24_services_identity_verification_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDesc = []byte{
	...
	0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x42, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x69, 0x64, 0x65, 0x6e, 0x74,
	...
	0x65, 0x61, 0x64, 0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x69,
	...
	0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69,
	...
	0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e,
	0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x49, 0x64, 0x65,
	...
	0x02, 0x3d, 0x3a, 0x01, 0x2a, 0x22, 0x38, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74,
	...
	0x69, 0x64, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x38, 0x12, 0x36, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63,
...
var (
	file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescData = file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_identity_verification_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_google_ads_googleads_v24_services_identity_verification_service_proto_goTypes = []any{
	(*StartIdentityVerificationRequest)(nil),                                           // 0: google.ads.googleads.v24.services.StartIdentityVerificationRequest
	(*GetIdentityVerificationRequest)(nil),                                             // 1: google.ads.googleads.v24.services.GetIdentityVerificationRequest
	(*GetIdentityVerificationResponse)(nil),                                            // 2: google.ads.googleads.v24.services.GetIdentityVerificationResponse
	(*IdentityVerification)(nil),                                                       // 3: google.ads.googleads.v24.services.IdentityVerification
	(*IdentityVerificationProgress)(nil),                                               // 4: google.ads.googleads.v24.services.IdentityVerificationProgress
	(*IdentityVerificationRequirement)(nil),                                            // 5: google.ads.googleads.v24.services.IdentityVerificationRequirement
	(enums.IdentityVerificationProgramEnum_IdentityVerificationProgram)(0),             // 6: google.ads.googleads.v24.enums.IdentityVerificationProgramEnum.IdentityVerificationProgram
	(enums.IdentityVerificationProgramStatusEnum_IdentityVerificationProgramStatus)(0), // 7: google.ads.googleads.v24.enums.IdentityVerificationProgramStatusEnum.IdentityVerificationProgramStatus
	(*emptypb.Empty)(nil),                                                              // 8: google.protobuf.Empty
}
var file_google_ads_googleads_v24_services_identity_verification_service_proto_depIdxs = []int32{
	6, // 0: google.ads.googleads.v24.services.StartIdentityVerificationRequest.verification_program:type_name -> google.ads.googleads.v24.enums.IdentityVerificationProgramEnum.IdentityVerificationProgram
	3, // 1: google.ads.googleads.v24.services.GetIdentityVerificationResponse.identity_verification:type_name -> google.ads.googleads.v24.services.IdentityVerification
	6, // 2: google.ads.googleads.v24.services.IdentityVerification.verification_program:type_name -> google.ads.googleads.v24.enums.IdentityVerificationProgramEnum.IdentityVerificationProgram
	5, // 3: google.ads.googleads.v24.services.IdentityVerification.identity_verification_requirement:type_name -> google.ads.googleads.v24.services.IdentityVerificationRequirement
	4, // 4: google.ads.googleads.v24.services.IdentityVerification.verification_progress:type_name -> google.ads.googleads.v24.services.IdentityVerificationProgress
	7, // 5: google.ads.googleads.v24.services.IdentityVerificationProgress.program_status:type_name -> google.ads.googleads.v24.enums.IdentityVerificationProgramStatusEnum.IdentityVerificationProgramStatus
	0, // 6: google.ads.googleads.v24.services.IdentityVerificationService.StartIdentityVerification:input_type -> google.ads.googleads.v24.services.StartIdentityVerificationRequest
	1, // 7: google.ads.googleads.v24.services.IdentityVerificationService.GetIdentityVerification:input_type -> google.ads.googleads.v24.services.GetIdentityVerificationRequest
	8, // 8: google.ads.googleads.v24.services.IdentityVerificationService.StartIdentityVerification:output_type -> google.protobuf.Empty
	2, // 9: google.ads.googleads.v24.services.IdentityVerificationService.GetIdentityVerification:output_type -> google.ads.googleads.v24.services.GetIdentityVerificationResponse
...
func init() { file_google_ads_googleads_v24_services_identity_verification_service_proto_init() }
func file_google_ads_googleads_v24_services_identity_verification_service_proto_init() {
	if File_google_ads_googleads_v24_services_identity_verification_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_identity_verification_service_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_identity_verification_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_identity_verification_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_identity_verification_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_identity_verification_service_proto = out.File
	file_google_ads_googleads_v24_services_identity_verification_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_identity_verification_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_identity_verification_service_proto_depIdxs = nil
}
...
func (c *identityVerificationServiceClient) StartIdentityVerification(ctx context.Context, in *StartIdentityVerificationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.IdentityVerificationService/StartIdentityVerification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityVerificationServiceClient) GetIdentityVerification(ctx context.Context, in *GetIdentityVerificationRequest, opts ...grpc.CallOption) (*GetIdentityVerificationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.IdentityVerificationService/GetIdentityVerification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedIdentityVerificationServiceServer can be embedded to have forward compatible implementations.
...
func RegisterIdentityVerificationServiceServer(s *grpc.Server, srv IdentityVerificationServiceServer) {
	s.RegisterService(&_IdentityVerificationService_serviceDesc, srv)
}
...
func _IdentityVerificationService_StartIdentityVerification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.IdentityVerificationService/StartIdentityVerification",
	}
...
func _IdentityVerificationService_GetIdentityVerification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.IdentityVerificationService/GetIdentityVerification",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _IdentityVerificationService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/identity_verification_service.proto",
}
