...
func (x *MutateCustomerManagerLinkRequest) Reset() {
	*x = MutateCustomerManagerLinkRequest{}
	mi := &file_google_ads_googleads_v24_services_customer_manager_link_service_proto_msgTypes[0]
...
func (*MutateCustomerManagerLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *MoveManagerLinkRequest) Reset() {
	*x = MoveManagerLinkRequest{}
	mi := &file_google_ads_googleads_v24_services_customer_manager_link_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MoveManagerLinkRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *CustomerManagerLinkOperation) Reset() {
	*x = CustomerManagerLinkOperation{}
	mi := &file_google_ads_googleads_v24_services_customer_manager_link_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerManagerLinkOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerManagerLinkResponse) Reset() {
	*x = MutateCustomerManagerLinkResponse{}
	mi := &file_google_ads_googleads_v24_services_customer_manager_link_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerManagerLinkResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *MoveManagerLinkResponse) Reset() {
	*x = MoveManagerLinkResponse{}
	mi := &file_google_ads_googleads_v24_services_customer_manager_link_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MoveManagerLinkResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *MutateCustomerManagerLinkResult) Reset() {
	*x = MutateCustomerManagerLinkResult{}
	mi := &file_google_ads_googleads_v24_services_customer_manager_link_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerManagerLinkResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescGZIP(), []int{5}
}
...
var File_google_ads_googleads_v24_services_customer_manager_link_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDesc = []byte{
	...
	0xe4, 0x93, 0x02, 0x3f, 0x3a, 0x01, 0x2a, 0x22, 0x3a, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75,
	...
	0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x4d, 0x6f, 0x76, 0x65,
...
var (
	file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescData = file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_customer_manager_link_service_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_google_ads_googleads_v24_services_customer_manager_link_service_proto_goTypes = []any{
	(*MutateCustomerManagerLinkRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateCustomerManagerLinkRequest
	(*MoveManagerLinkRequest)(nil),            // 1: google.ads.googleads.v24.services.MoveManagerLinkRequest
	(*CustomerManagerLinkOperation)(nil),      // 2: google.ads.googleads.v24.services.CustomerManagerLinkOperation
	(*MutateCustomerManagerLinkResponse)(nil), // 3: google.ads.googleads.v24.services.MutateCustomerManagerLinkResponse
	(*MoveManagerLinkResponse)(nil),           // 4: google.ads.googleads.v24.services.MoveManagerLinkResponse
	(*MutateCustomerManagerLinkResult)(nil),   // 5: google.ads.googleads.v24.services.MutateCustomerManagerLinkResult
	(*fieldmaskpb.FieldMask)(nil),             // 6: google.protobuf.FieldMask
	(*resources.CustomerManagerLink)(nil),     // 7: google.ads.googleads.v24.resources.CustomerManagerLink
}
var file_google_ads_googleads_v24_services_customer_manager_link_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v24.services.MutateCustomerManagerLinkRequest.operations:type_name -> google.ads.googleads.v24.services.CustomerManagerLinkOperation
	6, // 1: google.ads.googleads.v24.services.CustomerManagerLinkOperation.update_mask:type_name -> google.protobuf.FieldMask
	7, // 2: google.ads.googleads.v24.services.CustomerManagerLinkOperation.update:type_name -> google.ads.googleads.v24.resources.CustomerManagerLink
	5, // 3: google.ads.googleads.v24.services.MutateCustomerManagerLinkResponse.results:type_name -> google.ads.googleads.v24.services.MutateCustomerManagerLinkResult
	0, // 4: google.ads.googleads.v24.services.CustomerManagerLinkService.MutateCustomerManagerLink:input_type -> google.ads.googleads.v24.services.MutateCustomerManagerLinkRequest
	1, // 5: google.ads.googleads.v24.services.CustomerManagerLinkService.MoveManagerLink:input_type -> google.ads.googleads.v24.services.MoveManagerLinkRequest
	3, // 6: google.ads.googleads.v24.services.CustomerManagerLinkService.MutateCustomerManagerLink:output_type -> google.ads.googleads.v24.services.MutateCustomerManagerLinkResponse
	4, // 7: google.ads.googleads.v24.services.CustomerManagerLinkService.MoveManagerLink:output_type -> google.ads.googleads.v24.services.MoveManagerLinkResponse
...
func init() { file_google_ads_googleads_v24_services_customer_manager_link_service_proto_init() }
func file_google_ads_googleads_v24_services_customer_manager_link_service_proto_init() {
	if File_google_ads_googleads_v24_services_customer_manager_link_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_customer_manager_link_service_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_customer_manager_link_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_customer_manager_link_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_customer_manager_link_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_customer_manager_link_service_proto = out.File
	file_google_ads_googleads_v24_services_customer_manager_link_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_customer_manager_link_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_customer_manager_link_service_proto_depIdxs = nil
}
...
func (c *customerManagerLinkServiceClient) MutateCustomerManagerLink(ctx context.Context, in *MutateCustomerManagerLinkRequest, opts ...grpc.CallOption) (*MutateCustomerManagerLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomerManagerLinkService/MutateCustomerManagerLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *customerManagerLinkServiceClient) MoveManagerLink(ctx context.Context, in *MoveManagerLinkRequest, opts ...grpc.CallOption) (*MoveManagerLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomerManagerLinkService/MoveManagerLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerManagerLinkService_MutateCustomerManagerLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomerManagerLinkService/MutateCustomerManagerLink",
	}
...
func _CustomerManagerLinkService_MoveManagerLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomerManagerLinkService/MoveManagerLink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _CustomerManagerLinkService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/customer_manager_link_service.proto",
}
