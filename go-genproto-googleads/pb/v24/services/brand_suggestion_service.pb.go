...
func (x *SuggestBrandsRequest) Reset() {
	*x = SuggestBrandsRequest{}
	mi := &file_google_ads_googleads_v24_services_brand_suggestion_service_proto_msgTypes[0]
...
func (*SuggestBrandsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SuggestBrandsResponse) Reset() {
	*x = SuggestBrandsResponse{}
	mi := &file_google_ads_googleads_v24_services_brand_suggestion_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SuggestBrandsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDescGZIP(), []int{1}
}
...
type BrandSuggestion struct {
	...
	State enums.BrandStateEnum_BrandState `protobuf:"varint,4,opt,name=state,proto3,enum=google.ads.googleads.v24.enums.BrandStateEnum_BrandState" json:"state,omitempty"`
}

func (x *BrandSuggestion) Reset() {
	*x = BrandSuggestion{}
	mi := &file_google_ads_googleads_v24_services_brand_suggestion_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BrandSuggestion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v24_services_brand_suggestion_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x42, 0x72, 0x61, 0x6e,
	...
	0x01, 0x2a, 0x22, 0x2c, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65,
...
var (
	file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDescData = file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_brand_suggestion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v24_services_brand_suggestion_service_proto_goTypes = []any{
	(*SuggestBrandsRequest)(nil),         // 0: google.ads.googleads.v24.services.SuggestBrandsRequest
	(*SuggestBrandsResponse)(nil),        // 1: google.ads.googleads.v24.services.SuggestBrandsResponse
	(*BrandSuggestion)(nil),              // 2: google.ads.googleads.v24.services.BrandSuggestion
	(enums.BrandStateEnum_BrandState)(0), // 3: google.ads.googleads.v24.enums.BrandStateEnum.BrandState
}
var file_google_ads_googleads_v24_services_brand_suggestion_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v24.services.SuggestBrandsResponse.brands:type_name -> google.ads.googleads.v24.services.BrandSuggestion
	3, // 1: google.ads.googleads.v24.services.BrandSuggestion.state:type_name -> google.ads.googleads.v24.enums.BrandStateEnum.BrandState
	0, // 2: google.ads.googleads.v24.services.BrandSuggestionService.SuggestBrands:input_type -> google.ads.googleads.v24.services.SuggestBrandsRequest
	1, // 3: google.ads.googleads.v24.services.BrandSuggestionService.SuggestBrands:output_type -> google.ads.googleads.v24.services.SuggestBrandsResponse
...
func init() { file_google_ads_googleads_v24_services_brand_suggestion_service_proto_init() }
func file_google_ads_googleads_v24_services_brand_suggestion_service_proto_init() {
	if File_google_ads_googleads_v24_services_brand_suggestion_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_brand_suggestion_service_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_brand_suggestion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_brand_suggestion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_brand_suggestion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_brand_suggestion_service_proto = out.File
	file_google_ads_googleads_v24_services_brand_suggestion_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_brand_suggestion_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_brand_suggestion_service_proto_depIdxs = nil
}
...
func (c *brandSuggestionServiceClient) SuggestBrands(ctx context.Context, in *SuggestBrandsRequest, opts ...grpc.CallOption) (*SuggestBrandsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.BrandSuggestionService/SuggestBrands", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBrandSuggestionServiceServer can be embedded to have forward compatible implementations.
...
func RegisterBrandSuggestionServiceServer(s *grpc.Server, srv BrandSuggestionServiceServer) {
	s.RegisterService(&_BrandSuggestionService_serviceDesc, srv)
}
...
func _BrandSuggestionService_SuggestBrands_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.BrandSuggestionService/SuggestBrands",
	}
...
var _BrandSuggestionService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/brand_suggestion_service.proto",
}
