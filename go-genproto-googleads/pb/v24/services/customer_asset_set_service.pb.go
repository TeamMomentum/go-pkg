...
func (x *MutateCustomerAssetSetsRequest) Reset() {
	*x = MutateCustomerAssetSetsRequest{}
	mi := &file_google_ads_googleads_v24_services_customer_asset_set_service_proto_msgTypes[0]
...
func (*MutateCustomerAssetSetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerAssetSetOperation) Reset() {
	*x = CustomerAssetSetOperation{}
	mi := &file_google_ads_googleads_v24_services_customer_asset_set_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerAssetSetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerAssetSetsResponse) Reset() {
	*x = MutateCustomerAssetSetsResponse{}
	mi := &file_google_ads_googleads_v24_services_customer_asset_set_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerAssetSetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerAssetSetResult) Reset() {
	*x = MutateCustomerAssetSetResult{}
	mi := &file_google_ads_googleads_v24_services_customer_asset_set_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerAssetSetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_customer_asset_set_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDesc = []byte{
	...
	0x22, 0x37, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
...
var (
	file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDescData = file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_customer_asset_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_customer_asset_set_service_proto_goTypes = []any{
	(*MutateCustomerAssetSetsRequest)(nil),                 // 0: google.ads.googleads.v24.services.MutateCustomerAssetSetsRequest
	(*CustomerAssetSetOperation)(nil),                      // 1: google.ads.googleads.v24.services.CustomerAssetSetOperation
	(*MutateCustomerAssetSetsResponse)(nil),                // 2: google.ads.googleads.v24.services.MutateCustomerAssetSetsResponse
	(*MutateCustomerAssetSetResult)(nil),                   // 3: google.ads.googleads.v24.services.MutateCustomerAssetSetResult
	...
	(*resources.CustomerAssetSet)(nil),                     // 5: google.ads.googleads.v24.resources.CustomerAssetSet
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_customer_asset_set_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCustomerAssetSetsRequest.operations:type_name -> google.ads.googleads.v24.services.CustomerAssetSetOperation
	4, // 1: google.ads.googleads.v24.services.MutateCustomerAssetSetsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.CustomerAssetSetOperation.create:type_name -> google.ads.googleads.v24.resources.CustomerAssetSet
	3, // 3: google.ads.googleads.v24.services.MutateCustomerAssetSetsResponse.results:type_name -> google.ads.googleads.v24.services.MutateCustomerAssetSetResult
	6, // 4: google.ads.googleads.v24.services.MutateCustomerAssetSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	5, // 5: google.ads.googleads.v24.services.MutateCustomerAssetSetResult.customer_asset_set:type_name -> google.ads.googleads.v24.resources.CustomerAssetSet
	0, // 6: google.ads.googleads.v24.services.CustomerAssetSetService.MutateCustomerAssetSets:input_type -> google.ads.googleads.v24.services.MutateCustomerAssetSetsRequest
	2, // 7: google.ads.googleads.v24.services.CustomerAssetSetService.MutateCustomerAssetSets:output_type -> google.ads.googleads.v24.services.MutateCustomerAssetSetsResponse
...
func init() { file_google_ads_googleads_v24_services_customer_asset_set_service_proto_init() }
func file_google_ads_googleads_v24_services_customer_asset_set_service_proto_init() {
	if File_google_ads_googleads_v24_services_customer_asset_set_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_customer_asset_set_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_customer_asset_set_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_customer_asset_set_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_customer_asset_set_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_customer_asset_set_service_proto = out.File
	file_google_ads_googleads_v24_services_customer_asset_set_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_customer_asset_set_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_customer_asset_set_service_proto_depIdxs = nil
}
...
func (c *customerAssetSetServiceClient) MutateCustomerAssetSets(ctx context.Context, in *MutateCustomerAssetSetsRequest, opts ...grpc.CallOption) (*MutateCustomerAssetSetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomerAssetSetService/MutateCustomerAssetSets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCustomerAssetSetServiceServer can be embedded to have forward compatible implementations.
...
func (*UnimplementedCustomerAssetSetServiceServer) MutateCustomerAssetSets(context.Context, *MutateCustomerAssetSetsRequest) (*MutateCustomerAssetSetsResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method MutateCustomerAssetSets not implemented")
}

func RegisterCustomerAssetSetServiceServer(s *grpc.Server, srv CustomerAssetSetServiceServer) {
	s.RegisterService(&_CustomerAssetSetService_serviceDesc, srv)
}
...
func _CustomerAssetSetService_MutateCustomerAssetSets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomerAssetSetService/MutateCustomerAssetSets",
	}
...
var _CustomerAssetSetService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/customer_asset_set_service.proto",
}
