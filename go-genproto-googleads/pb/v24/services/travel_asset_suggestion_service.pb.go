...
func (x *SuggestTravelAssetsRequest) Reset() {
	*x = SuggestTravelAssetsRequest{}
	mi := &file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_msgTypes[0]
...
func (*SuggestTravelAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SuggestTravelAssetsResponse) Reset() {
	*x = SuggestTravelAssetsResponse{}
	mi := &file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SuggestTravelAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescGZIP(), []int{1}
}
...
type HotelAssetSuggestion struct {
	...
	// Call to action type.
	CallToAction enums.CallToActionTypeEnum_CallToActionType `protobuf:"varint,4,opt,name=call_to_action,json=callToAction,proto3,enum=google.ads.googleads.v24.enums.CallToActionTypeEnum_CallToActionType" json:"call_to_action,omitempty"`
	...
	Status enums.HotelAssetSuggestionStatusEnum_HotelAssetSuggestionStatus `protobuf:"varint,7,opt,name=status,proto3,enum=google.ads.googleads.v24.enums.HotelAssetSuggestionStatusEnum_HotelAssetSuggestionStatus" json:"status,omitempty"`
}

func (x *HotelAssetSuggestion) Reset() {
	*x = HotelAssetSuggestion{}
	mi := &file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HotelAssetSuggestion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *HotelTextAsset) Reset() {
	*x = HotelTextAsset{}
	mi := &file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HotelTextAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescGZIP(), []int{3}
}
...
func (x *HotelImageAsset) Reset() {
	*x = HotelImageAsset{}
	mi := &file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HotelImageAsset) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescGZIP(), []int{4}
}
...
var File_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x35, 0x67, 0x6f,
	...
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x68, 0x6f,
	...
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x48,
...
var (
	file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescData = file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_goTypes = []any{
	(*SuggestTravelAssetsRequest)(nil),                                   // 0: google.ads.googleads.v24.services.SuggestTravelAssetsRequest
	(*SuggestTravelAssetsResponse)(nil),                                  // 1: google.ads.googleads.v24.services.SuggestTravelAssetsResponse
	(*HotelAssetSuggestion)(nil),                                         // 2: google.ads.googleads.v24.services.HotelAssetSuggestion
	(*HotelTextAsset)(nil),                                               // 3: google.ads.googleads.v24.services.HotelTextAsset
	(*HotelImageAsset)(nil),                                              // 4: google.ads.googleads.v24.services.HotelImageAsset
	(enums.CallToActionTypeEnum_CallToActionType)(0),                     // 5: google.ads.googleads.v24.enums.CallToActionTypeEnum.CallToActionType
	(enums.HotelAssetSuggestionStatusEnum_HotelAssetSuggestionStatus)(0), // 6: google.ads.googleads.v24.enums.HotelAssetSuggestionStatusEnum.HotelAssetSuggestionStatus
	(enums.AssetFieldTypeEnum_AssetFieldType)(0),                         // 7: google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType
}
var file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v24.services.SuggestTravelAssetsResponse.hotel_asset_suggestions:type_name -> google.ads.googleads.v24.services.HotelAssetSuggestion
	5, // 1: google.ads.googleads.v24.services.HotelAssetSuggestion.call_to_action:type_name -> google.ads.googleads.v24.enums.CallToActionTypeEnum.CallToActionType
	3, // 2: google.ads.googleads.v24.services.HotelAssetSuggestion.text_assets:type_name -> google.ads.googleads.v24.services.HotelTextAsset
	4, // 3: google.ads.googleads.v24.services.HotelAssetSuggestion.image_assets:type_name -> google.ads.googleads.v24.services.HotelImageAsset
	6, // 4: google.ads.googleads.v24.services.HotelAssetSuggestion.status:type_name -> google.ads.googleads.v24.enums.HotelAssetSuggestionStatusEnum.HotelAssetSuggestionStatus
	7, // 5: google.ads.googleads.v24.services.HotelTextAsset.asset_field_type:type_name -> google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType
	7, // 6: google.ads.googleads.v24.services.HotelImageAsset.asset_field_type:type_name -> google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType
	0, // 7: google.ads.googleads.v24.services.TravelAssetSuggestionService.SuggestTravelAssets:input_type -> google.ads.googleads.v24.services.SuggestTravelAssetsRequest
	1, // 8: google.ads.googleads.v24.services.TravelAssetSuggestionService.SuggestTravelAssets:output_type -> google.ads.googleads.v24.services.SuggestTravelAssetsResponse
...
func init() { file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_init() }
func file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_init() {
	if File_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto = out.File
	file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_travel_asset_suggestion_service_proto_depIdxs = nil
}
...
func (c *travelAssetSuggestionServiceClient) SuggestTravelAssets(ctx context.Context, in *SuggestTravelAssetsRequest, opts ...grpc.CallOption) (*SuggestTravelAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.TravelAssetSuggestionService/SuggestTravelAssets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TravelAssetSuggestionService_SuggestTravelAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.TravelAssetSuggestionService/SuggestTravelAssets",
	}
...
var _TravelAssetSuggestionService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/travel_asset_suggestion_service.proto",
}
