...
func (x *MutateCustomerAssetsRequest) Reset() {
	*x = MutateCustomerAssetsRequest{}
	mi := &file_google_ads_googleads_v24_services_customer_asset_service_proto_msgTypes[0]
...
func (*MutateCustomerAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerAssetOperation) Reset() {
	*x = CustomerAssetOperation{}
	mi := &file_google_ads_googleads_v24_services_customer_asset_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerAssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerAssetsResponse) Reset() {
	*x = MutateCustomerAssetsResponse{}
	mi := &file_google_ads_googleads_v24_services_customer_asset_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerAssetResult) Reset() {
	*x = MutateCustomerAssetResult{}
	mi := &file_google_ads_googleads_v24_services_customer_asset_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_customer_asset_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDescData = file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_customer_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_customer_asset_service_proto_goTypes = []any{
	(*MutateCustomerAssetsRequest)(nil),                    // 0: google.ads.googleads.v24.services.MutateCustomerAssetsRequest
	(*CustomerAssetOperation)(nil),                         // 1: google.ads.googleads.v24.services.CustomerAssetOperation
	(*MutateCustomerAssetsResponse)(nil),                   // 2: google.ads.googleads.v24.services.MutateCustomerAssetsResponse
	(*MutateCustomerAssetResult)(nil),                      // 3: google.ads.googleads.v24.services.MutateCustomerAssetResult
	...
	(*resources.CustomerAsset)(nil),                        // 6: google.ads.googleads.v24.resources.CustomerAsset
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_customer_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCustomerAssetsRequest.operations:type_name -> google.ads.googleads.v24.services.CustomerAssetOperation
	4, // 1: google.ads.googleads.v24.services.MutateCustomerAssetsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.CustomerAssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.CustomerAssetOperation.create:type_name -> google.ads.googleads.v24.resources.CustomerAsset
	6, // 4: google.ads.googleads.v24.services.CustomerAssetOperation.update:type_name -> google.ads.googleads.v24.resources.CustomerAsset
	7, // 5: google.ads.googleads.v24.services.MutateCustomerAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateCustomerAssetsResponse.results:type_name -> google.ads.googleads.v24.services.MutateCustomerAssetResult
	6, // 7: google.ads.googleads.v24.services.MutateCustomerAssetResult.customer_asset:type_name -> google.ads.googleads.v24.resources.CustomerAsset
	0, // 8: google.ads.googleads.v24.services.CustomerAssetService.MutateCustomerAssets:input_type -> google.ads.googleads.v24.services.MutateCustomerAssetsRequest
	2, // 9: google.ads.googleads.v24.services.CustomerAssetService.MutateCustomerAssets:output_type -> google.ads.googleads.v24.services.MutateCustomerAssetsResponse
...
func init() { file_google_ads_googleads_v24_services_customer_asset_service_proto_init() }
func file_google_ads_googleads_v24_services_customer_asset_service_proto_init() {
	if File_google_ads_googleads_v24_services_customer_asset_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_customer_asset_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_customer_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_customer_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_customer_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_customer_asset_service_proto = out.File
	file_google_ads_googleads_v24_services_customer_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_customer_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_customer_asset_service_proto_depIdxs = nil
}
...
func (c *customerAssetServiceClient) MutateCustomerAssets(ctx context.Context, in *MutateCustomerAssetsRequest, opts ...grpc.CallOption) (*MutateCustomerAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomerAssetService/MutateCustomerAssets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerAssetService_MutateCustomerAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomerAssetService/MutateCustomerAssets",
	}
...
var _CustomerAssetService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/customer_asset_service.proto",
}
