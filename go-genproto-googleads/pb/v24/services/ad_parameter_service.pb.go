...
func (x *MutateAdParametersRequest) Reset() {
	*x = MutateAdParametersRequest{}
	mi := &file_google_ads_googleads_v24_services_ad_parameter_service_proto_msgTypes[0]
...
func (*MutateAdParametersRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdParameterOperation) Reset() {
	*x = AdParameterOperation{}
	mi := &file_google_ads_googleads_v24_services_ad_parameter_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdParameterOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdParametersResponse) Reset() {
	*x = MutateAdParametersResponse{}
	mi := &file_google_ads_googleads_v24_services_ad_parameter_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdParametersResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdParameterResult) Reset() {
	*x = MutateAdParameterResult{}
	mi := &file_google_ads_googleads_v24_services_ad_parameter_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdParameterResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_ad_parameter_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDescData = file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_ad_parameter_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_ad_parameter_service_proto_goTypes = []any{
	(*MutateAdParametersRequest)(nil),                      // 0: google.ads.googleads.v24.services.MutateAdParametersRequest
	(*AdParameterOperation)(nil),                           // 1: google.ads.googleads.v24.services.AdParameterOperation
	(*MutateAdParametersResponse)(nil),                     // 2: google.ads.googleads.v24.services.MutateAdParametersResponse
	(*MutateAdParameterResult)(nil),                        // 3: google.ads.googleads.v24.services.MutateAdParameterResult
	...
	(*resources.AdParameter)(nil),                          // 6: google.ads.googleads.v24.resources.AdParameter
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_ad_parameter_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateAdParametersRequest.operations:type_name -> google.ads.googleads.v24.services.AdParameterOperation
	4, // 1: google.ads.googleads.v24.services.MutateAdParametersRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.AdParameterOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.AdParameterOperation.create:type_name -> google.ads.googleads.v24.resources.AdParameter
	6, // 4: google.ads.googleads.v24.services.AdParameterOperation.update:type_name -> google.ads.googleads.v24.resources.AdParameter
	7, // 5: google.ads.googleads.v24.services.MutateAdParametersResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateAdParametersResponse.results:type_name -> google.ads.googleads.v24.services.MutateAdParameterResult
	6, // 7: google.ads.googleads.v24.services.MutateAdParameterResult.ad_parameter:type_name -> google.ads.googleads.v24.resources.AdParameter
	0, // 8: google.ads.googleads.v24.services.AdParameterService.MutateAdParameters:input_type -> google.ads.googleads.v24.services.MutateAdParametersRequest
	2, // 9: google.ads.googleads.v24.services.AdParameterService.MutateAdParameters:output_type -> google.ads.googleads.v24.services.MutateAdParametersResponse
...
func init() { file_google_ads_googleads_v24_services_ad_parameter_service_proto_init() }
func file_google_ads_googleads_v24_services_ad_parameter_service_proto_init() {
	if File_google_ads_googleads_v24_services_ad_parameter_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_ad_parameter_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_ad_parameter_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_ad_parameter_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_ad_parameter_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_ad_parameter_service_proto = out.File
	file_google_ads_googleads_v24_services_ad_parameter_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_ad_parameter_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_ad_parameter_service_proto_depIdxs = nil
}
...
func (c *adParameterServiceClient) MutateAdParameters(ctx context.Context, in *MutateAdParametersRequest, opts ...grpc.CallOption) (*MutateAdParametersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AdParameterService/MutateAdParameters", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdParameterService_MutateAdParameters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AdParameterService/MutateAdParameters",
	}
...
var _AdParameterService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/ad_parameter_service.proto",
}
