...
func (x *SuggestGeoTargetConstantsRequest) Reset() {
	*x = SuggestGeoTargetConstantsRequest{}
	mi := &file_google_ads_googleads_v24_services_geo_target_constant_service_proto_msgTypes[0]
...
func (*SuggestGeoTargetConstantsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SuggestGeoTargetConstantsResponse) Reset() {
	*x = SuggestGeoTargetConstantsResponse{}
	mi := &file_google_ads_googleads_v24_services_geo_target_constant_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SuggestGeoTargetConstantsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *GeoTargetConstantSuggestion) Reset() {
	*x = GeoTargetConstantSuggestion{}
	mi := &file_google_ads_googleads_v24_services_geo_target_constant_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GeoTargetConstantSuggestion) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *SuggestGeoTargetConstantsRequest_LocationNames) Reset() {
	*x = SuggestGeoTargetConstantsRequest_LocationNames{}
	mi := &file_google_ads_googleads_v24_services_geo_target_constant_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SuggestGeoTargetConstantsRequest_LocationNames) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SuggestGeoTargetConstantsRequest_GeoTargets) Reset() {
	*x = SuggestGeoTargetConstantsRequest_GeoTargets{}
	mi := &file_google_ads_googleads_v24_services_geo_target_constant_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SuggestGeoTargetConstantsRequest_GeoTargets) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescGZIP(), []int{0, 1}
}
...
var File_google_ads_googleads_v24_services_geo_target_constant_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x67, 0x65, 0x6f,
	...
	0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x75, 0x67,
	...
	0x2a, 0x22, 0x1f, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x67, 0x65, 0x6f, 0x54, 0x61, 0x72, 0x67, 0x65,
	...
	0x5c, 0x56, 0x32, 0x34, 0x5c, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0xea, 0x02, 0x25,
	0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x32, 0x34, 0x3a, 0x3a, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescData = file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_geo_target_constant_service_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_google_ads_googleads_v24_services_geo_target_constant_service_proto_goTypes = []any{
	(*SuggestGeoTargetConstantsRequest)(nil),               // 0: google.ads.googleads.v24.services.SuggestGeoTargetConstantsRequest
	(*SuggestGeoTargetConstantsResponse)(nil),              // 1: google.ads.googleads.v24.services.SuggestGeoTargetConstantsResponse
	(*GeoTargetConstantSuggestion)(nil),                    // 2: google.ads.googleads.v24.services.GeoTargetConstantSuggestion
	(*SuggestGeoTargetConstantsRequest_LocationNames)(nil), // 3: google.ads.googleads.v24.services.SuggestGeoTargetConstantsRequest.LocationNames
	(*SuggestGeoTargetConstantsRequest_GeoTargets)(nil),    // 4: google.ads.googleads.v24.services.SuggestGeoTargetConstantsRequest.GeoTargets
	(*resources.GeoTargetConstant)(nil),                    // 5: google.ads.googleads.v24.resources.GeoTargetConstant
}
var file_google_ads_googleads_v24_services_geo_target_constant_service_proto_depIdxs = []int32{
	3, // 0: google.ads.googleads.v24.services.SuggestGeoTargetConstantsRequest.location_names:type_name -> google.ads.googleads.v24.services.SuggestGeoTargetConstantsRequest.LocationNames
	4, // 1: google.ads.googleads.v24.services.SuggestGeoTargetConstantsRequest.geo_targets:type_name -> google.ads.googleads.v24.services.SuggestGeoTargetConstantsRequest.GeoTargets
	2, // 2: google.ads.googleads.v24.services.SuggestGeoTargetConstantsResponse.geo_target_constant_suggestions:type_name -> google.ads.googleads.v24.services.GeoTargetConstantSuggestion
	5, // 3: google.ads.googleads.v24.services.GeoTargetConstantSuggestion.geo_target_constant:type_name -> google.ads.googleads.v24.resources.GeoTargetConstant
	5, // 4: google.ads.googleads.v24.services.GeoTargetConstantSuggestion.geo_target_constant_parents:type_name -> google.ads.googleads.v24.resources.GeoTargetConstant
	0, // 5: google.ads.googleads.v24.services.GeoTargetConstantService.SuggestGeoTargetConstants:input_type -> google.ads.googleads.v24.services.SuggestGeoTargetConstantsRequest
	1, // 6: google.ads.googleads.v24.services.GeoTargetConstantService.SuggestGeoTargetConstants:output_type -> google.ads.googleads.v24.services.SuggestGeoTargetConstantsResponse
...
func init() { file_google_ads_googleads_v24_services_geo_target_constant_service_proto_init() }
func file_google_ads_googleads_v24_services_geo_target_constant_service_proto_init() {
	if File_google_ads_googleads_v24_services_geo_target_constant_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_geo_target_constant_service_proto_msgTypes[0].OneofWrappers = []any{
		(*SuggestGeoTargetConstantsRequest_LocationNames_)(nil),
		(*SuggestGeoTargetConstantsRequest_GeoTargets_)(nil),
	}
	file_google_ads_googleads_v24_services_geo_target_constant_service_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_geo_target_constant_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_geo_target_constant_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_geo_target_constant_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_geo_target_constant_service_proto = out.File
	file_google_ads_googleads_v24_services_geo_target_constant_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_geo_target_constant_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_geo_target_constant_service_proto_depIdxs = nil
}
...
func (c *geoTargetConstantServiceClient) SuggestGeoTargetConstants(ctx context.Context, in *SuggestGeoTargetConstantsRequest, opts ...grpc.CallOption) (*SuggestGeoTargetConstantsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.GeoTargetConstantService/SuggestGeoTargetConstants", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GeoTargetConstantService_SuggestGeoTargetConstants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.GeoTargetConstantService/SuggestGeoTargetConstants",
	}
...
var _GeoTargetConstantService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/geo_target_constant_service.proto",
}
