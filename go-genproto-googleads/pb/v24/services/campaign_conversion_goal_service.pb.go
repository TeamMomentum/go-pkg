...
func (x *MutateCampaignConversionGoalsRequest) Reset() {
	*x = MutateCampaignConversionGoalsRequest{}
	mi := &file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_msgTypes[0]
...
func (*MutateCampaignConversionGoalsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignConversionGoalOperation) Reset() {
	*x = CampaignConversionGoalOperation{}
	mi := &file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CampaignConversionGoalOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignConversionGoalsResponse) Reset() {
	*x = MutateCampaignConversionGoalsResponse{}
	mi := &file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignConversionGoalsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignConversionGoalResult) Reset() {
	*x = MutateCampaignConversionGoalResult{}
	mi := &file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignConversionGoalResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x61, 0x6d,
...
var (
	file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDescData = file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_goTypes = []any{
	(*MutateCampaignConversionGoalsRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateCampaignConversionGoalsRequest
	(*CampaignConversionGoalOperation)(nil),       // 1: google.ads.googleads.v24.services.CampaignConversionGoalOperation
	(*MutateCampaignConversionGoalsResponse)(nil), // 2: google.ads.googleads.v24.services.MutateCampaignConversionGoalsResponse
	(*MutateCampaignConversionGoalResult)(nil),    // 3: google.ads.googleads.v24.services.MutateCampaignConversionGoalResult
	(*fieldmaskpb.FieldMask)(nil),                 // 4: google.protobuf.FieldMask
	(*resources.CampaignConversionGoal)(nil),      // 5: google.ads.googleads.v24.resources.CampaignConversionGoal
}
var file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCampaignConversionGoalsRequest.operations:type_name -> google.ads.googleads.v24.services.CampaignConversionGoalOperation
	4, // 1: google.ads.googleads.v24.services.CampaignConversionGoalOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.CampaignConversionGoalOperation.update:type_name -> google.ads.googleads.v24.resources.CampaignConversionGoal
	3, // 3: google.ads.googleads.v24.services.MutateCampaignConversionGoalsResponse.results:type_name -> google.ads.googleads.v24.services.MutateCampaignConversionGoalResult
	0, // 4: google.ads.googleads.v24.services.CampaignConversionGoalService.MutateCampaignConversionGoals:input_type -> google.ads.googleads.v24.services.MutateCampaignConversionGoalsRequest
	2, // 5: google.ads.googleads.v24.services.CampaignConversionGoalService.MutateCampaignConversionGoals:output_type -> google.ads.googleads.v24.services.MutateCampaignConversionGoalsResponse
...
func init() { file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_init() }
func file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_init() {
	if File_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto = out.File
	file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_campaign_conversion_goal_service_proto_depIdxs = nil
}
...
func (c *campaignConversionGoalServiceClient) MutateCampaignConversionGoals(ctx context.Context, in *MutateCampaignConversionGoalsRequest, opts ...grpc.CallOption) (*MutateCampaignConversionGoalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CampaignConversionGoalService/MutateCampaignConversionGoals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignConversionGoalService_MutateCampaignConversionGoals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CampaignConversionGoalService/MutateCampaignConversionGoals",
	}
...
var _CampaignConversionGoalService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/campaign_conversion_goal_service.proto",
}
