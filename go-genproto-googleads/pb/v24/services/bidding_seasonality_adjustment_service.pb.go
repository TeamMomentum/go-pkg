...
func (x *MutateBiddingSeasonalityAdjustmentsRequest) Reset() {
	*x = MutateBiddingSeasonalityAdjustmentsRequest{}
	mi := &file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_msgTypes[0]
...
func (*MutateBiddingSeasonalityAdjustmentsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *BiddingSeasonalityAdjustmentOperation) Reset() {
	*x = BiddingSeasonalityAdjustmentOperation{}
	mi := &file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BiddingSeasonalityAdjustmentOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateBiddingSeasonalityAdjustmentsResponse) Reset() {
	*x = MutateBiddingSeasonalityAdjustmentsResponse{}
	mi := &file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateBiddingSeasonalityAdjustmentsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateBiddingSeasonalityAdjustmentsResult) Reset() {
	*x = MutateBiddingSeasonalityAdjustmentsResult{}
	mi := &file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateBiddingSeasonalityAdjustmentsResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x93, 0x02, 0x48, 0x3a, 0x01, 0x2a, 0x22, 0x43, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73,
	...
	0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x28, 0x42, 0x69,
	0x64, 0x64, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x61, 0x6c, 0x69, 0x74, 0x79,
...
var (
	file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDescData = file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_goTypes = []any{
	(*MutateBiddingSeasonalityAdjustmentsRequest)(nil),     // 0: google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsRequest
	(*BiddingSeasonalityAdjustmentOperation)(nil),          // 1: google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentOperation
	(*MutateBiddingSeasonalityAdjustmentsResponse)(nil),    // 2: google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsResponse
	(*MutateBiddingSeasonalityAdjustmentsResult)(nil),      // 3: google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsResult
	...
	(*resources.BiddingSeasonalityAdjustment)(nil),         // 6: google.ads.googleads.v24.resources.BiddingSeasonalityAdjustment
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsRequest.operations:type_name -> google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentOperation
	4, // 1: google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentOperation.create:type_name -> google.ads.googleads.v24.resources.BiddingSeasonalityAdjustment
	6, // 4: google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentOperation.update:type_name -> google.ads.googleads.v24.resources.BiddingSeasonalityAdjustment
	7, // 5: google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsResponse.results:type_name -> google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsResult
	6, // 7: google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsResult.bidding_seasonality_adjustment:type_name -> google.ads.googleads.v24.resources.BiddingSeasonalityAdjustment
	0, // 8: google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentService.MutateBiddingSeasonalityAdjustments:input_type -> google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsRequest
	2, // 9: google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentService.MutateBiddingSeasonalityAdjustments:output_type -> google.ads.googleads.v24.services.MutateBiddingSeasonalityAdjustmentsResponse
...
func file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_init() {
	if File_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto = out.File
	file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_bidding_seasonality_adjustment_service_proto_depIdxs = nil
}
...
func (c *biddingSeasonalityAdjustmentServiceClient) MutateBiddingSeasonalityAdjustments(ctx context.Context, in *MutateBiddingSeasonalityAdjustmentsRequest, opts ...grpc.CallOption) (*MutateBiddingSeasonalityAdjustmentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentService/MutateBiddingSeasonalityAdjustments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BiddingSeasonalityAdjustmentService_MutateBiddingSeasonalityAdjustments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.BiddingSeasonalityAdjustmentService/MutateBiddingSeasonalityAdjustments",
	}
...
var _BiddingSeasonalityAdjustmentService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/bidding_seasonality_adjustment_service.proto",
}
