...
func (x *MutateCampaignBudgetsRequest) Reset() {
	*x = MutateCampaignBudgetsRequest{}
	mi := &file_google_ads_googleads_v24_services_campaign_budget_service_proto_msgTypes[0]
...
func (*MutateCampaignBudgetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignBudgetOperation) Reset() {
	*x = CampaignBudgetOperation{}
	mi := &file_google_ads_googleads_v24_services_campaign_budget_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CampaignBudgetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignBudgetsResponse) Reset() {
	*x = MutateCampaignBudgetsResponse{}
	mi := &file_google_ads_googleads_v24_services_campaign_budget_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignBudgetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignBudgetResult) Reset() {
	*x = MutateCampaignBudgetResult{}
	mi := &file_google_ads_googleads_v24_services_campaign_budget_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignBudgetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_campaign_budget_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDesc = []byte{
	...
	0x93, 0x02, 0x3a, 0x3a, 0x01, 0x2a, 0x22, 0x35, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73,
	...
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1a,
	0x43, 0x61, 0x6d, 0x70, 0x61, 0x69, 0x67, 0x6e, 0x42, 0x75, 0x64, 0x67, 0x65, 0x74, 0x53, 0x65,
...
var (
	file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDescData = file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_campaign_budget_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_campaign_budget_service_proto_goTypes = []any{
	(*MutateCampaignBudgetsRequest)(nil),                   // 0: google.ads.googleads.v24.services.MutateCampaignBudgetsRequest
	(*CampaignBudgetOperation)(nil),                        // 1: google.ads.googleads.v24.services.CampaignBudgetOperation
	(*MutateCampaignBudgetsResponse)(nil),                  // 2: google.ads.googleads.v24.services.MutateCampaignBudgetsResponse
	(*MutateCampaignBudgetResult)(nil),                     // 3: google.ads.googleads.v24.services.MutateCampaignBudgetResult
	...
	(*resources.CampaignBudget)(nil),                       // 6: google.ads.googleads.v24.resources.CampaignBudget
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_campaign_budget_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCampaignBudgetsRequest.operations:type_name -> google.ads.googleads.v24.services.CampaignBudgetOperation
	4, // 1: google.ads.googleads.v24.services.MutateCampaignBudgetsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.CampaignBudgetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.CampaignBudgetOperation.create:type_name -> google.ads.googleads.v24.resources.CampaignBudget
	6, // 4: google.ads.googleads.v24.services.CampaignBudgetOperation.update:type_name -> google.ads.googleads.v24.resources.CampaignBudget
	7, // 5: google.ads.googleads.v24.services.MutateCampaignBudgetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateCampaignBudgetsResponse.results:type_name -> google.ads.googleads.v24.services.MutateCampaignBudgetResult
	6, // 7: google.ads.googleads.v24.services.MutateCampaignBudgetResult.campaign_budget:type_name -> google.ads.googleads.v24.resources.CampaignBudget
	0, // 8: google.ads.googleads.v24.services.CampaignBudgetService.MutateCampaignBudgets:input_type -> google.ads.googleads.v24.services.MutateCampaignBudgetsRequest
	2, // 9: google.ads.googleads.v24.services.CampaignBudgetService.MutateCampaignBudgets:output_type -> google.ads.googleads.v24.services.MutateCampaignBudgetsResponse
...
func init() { file_google_ads_googleads_v24_services_campaign_budget_service_proto_init() }
func file_google_ads_googleads_v24_services_campaign_budget_service_proto_init() {
	if File_google_ads_googleads_v24_services_campaign_budget_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_campaign_budget_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_campaign_budget_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_campaign_budget_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_campaign_budget_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_campaign_budget_service_proto = out.File
	file_google_ads_googleads_v24_services_campaign_budget_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_campaign_budget_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_campaign_budget_service_proto_depIdxs = nil
}
...
func (c *campaignBudgetServiceClient) MutateCampaignBudgets(ctx context.Context, in *MutateCampaignBudgetsRequest, opts ...grpc.CallOption) (*MutateCampaignBudgetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CampaignBudgetService/MutateCampaignBudgets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignBudgetService_MutateCampaignBudgets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CampaignBudgetService/MutateCampaignBudgets",
	}
...
var _CampaignBudgetService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/campaign_budget_service.proto",
}
