...
func (x *MutateAdGroupLabelsRequest) Reset() {
	*x = MutateAdGroupLabelsRequest{}
	mi := &file_google_ads_googleads_v24_services_ad_group_label_service_proto_msgTypes[0]
...
func (*MutateAdGroupLabelsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupLabelOperation) Reset() {
	*x = AdGroupLabelOperation{}
	mi := &file_google_ads_googleads_v24_services_ad_group_label_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdGroupLabelOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupLabelsResponse) Reset() {
	*x = MutateAdGroupLabelsResponse{}
	mi := &file_google_ads_googleads_v24_services_ad_group_label_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupLabelsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupLabelResult) Reset() {
	*x = MutateAdGroupLabelResult{}
	mi := &file_google_ads_googleads_v24_services_ad_group_label_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupLabelResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_ad_group_label_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDesc = []byte{
	...
	0x01, 0x2a, 0x22, 0x33, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65,
...
var (
	file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDescData = file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_ad_group_label_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_ad_group_label_service_proto_goTypes = []any{
	(*MutateAdGroupLabelsRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateAdGroupLabelsRequest
	(*AdGroupLabelOperation)(nil),       // 1: google.ads.googleads.v24.services.AdGroupLabelOperation
	(*MutateAdGroupLabelsResponse)(nil), // 2: google.ads.googleads.v24.services.MutateAdGroupLabelsResponse
	(*MutateAdGroupLabelResult)(nil),    // 3: google.ads.googleads.v24.services.MutateAdGroupLabelResult
	(*resources.AdGroupLabel)(nil),      // 4: google.ads.googleads.v24.resources.AdGroupLabel
	(*status.Status)(nil),               // 5: google.rpc.Status
}
var file_google_ads_googleads_v24_services_ad_group_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateAdGroupLabelsRequest.operations:type_name -> google.ads.googleads.v24.services.AdGroupLabelOperation
	4, // 1: google.ads.googleads.v24.services.AdGroupLabelOperation.create:type_name -> google.ads.googleads.v24.resources.AdGroupLabel
	5, // 2: google.ads.googleads.v24.services.MutateAdGroupLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 3: google.ads.googleads.v24.services.MutateAdGroupLabelsResponse.results:type_name -> google.ads.googleads.v24.services.MutateAdGroupLabelResult
	0, // 4: google.ads.googleads.v24.services.AdGroupLabelService.MutateAdGroupLabels:input_type -> google.ads.googleads.v24.services.MutateAdGroupLabelsRequest
	2, // 5: google.ads.googleads.v24.services.AdGroupLabelService.MutateAdGroupLabels:output_type -> google.ads.googleads.v24.services.MutateAdGroupLabelsResponse
...
func init() { file_google_ads_googleads_v24_services_ad_group_label_service_proto_init() }
func file_google_ads_googleads_v24_services_ad_group_label_service_proto_init() {
	if File_google_ads_googleads_v24_services_ad_group_label_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_ad_group_label_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_ad_group_label_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_ad_group_label_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_ad_group_label_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_ad_group_label_service_proto = out.File
	file_google_ads_googleads_v24_services_ad_group_label_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_ad_group_label_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_ad_group_label_service_proto_depIdxs = nil
}
...
func (c *adGroupLabelServiceClient) MutateAdGroupLabels(ctx context.Context, in *MutateAdGroupLabelsRequest, opts ...grpc.CallOption) (*MutateAdGroupLabelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AdGroupLabelService/MutateAdGroupLabels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdGroupLabelService_MutateAdGroupLabels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AdGroupLabelService/MutateAdGroupLabels",
	}
...
var _AdGroupLabelService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/ad_group_label_service.proto",
}
