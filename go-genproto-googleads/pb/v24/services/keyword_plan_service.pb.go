...
func (x *MutateKeywordPlansRequest) Reset() {
	*x = MutateKeywordPlansRequest{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_service_proto_msgTypes[0]
...
func (*MutateKeywordPlansRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordPlanOperation) Reset() {
	*x = KeywordPlanOperation{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordPlanOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateKeywordPlansResponse) Reset() {
	*x = MutateKeywordPlansResponse{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlansResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateKeywordPlansResult) Reset() {
	*x = MutateKeywordPlansResult{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlansResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_keyword_plan_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4b, 0x65, 0x79,
...
var (
	file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDescData = file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_keyword_plan_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_keyword_plan_service_proto_goTypes = []any{
	(*MutateKeywordPlansRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateKeywordPlansRequest
	(*KeywordPlanOperation)(nil),       // 1: google.ads.googleads.v24.services.KeywordPlanOperation
	(*MutateKeywordPlansResponse)(nil), // 2: google.ads.googleads.v24.services.MutateKeywordPlansResponse
	(*MutateKeywordPlansResult)(nil),   // 3: google.ads.googleads.v24.services.MutateKeywordPlansResult
	(*fieldmaskpb.FieldMask)(nil),      // 4: google.protobuf.FieldMask
	(*resources.KeywordPlan)(nil),      // 5: google.ads.googleads.v24.resources.KeywordPlan
	(*status.Status)(nil),              // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_keyword_plan_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateKeywordPlansRequest.operations:type_name -> google.ads.googleads.v24.services.KeywordPlanOperation
	4, // 1: google.ads.googleads.v24.services.KeywordPlanOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.KeywordPlanOperation.create:type_name -> google.ads.googleads.v24.resources.KeywordPlan
	5, // 3: google.ads.googleads.v24.services.KeywordPlanOperation.update:type_name -> google.ads.googleads.v24.resources.KeywordPlan
	6, // 4: google.ads.googleads.v24.services.MutateKeywordPlansResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 5: google.ads.googleads.v24.services.MutateKeywordPlansResponse.results:type_name -> google.ads.googleads.v24.services.MutateKeywordPlansResult
	0, // 6: google.ads.googleads.v24.services.KeywordPlanService.MutateKeywordPlans:input_type -> google.ads.googleads.v24.services.MutateKeywordPlansRequest
	2, // 7: google.ads.googleads.v24.services.KeywordPlanService.MutateKeywordPlans:output_type -> google.ads.googleads.v24.services.MutateKeywordPlansResponse
...
func init() { file_google_ads_googleads_v24_services_keyword_plan_service_proto_init() }
func file_google_ads_googleads_v24_services_keyword_plan_service_proto_init() {
	if File_google_ads_googleads_v24_services_keyword_plan_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_keyword_plan_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_keyword_plan_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_keyword_plan_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_keyword_plan_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_keyword_plan_service_proto = out.File
	file_google_ads_googleads_v24_services_keyword_plan_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_keyword_plan_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_keyword_plan_service_proto_depIdxs = nil
}
...
func (c *keywordPlanServiceClient) MutateKeywordPlans(ctx context.Context, in *MutateKeywordPlansRequest, opts ...grpc.CallOption) (*MutateKeywordPlansResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.KeywordPlanService/MutateKeywordPlans", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _KeywordPlanService_MutateKeywordPlans_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.KeywordPlanService/MutateKeywordPlans",
	}
...
var _KeywordPlanService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/keyword_plan_service.proto",
}
