...
func (x *MutateRecommendationSubscriptionRequest) Reset() {
	*x = MutateRecommendationSubscriptionRequest{}
	mi := &file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_msgTypes[0]
...
func (*MutateRecommendationSubscriptionRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *RecommendationSubscriptionOperation) Reset() {
	*x = RecommendationSubscriptionOperation{}
	mi := &file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecommendationSubscriptionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateRecommendationSubscriptionResponse) Reset() {
	*x = MutateRecommendationSubscriptionResponse{}
	mi := &file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateRecommendationSubscriptionResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateRecommendationSubscriptionResult) Reset() {
	*x = MutateRecommendationSubscriptionResult{}
	mi := &file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateRecommendationSubscriptionResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_recommendation_subscription_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDesc = []byte{
	...
	0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x6d,
	0x6d, 0x65, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69,
	...
	0x93, 0x02, 0x60, 0x3a, 0x01, 0x2a, 0x22, 0x5b, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73,
	...
	0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x32, 0x34, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x73, 0xca, 0x02, 0x21, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73,
	0x5c, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x5c, 0x56, 0x32, 0x34, 0x5c, 0x53,
	...
	0x3a, 0x3a, 0x56, 0x32, 0x34, 0x3a, 0x3a, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDescData = file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_goTypes = []any{
	(*MutateRecommendationSubscriptionRequest)(nil),        // 0: google.ads.googleads.v24.services.MutateRecommendationSubscriptionRequest
	(*RecommendationSubscriptionOperation)(nil),            // 1: google.ads.googleads.v24.services.RecommendationSubscriptionOperation
	(*MutateRecommendationSubscriptionResponse)(nil),       // 2: google.ads.googleads.v24.services.MutateRecommendationSubscriptionResponse
	(*MutateRecommendationSubscriptionResult)(nil),         // 3: google.ads.googleads.v24.services.MutateRecommendationSubscriptionResult
	(enums.ResponseContentTypeEnum_ResponseContentType)(0), // 4: google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	(*fieldmaskpb.FieldMask)(nil),                          // 5: google.protobuf.FieldMask
	(*resources.RecommendationSubscription)(nil),           // 6: google.ads.googleads.v24.resources.RecommendationSubscription
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateRecommendationSubscriptionRequest.operations:type_name -> google.ads.googleads.v24.services.RecommendationSubscriptionOperation
	4, // 1: google.ads.googleads.v24.services.MutateRecommendationSubscriptionRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.RecommendationSubscriptionOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.RecommendationSubscriptionOperation.create:type_name -> google.ads.googleads.v24.resources.RecommendationSubscription
	6, // 4: google.ads.googleads.v24.services.RecommendationSubscriptionOperation.update:type_name -> google.ads.googleads.v24.resources.RecommendationSubscription
	3, // 5: google.ads.googleads.v24.services.MutateRecommendationSubscriptionResponse.results:type_name -> google.ads.googleads.v24.services.MutateRecommendationSubscriptionResult
	7, // 6: google.ads.googleads.v24.services.MutateRecommendationSubscriptionResponse.partial_failure_error:type_name -> google.rpc.Status
	6, // 7: google.ads.googleads.v24.services.MutateRecommendationSubscriptionResult.recommendation_subscription:type_name -> google.ads.googleads.v24.resources.RecommendationSubscription
	0, // 8: google.ads.googleads.v24.services.RecommendationSubscriptionService.MutateRecommendationSubscription:input_type -> google.ads.googleads.v24.services.MutateRecommendationSubscriptionRequest
	2, // 9: google.ads.googleads.v24.services.RecommendationSubscriptionService.MutateRecommendationSubscription:output_type -> google.ads.googleads.v24.services.MutateRecommendationSubscriptionResponse
...
func init() { file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_init() }
func file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_init() {
	if File_google_ads_googleads_v24_services_recommendation_subscription_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_recommendation_subscription_service_proto = out.File
	file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_recommendation_subscription_service_proto_depIdxs = nil
}
...
func (c *recommendationSubscriptionServiceClient) MutateRecommendationSubscription(ctx context.Context, in *MutateRecommendationSubscriptionRequest, opts ...grpc.CallOption) (*MutateRecommendationSubscriptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.RecommendationSubscriptionService/MutateRecommendationSubscription", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedRecommendationSubscriptionServiceServer can be embedded to have forward compatible implementations.
...
func (*UnimplementedRecommendationSubscriptionServiceServer) MutateRecommendationSubscription(context.Context, *MutateRecommendationSubscriptionRequest) (*MutateRecommendationSubscriptionResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method MutateRecommendationSubscription not implemented")
}

func RegisterRecommendationSubscriptionServiceServer(s *grpc.Server, srv RecommendationSubscriptionServiceServer) {
	s.RegisterService(&_RecommendationSubscriptionService_serviceDesc, srv)
}
...
func _RecommendationSubscriptionService_MutateRecommendationSubscription_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.RecommendationSubscriptionService/MutateRecommendationSubscription",
	}
...
var _RecommendationSubscriptionService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/recommendation_subscription_service.proto",
}
