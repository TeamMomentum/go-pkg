...
func (x *MutateCampaignSharedSetsRequest) Reset() {
	*x = MutateCampaignSharedSetsRequest{}
	mi := &file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_msgTypes[0]
...
func (*MutateCampaignSharedSetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignSharedSetOperation) Reset() {
	*x = CampaignSharedSetOperation{}
	mi := &file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CampaignSharedSetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignSharedSetsResponse) Reset() {
	*x = MutateCampaignSharedSetsResponse{}
	mi := &file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignSharedSetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignSharedSetResult) Reset() {
	*x = MutateCampaignSharedSetResult{}
	mi := &file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignSharedSetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_campaign_shared_set_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDesc = []byte{
	...
	0x01, 0x2a, 0x22, 0x38, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65,
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1d, 0x43,
...
var (
	file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDescData = file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_goTypes = []any{
	(*MutateCampaignSharedSetsRequest)(nil),                // 0: google.ads.googleads.v24.services.MutateCampaignSharedSetsRequest
	(*CampaignSharedSetOperation)(nil),                     // 1: google.ads.googleads.v24.services.CampaignSharedSetOperation
	(*MutateCampaignSharedSetsResponse)(nil),               // 2: google.ads.googleads.v24.services.MutateCampaignSharedSetsResponse
	(*MutateCampaignSharedSetResult)(nil),                  // 3: google.ads.googleads.v24.services.MutateCampaignSharedSetResult
	...
	(*resources.CampaignSharedSet)(nil),                    // 5: google.ads.googleads.v24.resources.CampaignSharedSet
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCampaignSharedSetsRequest.operations:type_name -> google.ads.googleads.v24.services.CampaignSharedSetOperation
	4, // 1: google.ads.googleads.v24.services.MutateCampaignSharedSetsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.CampaignSharedSetOperation.create:type_name -> google.ads.googleads.v24.resources.CampaignSharedSet
	6, // 3: google.ads.googleads.v24.services.MutateCampaignSharedSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 4: google.ads.googleads.v24.services.MutateCampaignSharedSetsResponse.results:type_name -> google.ads.googleads.v24.services.MutateCampaignSharedSetResult
	5, // 5: google.ads.googleads.v24.services.MutateCampaignSharedSetResult.campaign_shared_set:type_name -> google.ads.googleads.v24.resources.CampaignSharedSet
	0, // 6: google.ads.googleads.v24.services.CampaignSharedSetService.MutateCampaignSharedSets:input_type -> google.ads.googleads.v24.services.MutateCampaignSharedSetsRequest
	2, // 7: google.ads.googleads.v24.services.CampaignSharedSetService.MutateCampaignSharedSets:output_type -> google.ads.googleads.v24.services.MutateCampaignSharedSetsResponse
...
func init() { file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_init() }
func file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_init() {
	if File_google_ads_googleads_v24_services_campaign_shared_set_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_campaign_shared_set_service_proto = out.File
	file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_campaign_shared_set_service_proto_depIdxs = nil
}
...
func (c *campaignSharedSetServiceClient) MutateCampaignSharedSets(ctx context.Context, in *MutateCampaignSharedSetsRequest, opts ...grpc.CallOption) (*MutateCampaignSharedSetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CampaignSharedSetService/MutateCampaignSharedSets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignSharedSetService_MutateCampaignSharedSets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CampaignSharedSetService/MutateCampaignSharedSets",
	}
...
var _CampaignSharedSetService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/campaign_shared_set_service.proto",
}
