...
func (x *MutateCustomInterestsRequest) Reset() {
	*x = MutateCustomInterestsRequest{}
	mi := &file_google_ads_googleads_v24_services_custom_interest_service_proto_msgTypes[0]
...
func (*MutateCustomInterestsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomInterestOperation) Reset() {
	*x = CustomInterestOperation{}
	mi := &file_google_ads_googleads_v24_services_custom_interest_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomInterestOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomInterestsResponse) Reset() {
	*x = MutateCustomInterestsResponse{}
	mi := &file_google_ads_googleads_v24_services_custom_interest_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomInterestsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomInterestResult) Reset() {
	*x = MutateCustomInterestResult{}
	mi := &file_google_ads_googleads_v24_services_custom_interest_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomInterestResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_custom_interest_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDesc = []byte{
	...
	0xd3, 0xe4, 0x93, 0x02, 0x3a, 0x3a, 0x01, 0x2a, 0x22, 0x35, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63,
...
var (
	file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDescData = file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_custom_interest_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_custom_interest_service_proto_goTypes = []any{
	(*MutateCustomInterestsRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateCustomInterestsRequest
	(*CustomInterestOperation)(nil),       // 1: google.ads.googleads.v24.services.CustomInterestOperation
	(*MutateCustomInterestsResponse)(nil), // 2: google.ads.googleads.v24.services.MutateCustomInterestsResponse
	(*MutateCustomInterestResult)(nil),    // 3: google.ads.googleads.v24.services.MutateCustomInterestResult
	(*fieldmaskpb.FieldMask)(nil),         // 4: google.protobuf.FieldMask
	(*resources.CustomInterest)(nil),      // 5: google.ads.googleads.v24.resources.CustomInterest
}
var file_google_ads_googleads_v24_services_custom_interest_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCustomInterestsRequest.operations:type_name -> google.ads.googleads.v24.services.CustomInterestOperation
	4, // 1: google.ads.googleads.v24.services.CustomInterestOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.CustomInterestOperation.create:type_name -> google.ads.googleads.v24.resources.CustomInterest
	5, // 3: google.ads.googleads.v24.services.CustomInterestOperation.update:type_name -> google.ads.googleads.v24.resources.CustomInterest
	3, // 4: google.ads.googleads.v24.services.MutateCustomInterestsResponse.results:type_name -> google.ads.googleads.v24.services.MutateCustomInterestResult
	0, // 5: google.ads.googleads.v24.services.CustomInterestService.MutateCustomInterests:input_type -> google.ads.googleads.v24.services.MutateCustomInterestsRequest
	2, // 6: google.ads.googleads.v24.services.CustomInterestService.MutateCustomInterests:output_type -> google.ads.googleads.v24.services.MutateCustomInterestsResponse
...
func init() { file_google_ads_googleads_v24_services_custom_interest_service_proto_init() }
func file_google_ads_googleads_v24_services_custom_interest_service_proto_init() {
	if File_google_ads_googleads_v24_services_custom_interest_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_custom_interest_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_custom_interest_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_custom_interest_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_custom_interest_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_custom_interest_service_proto = out.File
	file_google_ads_googleads_v24_services_custom_interest_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_custom_interest_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_custom_interest_service_proto_depIdxs = nil
}
...
func (c *customInterestServiceClient) MutateCustomInterests(ctx context.Context, in *MutateCustomInterestsRequest, opts ...grpc.CallOption) (*MutateCustomInterestsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomInterestService/MutateCustomInterests", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomInterestService_MutateCustomInterests_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomInterestService/MutateCustomInterests",
	}
...
var _CustomInterestService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/custom_interest_service.proto",
}
