...
func (x *MutateAssetSetsRequest) Reset() {
	*x = MutateAssetSetsRequest{}
	mi := &file_google_ads_googleads_v24_services_asset_set_service_proto_msgTypes[0]
...
func (*MutateAssetSetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetSetOperation) Reset() {
	*x = AssetSetOperation{}
	mi := &file_google_ads_googleads_v24_services_asset_set_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AssetSetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAssetSetsResponse) Reset() {
	*x = MutateAssetSetsResponse{}
	mi := &file_google_ads_googleads_v24_services_asset_set_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAssetSetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetSetResult) Reset() {
	*x = MutateAssetSetResult{}
	mi := &file_google_ads_googleads_v24_services_asset_set_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAssetSetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_set_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_asset_set_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_asset_set_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_services_asset_set_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_asset_set_service_proto_rawDescData = file_google_ads_googleads_v24_services_asset_set_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_asset_set_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_asset_set_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_asset_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_asset_set_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_asset_set_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_asset_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_asset_set_service_proto_goTypes = []any{
	(*MutateAssetSetsRequest)(nil),                         // 0: google.ads.googleads.v24.services.MutateAssetSetsRequest
	(*AssetSetOperation)(nil),                              // 1: google.ads.googleads.v24.services.AssetSetOperation
	(*MutateAssetSetsResponse)(nil),                        // 2: google.ads.googleads.v24.services.MutateAssetSetsResponse
	(*MutateAssetSetResult)(nil),                           // 3: google.ads.googleads.v24.services.MutateAssetSetResult
	...
	(*resources.AssetSet)(nil),                             // 6: google.ads.googleads.v24.resources.AssetSet
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_asset_set_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateAssetSetsRequest.operations:type_name -> google.ads.googleads.v24.services.AssetSetOperation
	4, // 1: google.ads.googleads.v24.services.MutateAssetSetsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.AssetSetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.AssetSetOperation.create:type_name -> google.ads.googleads.v24.resources.AssetSet
	6, // 4: google.ads.googleads.v24.services.AssetSetOperation.update:type_name -> google.ads.googleads.v24.resources.AssetSet
	3, // 5: google.ads.googleads.v24.services.MutateAssetSetsResponse.results:type_name -> google.ads.googleads.v24.services.MutateAssetSetResult
	7, // 6: google.ads.googleads.v24.services.MutateAssetSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	6, // 7: google.ads.googleads.v24.services.MutateAssetSetResult.asset_set:type_name -> google.ads.googleads.v24.resources.AssetSet
	0, // 8: google.ads.googleads.v24.services.AssetSetService.MutateAssetSets:input_type -> google.ads.googleads.v24.services.MutateAssetSetsRequest
	2, // 9: google.ads.googleads.v24.services.AssetSetService.MutateAssetSets:output_type -> google.ads.googleads.v24.services.MutateAssetSetsResponse
...
func init() { file_google_ads_googleads_v24_services_asset_set_service_proto_init() }
func file_google_ads_googleads_v24_services_asset_set_service_proto_init() {
	if File_google_ads_googleads_v24_services_asset_set_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_asset_set_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_asset_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_asset_set_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_asset_set_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_asset_set_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_asset_set_service_proto = out.File
	file_google_ads_googleads_v24_services_asset_set_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_asset_set_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_asset_set_service_proto_depIdxs = nil
}
...
func (c *assetSetServiceClient) MutateAssetSets(ctx context.Context, in *MutateAssetSetsRequest, opts ...grpc.CallOption) (*MutateAssetSetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AssetSetService/MutateAssetSets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AssetSetService_MutateAssetSets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AssetSetService/MutateAssetSets",
	}
...
var _AssetSetService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/asset_set_service.proto",
}
