...
func (x *UploadUserDataRequest) Reset() {
	*x = UploadUserDataRequest{}
	mi := &file_google_ads_googleads_v24_services_user_data_service_proto_msgTypes[0]
...
func (*UploadUserDataRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_user_data_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *UserDataOperation) Reset() {
	*x = UserDataOperation{}
	mi := &file_google_ads_googleads_v24_services_user_data_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserDataOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_user_data_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *UploadUserDataResponse) Reset() {
	*x = UploadUserDataResponse{}
	mi := &file_google_ads_googleads_v24_services_user_data_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UploadUserDataResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_user_data_service_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v24_services_user_data_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_user_data_service_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x37,
	...
	0x02, 0x32, 0x3a, 0x01, 0x2a, 0x22, 0x2d, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74,
...
var (
	file_google_ads_googleads_v24_services_user_data_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_user_data_service_proto_rawDescData = file_google_ads_googleads_v24_services_user_data_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_user_data_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_user_data_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_user_data_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_user_data_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_user_data_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_user_data_service_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v24_services_user_data_service_proto_goTypes = []any{
	(*UploadUserDataRequest)(nil),                // 0: google.ads.googleads.v24.services.UploadUserDataRequest
	(*UserDataOperation)(nil),                    // 1: google.ads.googleads.v24.services.UserDataOperation
	(*UploadUserDataResponse)(nil),               // 2: google.ads.googleads.v24.services.UploadUserDataResponse
	(*common.CustomerMatchUserListMetadata)(nil), // 3: google.ads.googleads.v24.common.CustomerMatchUserListMetadata
	(*common.UserData)(nil),                      // 4: google.ads.googleads.v24.common.UserData
}
var file_google_ads_googleads_v24_services_user_data_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.UploadUserDataRequest.operations:type_name -> google.ads.googleads.v24.services.UserDataOperation
	3, // 1: google.ads.googleads.v24.services.UploadUserDataRequest.customer_match_user_list_metadata:type_name -> google.ads.googleads.v24.common.CustomerMatchUserListMetadata
	4, // 2: google.ads.googleads.v24.services.UserDataOperation.create:type_name -> google.ads.googleads.v24.common.UserData
	4, // 3: google.ads.googleads.v24.services.UserDataOperation.remove:type_name -> google.ads.googleads.v24.common.UserData
	0, // 4: google.ads.googleads.v24.services.UserDataService.UploadUserData:input_type -> google.ads.googleads.v24.services.UploadUserDataRequest
	2, // 5: google.ads.googleads.v24.services.UserDataService.UploadUserData:output_type -> google.ads.googleads.v24.services.UploadUserDataResponse
...
func init() { file_google_ads_googleads_v24_services_user_data_service_proto_init() }
func file_google_ads_googleads_v24_services_user_data_service_proto_init() {
	if File_google_ads_googleads_v24_services_user_data_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_user_data_service_proto_msgTypes[0].OneofWrappers = []any{
		(*UploadUserDataRequest_CustomerMatchUserListMetadata)(nil),
	}
	file_google_ads_googleads_v24_services_user_data_service_proto_msgTypes[1].OneofWrappers = []any{
		(*UserDataOperation_Create)(nil),
		(*UserDataOperation_Remove)(nil),
	}
	file_google_ads_googleads_v24_services_user_data_service_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_services_user_data_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_user_data_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_user_data_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_user_data_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_user_data_service_proto = out.File
	file_google_ads_googleads_v24_services_user_data_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_user_data_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_user_data_service_proto_depIdxs = nil
}
...
func (c *userDataServiceClient) UploadUserData(ctx context.Context, in *UploadUserDataRequest, opts ...grpc.CallOption) (*UploadUserDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.UserDataService/UploadUserData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserDataService_UploadUserData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.UserDataService/UploadUserData",
	}
...
var _UserDataService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/user_data_service.proto",
}
