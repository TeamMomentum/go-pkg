...
func (x *MutateCustomerCustomizersRequest) Reset() {
	*x = MutateCustomerCustomizersRequest{}
	mi := &file_google_ads_googleads_v24_services_customer_customizer_service_proto_msgTypes[0]
...
func (*MutateCustomerCustomizersRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerCustomizerOperation) Reset() {
	*x = CustomerCustomizerOperation{}
	mi := &file_google_ads_googleads_v24_services_customer_customizer_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerCustomizerOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerCustomizersResponse) Reset() {
	*x = MutateCustomerCustomizersResponse{}
	mi := &file_google_ads_googleads_v24_services_customer_customizer_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerCustomizersResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerCustomizerResult) Reset() {
	*x = MutateCustomerCustomizerResult{}
	mi := &file_google_ads_googleads_v24_services_customer_customizer_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerCustomizerResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_customer_customizer_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	...
	0x2a, 0x22, 0x39, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
	...
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1e, 0x43,
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x69, 0x7a, 0x65,
...
var (
	file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDescData = file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_customer_customizer_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_customer_customizer_service_proto_goTypes = []any{
	(*MutateCustomerCustomizersRequest)(nil),               // 0: google.ads.googleads.v24.services.MutateCustomerCustomizersRequest
	(*CustomerCustomizerOperation)(nil),                    // 1: google.ads.googleads.v24.services.CustomerCustomizerOperation
	(*MutateCustomerCustomizersResponse)(nil),              // 2: google.ads.googleads.v24.services.MutateCustomerCustomizersResponse
	(*MutateCustomerCustomizerResult)(nil),                 // 3: google.ads.googleads.v24.services.MutateCustomerCustomizerResult
	...
	(*resources.CustomerCustomizer)(nil),                   // 5: google.ads.googleads.v24.resources.CustomerCustomizer
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_customer_customizer_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCustomerCustomizersRequest.operations:type_name -> google.ads.googleads.v24.services.CustomerCustomizerOperation
	4, // 1: google.ads.googleads.v24.services.MutateCustomerCustomizersRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.CustomerCustomizerOperation.create:type_name -> google.ads.googleads.v24.resources.CustomerCustomizer
	3, // 3: google.ads.googleads.v24.services.MutateCustomerCustomizersResponse.results:type_name -> google.ads.googleads.v24.services.MutateCustomerCustomizerResult
	6, // 4: google.ads.googleads.v24.services.MutateCustomerCustomizersResponse.partial_failure_error:type_name -> google.rpc.Status
	5, // 5: google.ads.googleads.v24.services.MutateCustomerCustomizerResult.customer_customizer:type_name -> google.ads.googleads.v24.resources.CustomerCustomizer
	0, // 6: google.ads.googleads.v24.services.CustomerCustomizerService.MutateCustomerCustomizers:input_type -> google.ads.googleads.v24.services.MutateCustomerCustomizersRequest
	2, // 7: google.ads.googleads.v24.services.CustomerCustomizerService.MutateCustomerCustomizers:output_type -> google.ads.googleads.v24.services.MutateCustomerCustomizersResponse
...
func init() { file_google_ads_googleads_v24_services_customer_customizer_service_proto_init() }
func file_google_ads_googleads_v24_services_customer_customizer_service_proto_init() {
	if File_google_ads_googleads_v24_services_customer_customizer_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_customer_customizer_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_customer_customizer_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_customer_customizer_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_customer_customizer_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_customer_customizer_service_proto = out.File
	file_google_ads_googleads_v24_services_customer_customizer_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_customer_customizer_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_customer_customizer_service_proto_depIdxs = nil
}
...
func (c *customerCustomizerServiceClient) MutateCustomerCustomizers(ctx context.Context, in *MutateCustomerCustomizersRequest, opts ...grpc.CallOption) (*MutateCustomerCustomizersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomerCustomizerService/MutateCustomerCustomizers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerCustomizerService_MutateCustomerCustomizers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomerCustomizerService/MutateCustomerCustomizers",
	}
...
var _CustomerCustomizerService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/customer_customizer_service.proto",
}
