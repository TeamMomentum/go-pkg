...
func (x *MutateAdGroupAssetsRequest) Reset() {
	*x = MutateAdGroupAssetsRequest{}
	mi := &file_google_ads_googleads_v24_services_ad_group_asset_service_proto_msgTypes[0]
...
func (*MutateAdGroupAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AdGroupAssetOperation) Reset() {
	*x = AdGroupAssetOperation{}
	mi := &file_google_ads_googleads_v24_services_ad_group_asset_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AdGroupAssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAdGroupAssetsResponse) Reset() {
	*x = MutateAdGroupAssetsResponse{}
	mi := &file_google_ads_googleads_v24_services_ad_group_asset_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAdGroupAssetResult) Reset() {
	*x = MutateAdGroupAssetResult{}
	mi := &file_google_ads_googleads_v24_services_ad_group_asset_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAdGroupAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_ad_group_asset_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDesc = []byte{
	...
	0x3a, 0x01, 0x2a, 0x22, 0x33, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
...
var (
	file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDescData = file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_ad_group_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_ad_group_asset_service_proto_goTypes = []any{
	(*MutateAdGroupAssetsRequest)(nil),                     // 0: google.ads.googleads.v24.services.MutateAdGroupAssetsRequest
	(*AdGroupAssetOperation)(nil),                          // 1: google.ads.googleads.v24.services.AdGroupAssetOperation
	(*MutateAdGroupAssetsResponse)(nil),                    // 2: google.ads.googleads.v24.services.MutateAdGroupAssetsResponse
	(*MutateAdGroupAssetResult)(nil),                       // 3: google.ads.googleads.v24.services.MutateAdGroupAssetResult
	...
	(*resources.AdGroupAsset)(nil),                         // 6: google.ads.googleads.v24.resources.AdGroupAsset
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_ad_group_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateAdGroupAssetsRequest.operations:type_name -> google.ads.googleads.v24.services.AdGroupAssetOperation
	4, // 1: google.ads.googleads.v24.services.MutateAdGroupAssetsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.AdGroupAssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.AdGroupAssetOperation.create:type_name -> google.ads.googleads.v24.resources.AdGroupAsset
	6, // 4: google.ads.googleads.v24.services.AdGroupAssetOperation.update:type_name -> google.ads.googleads.v24.resources.AdGroupAsset
	7, // 5: google.ads.googleads.v24.services.MutateAdGroupAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateAdGroupAssetsResponse.results:type_name -> google.ads.googleads.v24.services.MutateAdGroupAssetResult
	6, // 7: google.ads.googleads.v24.services.MutateAdGroupAssetResult.ad_group_asset:type_name -> google.ads.googleads.v24.resources.AdGroupAsset
	0, // 8: google.ads.googleads.v24.services.AdGroupAssetService.MutateAdGroupAssets:input_type -> google.ads.googleads.v24.services.MutateAdGroupAssetsRequest
	2, // 9: google.ads.googleads.v24.services.AdGroupAssetService.MutateAdGroupAssets:output_type -> google.ads.googleads.v24.services.MutateAdGroupAssetsResponse
...
func init() { file_google_ads_googleads_v24_services_ad_group_asset_service_proto_init() }
func file_google_ads_googleads_v24_services_ad_group_asset_service_proto_init() {
	if File_google_ads_googleads_v24_services_ad_group_asset_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_ad_group_asset_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_ad_group_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_ad_group_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_ad_group_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_ad_group_asset_service_proto = out.File
	file_google_ads_googleads_v24_services_ad_group_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_ad_group_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_ad_group_asset_service_proto_depIdxs = nil
}
...
func (c *adGroupAssetServiceClient) MutateAdGroupAssets(ctx context.Context, in *MutateAdGroupAssetsRequest, opts ...grpc.CallOption) (*MutateAdGroupAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AdGroupAssetService/MutateAdGroupAssets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AdGroupAssetService_MutateAdGroupAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AdGroupAssetService/MutateAdGroupAssets",
	}
...
var _AdGroupAssetService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/ad_group_asset_service.proto",
}
