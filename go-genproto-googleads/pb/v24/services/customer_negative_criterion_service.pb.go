...
func (x *MutateCustomerNegativeCriteriaRequest) Reset() {
	*x = MutateCustomerNegativeCriteriaRequest{}
	mi := &file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_msgTypes[0]
...
func (*MutateCustomerNegativeCriteriaRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerNegativeCriterionOperation) Reset() {
	*x = CustomerNegativeCriterionOperation{}
	mi := &file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerNegativeCriterionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerNegativeCriteriaResponse) Reset() {
	*x = MutateCustomerNegativeCriteriaResponse{}
	mi := &file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerNegativeCriteriaResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerNegativeCriteriaResult) Reset() {
	*x = MutateCustomerNegativeCriteriaResult{}
	mi := &file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerNegativeCriteriaResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_customer_negative_criterion_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDesc = []byte{
	...
	0x93, 0x02, 0x43, 0x3a, 0x01, 0x2a, 0x22, 0x3e, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x32, 0x34, 0x2e, 0x53, 0x65, 0x72,
	...
	0x64, 0x73, 0x3a, 0x3a, 0x56, 0x32, 0x34, 0x3a, 0x3a, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDescData = file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_goTypes = []any{
	(*MutateCustomerNegativeCriteriaRequest)(nil),          // 0: google.ads.googleads.v24.services.MutateCustomerNegativeCriteriaRequest
	(*CustomerNegativeCriterionOperation)(nil),             // 1: google.ads.googleads.v24.services.CustomerNegativeCriterionOperation
	(*MutateCustomerNegativeCriteriaResponse)(nil),         // 2: google.ads.googleads.v24.services.MutateCustomerNegativeCriteriaResponse
	(*MutateCustomerNegativeCriteriaResult)(nil),           // 3: google.ads.googleads.v24.services.MutateCustomerNegativeCriteriaResult
	...
	(*resources.CustomerNegativeCriterion)(nil),            // 5: google.ads.googleads.v24.resources.CustomerNegativeCriterion
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCustomerNegativeCriteriaRequest.operations:type_name -> google.ads.googleads.v24.services.CustomerNegativeCriterionOperation
	4, // 1: google.ads.googleads.v24.services.MutateCustomerNegativeCriteriaRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.CustomerNegativeCriterionOperation.create:type_name -> google.ads.googleads.v24.resources.CustomerNegativeCriterion
	6, // 3: google.ads.googleads.v24.services.MutateCustomerNegativeCriteriaResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 4: google.ads.googleads.v24.services.MutateCustomerNegativeCriteriaResponse.results:type_name -> google.ads.googleads.v24.services.MutateCustomerNegativeCriteriaResult
	5, // 5: google.ads.googleads.v24.services.MutateCustomerNegativeCriteriaResult.customer_negative_criterion:type_name -> google.ads.googleads.v24.resources.CustomerNegativeCriterion
	0, // 6: google.ads.googleads.v24.services.CustomerNegativeCriterionService.MutateCustomerNegativeCriteria:input_type -> google.ads.googleads.v24.services.MutateCustomerNegativeCriteriaRequest
	2, // 7: google.ads.googleads.v24.services.CustomerNegativeCriterionService.MutateCustomerNegativeCriteria:output_type -> google.ads.googleads.v24.services.MutateCustomerNegativeCriteriaResponse
...
func init() { file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_init() }
func file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_init() {
	if File_google_ads_googleads_v24_services_customer_negative_criterion_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_customer_negative_criterion_service_proto = out.File
	file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_customer_negative_criterion_service_proto_depIdxs = nil
}
...
func (c *customerNegativeCriterionServiceClient) MutateCustomerNegativeCriteria(ctx context.Context, in *MutateCustomerNegativeCriteriaRequest, opts ...grpc.CallOption) (*MutateCustomerNegativeCriteriaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomerNegativeCriterionService/MutateCustomerNegativeCriteria", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerNegativeCriterionService_MutateCustomerNegativeCriteria_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomerNegativeCriterionService/MutateCustomerNegativeCriteria",
	}
...
var _CustomerNegativeCriterionService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/customer_negative_criterion_service.proto",
}
