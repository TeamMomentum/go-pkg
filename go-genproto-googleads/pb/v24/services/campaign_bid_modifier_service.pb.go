...
func (x *MutateCampaignBidModifiersRequest) Reset() {
	*x = MutateCampaignBidModifiersRequest{}
	mi := &file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_msgTypes[0]
...
func (*MutateCampaignBidModifiersRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignBidModifierOperation) Reset() {
	*x = CampaignBidModifierOperation{}
	mi := &file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CampaignBidModifierOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignBidModifiersResponse) Reset() {
	*x = MutateCampaignBidModifiersResponse{}
	mi := &file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignBidModifiersResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignBidModifierResult) Reset() {
	*x = MutateCampaignBidModifierResult{}
	mi := &file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignBidModifierResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x72, 0x65, 0x73, 0x70, 0x6f,
	...
	0xd3, 0xe4, 0x93, 0x02, 0x3f, 0x3a, 0x01, 0x2a, 0x22, 0x3a, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63,
...
var (
	file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDescData = file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_goTypes = []any{
	(*MutateCampaignBidModifiersRequest)(nil),              // 0: google.ads.googleads.v24.services.MutateCampaignBidModifiersRequest
	(*CampaignBidModifierOperation)(nil),                   // 1: google.ads.googleads.v24.services.CampaignBidModifierOperation
	(*MutateCampaignBidModifiersResponse)(nil),             // 2: google.ads.googleads.v24.services.MutateCampaignBidModifiersResponse
	(*MutateCampaignBidModifierResult)(nil),                // 3: google.ads.googleads.v24.services.MutateCampaignBidModifierResult
	...
	(*resources.CampaignBidModifier)(nil),                  // 6: google.ads.googleads.v24.resources.CampaignBidModifier
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCampaignBidModifiersRequest.operations:type_name -> google.ads.googleads.v24.services.CampaignBidModifierOperation
	4, // 1: google.ads.googleads.v24.services.MutateCampaignBidModifiersRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.CampaignBidModifierOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.CampaignBidModifierOperation.create:type_name -> google.ads.googleads.v24.resources.CampaignBidModifier
	6, // 4: google.ads.googleads.v24.services.CampaignBidModifierOperation.update:type_name -> google.ads.googleads.v24.resources.CampaignBidModifier
	7, // 5: google.ads.googleads.v24.services.MutateCampaignBidModifiersResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateCampaignBidModifiersResponse.results:type_name -> google.ads.googleads.v24.services.MutateCampaignBidModifierResult
	6, // 7: google.ads.googleads.v24.services.MutateCampaignBidModifierResult.campaign_bid_modifier:type_name -> google.ads.googleads.v24.resources.CampaignBidModifier
	0, // 8: google.ads.googleads.v24.services.CampaignBidModifierService.MutateCampaignBidModifiers:input_type -> google.ads.googleads.v24.services.MutateCampaignBidModifiersRequest
	2, // 9: google.ads.googleads.v24.services.CampaignBidModifierService.MutateCampaignBidModifiers:output_type -> google.ads.googleads.v24.services.MutateCampaignBidModifiersResponse
...
func init() { file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_init() }
func file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_init() {
	if File_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto = out.File
	file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_campaign_bid_modifier_service_proto_depIdxs = nil
}
...
func (c *campaignBidModifierServiceClient) MutateCampaignBidModifiers(ctx context.Context, in *MutateCampaignBidModifiersRequest, opts ...grpc.CallOption) (*MutateCampaignBidModifiersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CampaignBidModifierService/MutateCampaignBidModifiers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignBidModifierService_MutateCampaignBidModifiers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CampaignBidModifierService/MutateCampaignBidModifiers",
	}
...
var _CampaignBidModifierService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/campaign_bid_modifier_service.proto",
}
