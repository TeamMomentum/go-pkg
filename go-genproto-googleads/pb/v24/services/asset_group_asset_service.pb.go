...
func (x *MutateAssetGroupAssetsRequest) Reset() {
	*x = MutateAssetGroupAssetsRequest{}
	mi := &file_google_ads_googleads_v24_services_asset_group_asset_service_proto_msgTypes[0]
...
func (*MutateAssetGroupAssetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetGroupAssetOperation) Reset() {
	*x = AssetGroupAssetOperation{}
	mi := &file_google_ads_googleads_v24_services_asset_group_asset_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AssetGroupAssetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAssetGroupAssetsResponse) Reset() {
	*x = MutateAssetGroupAssetsResponse{}
	mi := &file_google_ads_googleads_v24_services_asset_group_asset_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAssetGroupAssetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetGroupAssetResult) Reset() {
	*x = MutateAssetGroupAssetResult{}
	mi := &file_google_ads_googleads_v24_services_asset_group_asset_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAssetGroupAssetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_asset_group_asset_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDescData = file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_asset_group_asset_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_asset_group_asset_service_proto_goTypes = []any{
	(*MutateAssetGroupAssetsRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateAssetGroupAssetsRequest
	(*AssetGroupAssetOperation)(nil),       // 1: google.ads.googleads.v24.services.AssetGroupAssetOperation
	(*MutateAssetGroupAssetsResponse)(nil), // 2: google.ads.googleads.v24.services.MutateAssetGroupAssetsResponse
	(*MutateAssetGroupAssetResult)(nil),    // 3: google.ads.googleads.v24.services.MutateAssetGroupAssetResult
	(*fieldmaskpb.FieldMask)(nil),          // 4: google.protobuf.FieldMask
	(*resources.AssetGroupAsset)(nil),      // 5: google.ads.googleads.v24.resources.AssetGroupAsset
	(*status.Status)(nil),                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_asset_group_asset_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateAssetGroupAssetsRequest.operations:type_name -> google.ads.googleads.v24.services.AssetGroupAssetOperation
	4, // 1: google.ads.googleads.v24.services.AssetGroupAssetOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.AssetGroupAssetOperation.create:type_name -> google.ads.googleads.v24.resources.AssetGroupAsset
	5, // 3: google.ads.googleads.v24.services.AssetGroupAssetOperation.update:type_name -> google.ads.googleads.v24.resources.AssetGroupAsset
	3, // 4: google.ads.googleads.v24.services.MutateAssetGroupAssetsResponse.results:type_name -> google.ads.googleads.v24.services.MutateAssetGroupAssetResult
	6, // 5: google.ads.googleads.v24.services.MutateAssetGroupAssetsResponse.partial_failure_error:type_name -> google.rpc.Status
	0, // 6: google.ads.googleads.v24.services.AssetGroupAssetService.MutateAssetGroupAssets:input_type -> google.ads.googleads.v24.services.MutateAssetGroupAssetsRequest
	2, // 7: google.ads.googleads.v24.services.AssetGroupAssetService.MutateAssetGroupAssets:output_type -> google.ads.googleads.v24.services.MutateAssetGroupAssetsResponse
...
func init() { file_google_ads_googleads_v24_services_asset_group_asset_service_proto_init() }
func file_google_ads_googleads_v24_services_asset_group_asset_service_proto_init() {
	if File_google_ads_googleads_v24_services_asset_group_asset_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_asset_group_asset_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_asset_group_asset_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_asset_group_asset_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_asset_group_asset_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_asset_group_asset_service_proto = out.File
	file_google_ads_googleads_v24_services_asset_group_asset_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_asset_group_asset_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_asset_group_asset_service_proto_depIdxs = nil
}
...
func (c *assetGroupAssetServiceClient) MutateAssetGroupAssets(ctx context.Context, in *MutateAssetGroupAssetsRequest, opts ...grpc.CallOption) (*MutateAssetGroupAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AssetGroupAssetService/MutateAssetGroupAssets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AssetGroupAssetService_MutateAssetGroupAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AssetGroupAssetService/MutateAssetGroupAssets",
	}
...
var _AssetGroupAssetService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/asset_group_asset_service.proto",
}
