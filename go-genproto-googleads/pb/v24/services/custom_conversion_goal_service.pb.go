...
func (x *MutateCustomConversionGoalsRequest) Reset() {
	*x = MutateCustomConversionGoalsRequest{}
	mi := &file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_msgTypes[0]
...
func (*MutateCustomConversionGoalsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomConversionGoalOperation) Reset() {
	*x = CustomConversionGoalOperation{}
	mi := &file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomConversionGoalOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomConversionGoalsResponse) Reset() {
	*x = MutateCustomConversionGoalsResponse{}
	mi := &file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomConversionGoalsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomConversionGoalResult) Reset() {
	*x = MutateCustomConversionGoalResult{}
	mi := &file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomConversionGoalResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_custom_conversion_goal_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDesc = []byte{
	...
	0x2a, 0x22, 0x3b, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
...
var (
	file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDescData = file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_goTypes = []any{
	(*MutateCustomConversionGoalsRequest)(nil),             // 0: google.ads.googleads.v24.services.MutateCustomConversionGoalsRequest
	(*CustomConversionGoalOperation)(nil),                  // 1: google.ads.googleads.v24.services.CustomConversionGoalOperation
	(*MutateCustomConversionGoalsResponse)(nil),            // 2: google.ads.googleads.v24.services.MutateCustomConversionGoalsResponse
	(*MutateCustomConversionGoalResult)(nil),               // 3: google.ads.googleads.v24.services.MutateCustomConversionGoalResult
	...
	(*resources.CustomConversionGoal)(nil),                 // 6: google.ads.googleads.v24.resources.CustomConversionGoal
}
var file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCustomConversionGoalsRequest.operations:type_name -> google.ads.googleads.v24.services.CustomConversionGoalOperation
	4, // 1: google.ads.googleads.v24.services.MutateCustomConversionGoalsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.CustomConversionGoalOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.CustomConversionGoalOperation.create:type_name -> google.ads.googleads.v24.resources.CustomConversionGoal
	6, // 4: google.ads.googleads.v24.services.CustomConversionGoalOperation.update:type_name -> google.ads.googleads.v24.resources.CustomConversionGoal
	3, // 5: google.ads.googleads.v24.services.MutateCustomConversionGoalsResponse.results:type_name -> google.ads.googleads.v24.services.MutateCustomConversionGoalResult
	6, // 6: google.ads.googleads.v24.services.MutateCustomConversionGoalResult.custom_conversion_goal:type_name -> google.ads.googleads.v24.resources.CustomConversionGoal
	0, // 7: google.ads.googleads.v24.services.CustomConversionGoalService.MutateCustomConversionGoals:input_type -> google.ads.googleads.v24.services.MutateCustomConversionGoalsRequest
	2, // 8: google.ads.googleads.v24.services.CustomConversionGoalService.MutateCustomConversionGoals:output_type -> google.ads.googleads.v24.services.MutateCustomConversionGoalsResponse
...
func init() { file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_init() }
func file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_init() {
	if File_google_ads_googleads_v24_services_custom_conversion_goal_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_custom_conversion_goal_service_proto = out.File
	file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_custom_conversion_goal_service_proto_depIdxs = nil
}
...
func (c *customConversionGoalServiceClient) MutateCustomConversionGoals(ctx context.Context, in *MutateCustomConversionGoalsRequest, opts ...grpc.CallOption) (*MutateCustomConversionGoalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomConversionGoalService/MutateCustomConversionGoals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomConversionGoalService_MutateCustomConversionGoals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomConversionGoalService/MutateCustomConversionGoals",
	}
...
var _CustomConversionGoalService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/custom_conversion_goal_service.proto",
}
