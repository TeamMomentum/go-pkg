...
func (x *MutateUserListsRequest) Reset() {
	*x = MutateUserListsRequest{}
	mi := &file_google_ads_googleads_v24_services_user_list_service_proto_msgTypes[0]
...
func (*MutateUserListsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_user_list_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *UserListOperation) Reset() {
	*x = UserListOperation{}
	mi := &file_google_ads_googleads_v24_services_user_list_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserListOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_user_list_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateUserListsResponse) Reset() {
	*x = MutateUserListsResponse{}
	mi := &file_google_ads_googleads_v24_services_user_list_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateUserListsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_user_list_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateUserListResult) Reset() {
	*x = MutateUserListResult{}
	mi := &file_google_ads_googleads_v24_services_user_list_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateUserListResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_user_list_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_user_list_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_user_list_service_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x1a, 0x32,
	...
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x14, 0x55,
...
var (
	file_google_ads_googleads_v24_services_user_list_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_user_list_service_proto_rawDescData = file_google_ads_googleads_v24_services_user_list_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_user_list_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_user_list_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_user_list_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_user_list_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_user_list_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_user_list_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_user_list_service_proto_goTypes = []any{
	(*MutateUserListsRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateUserListsRequest
	(*UserListOperation)(nil),       // 1: google.ads.googleads.v24.services.UserListOperation
	(*MutateUserListsResponse)(nil), // 2: google.ads.googleads.v24.services.MutateUserListsResponse
	(*MutateUserListResult)(nil),    // 3: google.ads.googleads.v24.services.MutateUserListResult
	(*fieldmaskpb.FieldMask)(nil),   // 4: google.protobuf.FieldMask
	(*resources.UserList)(nil),      // 5: google.ads.googleads.v24.resources.UserList
	(*status.Status)(nil),           // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_user_list_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateUserListsRequest.operations:type_name -> google.ads.googleads.v24.services.UserListOperation
	4, // 1: google.ads.googleads.v24.services.UserListOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.UserListOperation.create:type_name -> google.ads.googleads.v24.resources.UserList
	5, // 3: google.ads.googleads.v24.services.UserListOperation.update:type_name -> google.ads.googleads.v24.resources.UserList
	6, // 4: google.ads.googleads.v24.services.MutateUserListsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 5: google.ads.googleads.v24.services.MutateUserListsResponse.results:type_name -> google.ads.googleads.v24.services.MutateUserListResult
	0, // 6: google.ads.googleads.v24.services.UserListService.MutateUserLists:input_type -> google.ads.googleads.v24.services.MutateUserListsRequest
	2, // 7: google.ads.googleads.v24.services.UserListService.MutateUserLists:output_type -> google.ads.googleads.v24.services.MutateUserListsResponse
...
func init() { file_google_ads_googleads_v24_services_user_list_service_proto_init() }
func file_google_ads_googleads_v24_services_user_list_service_proto_init() {
	if File_google_ads_googleads_v24_services_user_list_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_user_list_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_user_list_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_user_list_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_user_list_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_user_list_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_user_list_service_proto = out.File
	file_google_ads_googleads_v24_services_user_list_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_user_list_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_user_list_service_proto_depIdxs = nil
}
...
func (c *userListServiceClient) MutateUserLists(ctx context.Context, in *MutateUserListsRequest, opts ...grpc.CallOption) (*MutateUserListsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.UserListService/MutateUserLists", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserListService_MutateUserLists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.UserListService/MutateUserLists",
	}
...
var _UserListService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/user_list_service.proto",
}
