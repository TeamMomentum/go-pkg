...
func (x *MutateConversionValueRulesRequest) Reset() {
	*x = MutateConversionValueRulesRequest{}
	mi := &file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_msgTypes[0]
...
func (*MutateConversionValueRulesRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConversionValueRuleOperation) Reset() {
	*x = ConversionValueRuleOperation{}
	mi := &file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionValueRuleOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateConversionValueRulesResponse) Reset() {
	*x = MutateConversionValueRulesResponse{}
	mi := &file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateConversionValueRulesResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateConversionValueRuleResult) Reset() {
	*x = MutateConversionValueRuleResult{}
	mi := &file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateConversionValueRuleResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_conversion_value_rule_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDescData = file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_goTypes = []any{
	(*MutateConversionValueRulesRequest)(nil),              // 0: google.ads.googleads.v24.services.MutateConversionValueRulesRequest
	(*ConversionValueRuleOperation)(nil),                   // 1: google.ads.googleads.v24.services.ConversionValueRuleOperation
	(*MutateConversionValueRulesResponse)(nil),             // 2: google.ads.googleads.v24.services.MutateConversionValueRulesResponse
	(*MutateConversionValueRuleResult)(nil),                // 3: google.ads.googleads.v24.services.MutateConversionValueRuleResult
	...
	(*resources.ConversionValueRule)(nil),                  // 6: google.ads.googleads.v24.resources.ConversionValueRule
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateConversionValueRulesRequest.operations:type_name -> google.ads.googleads.v24.services.ConversionValueRuleOperation
	4, // 1: google.ads.googleads.v24.services.MutateConversionValueRulesRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.ConversionValueRuleOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.ConversionValueRuleOperation.create:type_name -> google.ads.googleads.v24.resources.ConversionValueRule
	6, // 4: google.ads.googleads.v24.services.ConversionValueRuleOperation.update:type_name -> google.ads.googleads.v24.resources.ConversionValueRule
	3, // 5: google.ads.googleads.v24.services.MutateConversionValueRulesResponse.results:type_name -> google.ads.googleads.v24.services.MutateConversionValueRuleResult
	7, // 6: google.ads.googleads.v24.services.MutateConversionValueRulesResponse.partial_failure_error:type_name -> google.rpc.Status
	6, // 7: google.ads.googleads.v24.services.MutateConversionValueRuleResult.conversion_value_rule:type_name -> google.ads.googleads.v24.resources.ConversionValueRule
	0, // 8: google.ads.googleads.v24.services.ConversionValueRuleService.MutateConversionValueRules:input_type -> google.ads.googleads.v24.services.MutateConversionValueRulesRequest
	2, // 9: google.ads.googleads.v24.services.ConversionValueRuleService.MutateConversionValueRules:output_type -> google.ads.googleads.v24.services.MutateConversionValueRulesResponse
...
func init() { file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_init() }
func file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_init() {
	if File_google_ads_googleads_v24_services_conversion_value_rule_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_conversion_value_rule_service_proto = out.File
	file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_conversion_value_rule_service_proto_depIdxs = nil
}
...
func (c *conversionValueRuleServiceClient) MutateConversionValueRules(ctx context.Context, in *MutateConversionValueRulesRequest, opts ...grpc.CallOption) (*MutateConversionValueRulesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.ConversionValueRuleService/MutateConversionValueRules", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConversionValueRuleService_MutateConversionValueRules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.ConversionValueRuleService/MutateConversionValueRules",
	}
...
var _ConversionValueRuleService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/conversion_value_rule_service.proto",
}
