...
func (x *MutateConversionActionsRequest) Reset() {
	*x = MutateConversionActionsRequest{}
	mi := &file_google_ads_googleads_v24_services_conversion_action_service_proto_msgTypes[0]
...
func (*MutateConversionActionsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *ConversionActionOperation) Reset() {
	*x = ConversionActionOperation{}
	mi := &file_google_ads_googleads_v24_services_conversion_action_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConversionActionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateConversionActionsResponse) Reset() {
	*x = MutateConversionActionsResponse{}
	mi := &file_google_ads_googleads_v24_services_conversion_action_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateConversionActionsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateConversionActionResult) Reset() {
	*x = MutateConversionActionResult{}
	mi := &file_google_ads_googleads_v24_services_conversion_action_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateConversionActionResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_conversion_action_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDescData = file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_conversion_action_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_conversion_action_service_proto_goTypes = []any{
	(*MutateConversionActionsRequest)(nil),                 // 0: google.ads.googleads.v24.services.MutateConversionActionsRequest
	(*ConversionActionOperation)(nil),                      // 1: google.ads.googleads.v24.services.ConversionActionOperation
	(*MutateConversionActionsResponse)(nil),                // 2: google.ads.googleads.v24.services.MutateConversionActionsResponse
	(*MutateConversionActionResult)(nil),                   // 3: google.ads.googleads.v24.services.MutateConversionActionResult
	...
	(*resources.ConversionAction)(nil),                     // 6: google.ads.googleads.v24.resources.ConversionAction
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_conversion_action_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateConversionActionsRequest.operations:type_name -> google.ads.googleads.v24.services.ConversionActionOperation
	4, // 1: google.ads.googleads.v24.services.MutateConversionActionsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.ConversionActionOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.ConversionActionOperation.create:type_name -> google.ads.googleads.v24.resources.ConversionAction
	6, // 4: google.ads.googleads.v24.services.ConversionActionOperation.update:type_name -> google.ads.googleads.v24.resources.ConversionAction
	7, // 5: google.ads.googleads.v24.services.MutateConversionActionsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateConversionActionsResponse.results:type_name -> google.ads.googleads.v24.services.MutateConversionActionResult
	6, // 7: google.ads.googleads.v24.services.MutateConversionActionResult.conversion_action:type_name -> google.ads.googleads.v24.resources.ConversionAction
	0, // 8: google.ads.googleads.v24.services.ConversionActionService.MutateConversionActions:input_type -> google.ads.googleads.v24.services.MutateConversionActionsRequest
	2, // 9: google.ads.googleads.v24.services.ConversionActionService.MutateConversionActions:output_type -> google.ads.googleads.v24.services.MutateConversionActionsResponse
...
func init() { file_google_ads_googleads_v24_services_conversion_action_service_proto_init() }
func file_google_ads_googleads_v24_services_conversion_action_service_proto_init() {
	if File_google_ads_googleads_v24_services_conversion_action_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_conversion_action_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_conversion_action_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_conversion_action_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_conversion_action_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_conversion_action_service_proto = out.File
	file_google_ads_googleads_v24_services_conversion_action_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_conversion_action_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_conversion_action_service_proto_depIdxs = nil
}
...
func (c *conversionActionServiceClient) MutateConversionActions(ctx context.Context, in *MutateConversionActionsRequest, opts ...grpc.CallOption) (*MutateConversionActionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.ConversionActionService/MutateConversionActions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConversionActionService_MutateConversionActions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.ConversionActionService/MutateConversionActions",
	}
...
var _ConversionActionService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/conversion_action_service.proto",
}
