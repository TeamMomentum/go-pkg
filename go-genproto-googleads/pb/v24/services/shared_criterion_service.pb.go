...
func (x *MutateSharedCriteriaRequest) Reset() {
	*x = MutateSharedCriteriaRequest{}
	mi := &file_google_ads_googleads_v24_services_shared_criterion_service_proto_msgTypes[0]
...
func (*MutateSharedCriteriaRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SharedCriterionOperation) Reset() {
	*x = SharedCriterionOperation{}
	mi := &file_google_ads_googleads_v24_services_shared_criterion_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SharedCriterionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateSharedCriteriaResponse) Reset() {
	*x = MutateSharedCriteriaResponse{}
	mi := &file_google_ads_googleads_v24_services_shared_criterion_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateSharedCriteriaResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateSharedCriterionResult) Reset() {
	*x = MutateSharedCriterionResult{}
	mi := &file_google_ads_googleads_v24_services_shared_criterion_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateSharedCriterionResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_shared_criterion_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDesc = []byte{
	...
	0x2a, 0x22, 0x34, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
...
var (
	file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDescData = file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_shared_criterion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_shared_criterion_service_proto_goTypes = []any{
	(*MutateSharedCriteriaRequest)(nil),                    // 0: google.ads.googleads.v24.services.MutateSharedCriteriaRequest
	(*SharedCriterionOperation)(nil),                       // 1: google.ads.googleads.v24.services.SharedCriterionOperation
	(*MutateSharedCriteriaResponse)(nil),                   // 2: google.ads.googleads.v24.services.MutateSharedCriteriaResponse
	(*MutateSharedCriterionResult)(nil),                    // 3: google.ads.googleads.v24.services.MutateSharedCriterionResult
	...
	(*resources.SharedCriterion)(nil),                      // 5: google.ads.googleads.v24.resources.SharedCriterion
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_shared_criterion_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateSharedCriteriaRequest.operations:type_name -> google.ads.googleads.v24.services.SharedCriterionOperation
	4, // 1: google.ads.googleads.v24.services.MutateSharedCriteriaRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.SharedCriterionOperation.create:type_name -> google.ads.googleads.v24.resources.SharedCriterion
	6, // 3: google.ads.googleads.v24.services.MutateSharedCriteriaResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 4: google.ads.googleads.v24.services.MutateSharedCriteriaResponse.results:type_name -> google.ads.googleads.v24.services.MutateSharedCriterionResult
	5, // 5: google.ads.googleads.v24.services.MutateSharedCriterionResult.shared_criterion:type_name -> google.ads.googleads.v24.resources.SharedCriterion
	0, // 6: google.ads.googleads.v24.services.SharedCriterionService.MutateSharedCriteria:input_type -> google.ads.googleads.v24.services.MutateSharedCriteriaRequest
	2, // 7: google.ads.googleads.v24.services.SharedCriterionService.MutateSharedCriteria:output_type -> google.ads.googleads.v24.services.MutateSharedCriteriaResponse
...
func init() { file_google_ads_googleads_v24_services_shared_criterion_service_proto_init() }
func file_google_ads_googleads_v24_services_shared_criterion_service_proto_init() {
	if File_google_ads_googleads_v24_services_shared_criterion_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_shared_criterion_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_shared_criterion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_shared_criterion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_shared_criterion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_shared_criterion_service_proto = out.File
	file_google_ads_googleads_v24_services_shared_criterion_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_shared_criterion_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_shared_criterion_service_proto_depIdxs = nil
}
...
func (c *sharedCriterionServiceClient) MutateSharedCriteria(ctx context.Context, in *MutateSharedCriteriaRequest, opts ...grpc.CallOption) (*MutateSharedCriteriaResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.SharedCriterionService/MutateSharedCriteria", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SharedCriterionService_MutateSharedCriteria_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.SharedCriterionService/MutateSharedCriteria",
	}
...
var _SharedCriterionService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/shared_criterion_service.proto",
}
