...
type GenerateTextRequest struct {
	...
	AssetFieldTypes []enums.AssetFieldTypeEnum_AssetFieldType `protobuf:"varint,2,rep,packed,name=asset_field_types,json=assetFieldTypes,proto3,enum=google.ads.googleads.v24.enums.AssetFieldTypeEnum_AssetFieldType" json:"asset_field_types,omitempty"`
...
func (x *GenerateTextRequest) Reset() {
	*x = GenerateTextRequest{}
	mi := &file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[0]
...
func (*GenerateTextRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP(), []int{0}
}
...
type GenerateTextRequest_AdvertisingChannelType struct {
	...
	AdvertisingChannelType enums.AdvertisingChannelTypeEnum_AdvertisingChannelType `protobuf:"varint,4,opt,name=advertising_channel_type,json=advertisingChannelType,proto3,enum=google.ads.googleads.v24.enums.AdvertisingChannelTypeEnum_AdvertisingChannelType,oneof"`
}
...
func (x *GenerateTextResponse) Reset() {
	*x = GenerateTextResponse{}
	mi := &file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateTextResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP(), []int{1}
}
...
type GeneratedText struct {
	...
	AssetFieldType enums.AssetFieldTypeEnum_AssetFieldType `protobuf:"varint,2,opt,name=asset_field_type,json=assetFieldType,proto3,enum=google.ads.googleads.v24.enums.AssetFieldTypeEnum_AssetFieldType" json:"asset_field_type,omitempty"`
}

func (x *GeneratedText) Reset() {
	*x = GeneratedText{}
	mi := &file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GeneratedText) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP(), []int{2}
}
...
type GenerateImagesRequest struct {
	...
	AssetFieldTypes []enums.AssetFieldTypeEnum_AssetFieldType `protobuf:"varint,4,rep,packed,name=asset_field_types,json=assetFieldTypes,proto3,enum=google.ads.googleads.v24.enums.AssetFieldTypeEnum_AssetFieldType" json:"asset_field_types,omitempty"`
...
func (x *GenerateImagesRequest) Reset() {
	*x = GenerateImagesRequest{}
	mi := &file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateImagesRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP(), []int{3}
}
...
type GenerateImagesRequest_AdvertisingChannelType struct {
	...
	AdvertisingChannelType enums.AdvertisingChannelTypeEnum_AdvertisingChannelType `protobuf:"varint,2,opt,name=advertising_channel_type,json=advertisingChannelType,proto3,enum=google.ads.googleads.v24.enums.AdvertisingChannelTypeEnum_AdvertisingChannelType,oneof"`
}
...
func (x *FinalUrlImageGenerationInput) Reset() {
	*x = FinalUrlImageGenerationInput{}
	mi := &file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FinalUrlImageGenerationInput) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP(), []int{4}
}
...
func (x *FreeformImageGenerationInput) Reset() {
	*x = FreeformImageGenerationInput{}
	mi := &file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FreeformImageGenerationInput) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP(), []int{5}
}
...
func (x *ProductRecontextGenerationImageInput) Reset() {
	*x = ProductRecontextGenerationImageInput{}
	mi := &file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ProductRecontextGenerationImageInput) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP(), []int{6}
}
...
func (x *GenerateImagesResponse) Reset() {
	*x = GenerateImagesResponse{}
	mi := &file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GenerateImagesResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP(), []int{7}
}
...
func (x *SourceImage) Reset() {
	*x = SourceImage{}
	mi := &file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SourceImage) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP(), []int{8}
}
...
func (x *GeneratedImage) Reset() {
	*x = GeneratedImage{}
	mi := &file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GeneratedImage) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP(), []int{9}
}
...
func (x *AssetGenerationExistingContext) Reset() {
	*x = AssetGenerationExistingContext{}
	mi := &file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AssetGenerationExistingContext) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP(), []int{10}
}
...
var File_google_ads_googleads_v24_services_asset_generation_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x46, 0x69,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x64, 0x76, 0x65, 0x72, 0x74, 0x69,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x46, 0x69, 0x6e, 0x61,
	...
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1b,
...
var (
	file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescData = file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_google_ads_googleads_v24_services_asset_generation_service_proto_goTypes = []any{
	(*GenerateTextRequest)(nil),                                  // 0: google.ads.googleads.v24.services.GenerateTextRequest
	(*GenerateTextResponse)(nil),                                 // 1: google.ads.googleads.v24.services.GenerateTextResponse
	(*GeneratedText)(nil),                                        // 2: google.ads.googleads.v24.services.GeneratedText
	(*GenerateImagesRequest)(nil),                                // 3: google.ads.googleads.v24.services.GenerateImagesRequest
	(*FinalUrlImageGenerationInput)(nil),                         // 4: google.ads.googleads.v24.services.FinalUrlImageGenerationInput
	(*FreeformImageGenerationInput)(nil),                         // 5: google.ads.googleads.v24.services.FreeformImageGenerationInput
	(*ProductRecontextGenerationImageInput)(nil),                 // 6: google.ads.googleads.v24.services.ProductRecontextGenerationImageInput
	(*GenerateImagesResponse)(nil),                               // 7: google.ads.googleads.v24.services.GenerateImagesResponse
	(*SourceImage)(nil),                                          // 8: google.ads.googleads.v24.services.SourceImage
	(*GeneratedImage)(nil),                                       // 9: google.ads.googleads.v24.services.GeneratedImage
	(*AssetGenerationExistingContext)(nil),                       // 10: google.ads.googleads.v24.services.AssetGenerationExistingContext
	(enums.AssetFieldTypeEnum_AssetFieldType)(0),                 // 11: google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType
	(enums.AdvertisingChannelTypeEnum_AdvertisingChannelType)(0), // 12: google.ads.googleads.v24.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType
}
var file_google_ads_googleads_v24_services_asset_generation_service_proto_depIdxs = []int32{
	11, // 0: google.ads.googleads.v24.services.GenerateTextRequest.asset_field_types:type_name -> google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType
	10, // 1: google.ads.googleads.v24.services.GenerateTextRequest.existing_generation_context:type_name -> google.ads.googleads.v24.services.AssetGenerationExistingContext
	12, // 2: google.ads.googleads.v24.services.GenerateTextRequest.advertising_channel_type:type_name -> google.ads.googleads.v24.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType
	2,  // 3: google.ads.googleads.v24.services.GenerateTextResponse.generated_text:type_name -> google.ads.googleads.v24.services.GeneratedText
	11, // 4: google.ads.googleads.v24.services.GeneratedText.asset_field_type:type_name -> google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType
	11, // 5: google.ads.googleads.v24.services.GenerateImagesRequest.asset_field_types:type_name -> google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType
	12, // 6: google.ads.googleads.v24.services.GenerateImagesRequest.advertising_channel_type:type_name -> google.ads.googleads.v24.enums.AdvertisingChannelTypeEnum.AdvertisingChannelType
	4,  // 7: google.ads.googleads.v24.services.GenerateImagesRequest.final_url_generation:type_name -> google.ads.googleads.v24.services.FinalUrlImageGenerationInput
	5,  // 8: google.ads.googleads.v24.services.GenerateImagesRequest.freeform_generation:type_name -> google.ads.googleads.v24.services.FreeformImageGenerationInput
	6,  // 9: google.ads.googleads.v24.services.GenerateImagesRequest.product_recontext_generation:type_name -> google.ads.googleads.v24.services.ProductRecontextGenerationImageInput
	8,  // 10: google.ads.googleads.v24.services.ProductRecontextGenerationImageInput.source_images:type_name -> google.ads.googleads.v24.services.SourceImage
	9,  // 11: google.ads.googleads.v24.services.GenerateImagesResponse.generated_images:type_name -> google.ads.googleads.v24.services.GeneratedImage
	11, // 12: google.ads.googleads.v24.services.GeneratedImage.asset_field_type:type_name -> google.ads.googleads.v24.enums.AssetFieldTypeEnum.AssetFieldType
	0,  // 13: google.ads.googleads.v24.services.AssetGenerationService.GenerateText:input_type -> google.ads.googleads.v24.services.GenerateTextRequest
	3,  // 14: google.ads.googleads.v24.services.AssetGenerationService.GenerateImages:input_type -> google.ads.googleads.v24.services.GenerateImagesRequest
	1,  // 15: google.ads.googleads.v24.services.AssetGenerationService.GenerateText:output_type -> google.ads.googleads.v24.services.GenerateTextResponse
	7,  // 16: google.ads.googleads.v24.services.AssetGenerationService.GenerateImages:output_type -> google.ads.googleads.v24.services.GenerateImagesResponse
...
func init() { file_google_ads_googleads_v24_services_asset_generation_service_proto_init() }
func file_google_ads_googleads_v24_services_asset_generation_service_proto_init() {
	if File_google_ads_googleads_v24_services_asset_generation_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[0].OneofWrappers = []any{
		(*GenerateTextRequest_ExistingGenerationContext)(nil),
		(*GenerateTextRequest_AdvertisingChannelType)(nil),
	}
	file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[3].OneofWrappers = []any{
	...
	file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[8].OneofWrappers = []any{
		(*SourceImage_ImageData)(nil),
	}
	file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes[10].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_asset_generation_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_asset_generation_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_asset_generation_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_asset_generation_service_proto = out.File
	file_google_ads_googleads_v24_services_asset_generation_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_asset_generation_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_asset_generation_service_proto_depIdxs = nil
}
...
func (c *assetGenerationServiceClient) GenerateText(ctx context.Context, in *GenerateTextRequest, opts ...grpc.CallOption) (*GenerateTextResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AssetGenerationService/GenerateText", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assetGenerationServiceClient) GenerateImages(ctx context.Context, in *GenerateImagesRequest, opts ...grpc.CallOption) (*GenerateImagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AssetGenerationService/GenerateImages", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AssetGenerationService_GenerateText_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AssetGenerationService/GenerateText",
	}
...
func _AssetGenerationService_GenerateImages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AssetGenerationService/GenerateImages",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _AssetGenerationService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/asset_generation_service.proto",
}
