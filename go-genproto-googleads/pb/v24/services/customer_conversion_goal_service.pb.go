...
func (x *MutateCustomerConversionGoalsRequest) Reset() {
	*x = MutateCustomerConversionGoalsRequest{}
	mi := &file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_msgTypes[0]
...
func (*MutateCustomerConversionGoalsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerConversionGoalOperation) Reset() {
	*x = CustomerConversionGoalOperation{}
	mi := &file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerConversionGoalOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerConversionGoalsResponse) Reset() {
	*x = MutateCustomerConversionGoalsResponse{}
	mi := &file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerConversionGoalsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerConversionGoalResult) Reset() {
	*x = MutateCustomerConversionGoalResult{}
	mi := &file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerConversionGoalResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_customer_conversion_goal_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x22, 0x43,
	0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x43, 0x6f, 0x6e, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f,
...
var (
	file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDescData = file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_goTypes = []any{
	(*MutateCustomerConversionGoalsRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateCustomerConversionGoalsRequest
	(*CustomerConversionGoalOperation)(nil),       // 1: google.ads.googleads.v24.services.CustomerConversionGoalOperation
	(*MutateCustomerConversionGoalsResponse)(nil), // 2: google.ads.googleads.v24.services.MutateCustomerConversionGoalsResponse
	(*MutateCustomerConversionGoalResult)(nil),    // 3: google.ads.googleads.v24.services.MutateCustomerConversionGoalResult
	(*fieldmaskpb.FieldMask)(nil),                 // 4: google.protobuf.FieldMask
	(*resources.CustomerConversionGoal)(nil),      // 5: google.ads.googleads.v24.resources.CustomerConversionGoal
}
var file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCustomerConversionGoalsRequest.operations:type_name -> google.ads.googleads.v24.services.CustomerConversionGoalOperation
	4, // 1: google.ads.googleads.v24.services.CustomerConversionGoalOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.CustomerConversionGoalOperation.update:type_name -> google.ads.googleads.v24.resources.CustomerConversionGoal
	3, // 3: google.ads.googleads.v24.services.MutateCustomerConversionGoalsResponse.results:type_name -> google.ads.googleads.v24.services.MutateCustomerConversionGoalResult
	0, // 4: google.ads.googleads.v24.services.CustomerConversionGoalService.MutateCustomerConversionGoals:input_type -> google.ads.googleads.v24.services.MutateCustomerConversionGoalsRequest
	2, // 5: google.ads.googleads.v24.services.CustomerConversionGoalService.MutateCustomerConversionGoals:output_type -> google.ads.googleads.v24.services.MutateCustomerConversionGoalsResponse
...
func init() { file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_init() }
func file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_init() {
	if File_google_ads_googleads_v24_services_customer_conversion_goal_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_customer_conversion_goal_service_proto = out.File
	file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_customer_conversion_goal_service_proto_depIdxs = nil
}
...
func (c *customerConversionGoalServiceClient) MutateCustomerConversionGoals(ctx context.Context, in *MutateCustomerConversionGoalsRequest, opts ...grpc.CallOption) (*MutateCustomerConversionGoalsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomerConversionGoalService/MutateCustomerConversionGoals", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomerConversionGoalService_MutateCustomerConversionGoals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomerConversionGoalService/MutateCustomerConversionGoals",
	}
...
var _CustomerConversionGoalService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/customer_conversion_goal_service.proto",
}
