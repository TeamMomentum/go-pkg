...
func (x *MutateAssetGroupListingGroupFiltersRequest) Reset() {
	*x = MutateAssetGroupListingGroupFiltersRequest{}
	mi := &file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_msgTypes[0]
...
func (*MutateAssetGroupListingGroupFiltersRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *AssetGroupListingGroupFilterOperation) Reset() {
	*x = AssetGroupListingGroupFilterOperation{}
	mi := &file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AssetGroupListingGroupFilterOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateAssetGroupListingGroupFiltersResponse) Reset() {
	*x = MutateAssetGroupListingGroupFiltersResponse{}
	mi := &file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAssetGroupListingGroupFiltersResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateAssetGroupListingGroupFilterResult) Reset() {
	*x = MutateAssetGroupListingGroupFilterResult{}
	mi := &file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateAssetGroupListingGroupFilterResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDesc = []byte{
	...
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x22, 0x43, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
...
var (
	file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDescData = file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_goTypes = []any{
	(*MutateAssetGroupListingGroupFiltersRequest)(nil),     // 0: google.ads.googleads.v24.services.MutateAssetGroupListingGroupFiltersRequest
	(*AssetGroupListingGroupFilterOperation)(nil),          // 1: google.ads.googleads.v24.services.AssetGroupListingGroupFilterOperation
	(*MutateAssetGroupListingGroupFiltersResponse)(nil),    // 2: google.ads.googleads.v24.services.MutateAssetGroupListingGroupFiltersResponse
	(*MutateAssetGroupListingGroupFilterResult)(nil),       // 3: google.ads.googleads.v24.services.MutateAssetGroupListingGroupFilterResult
	...
	(*resources.AssetGroupListingGroupFilter)(nil),         // 6: google.ads.googleads.v24.resources.AssetGroupListingGroupFilter
}
var file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateAssetGroupListingGroupFiltersRequest.operations:type_name -> google.ads.googleads.v24.services.AssetGroupListingGroupFilterOperation
	4, // 1: google.ads.googleads.v24.services.MutateAssetGroupListingGroupFiltersRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.AssetGroupListingGroupFilterOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.AssetGroupListingGroupFilterOperation.create:type_name -> google.ads.googleads.v24.resources.AssetGroupListingGroupFilter
	6, // 4: google.ads.googleads.v24.services.AssetGroupListingGroupFilterOperation.update:type_name -> google.ads.googleads.v24.resources.AssetGroupListingGroupFilter
	3, // 5: google.ads.googleads.v24.services.MutateAssetGroupListingGroupFiltersResponse.results:type_name -> google.ads.googleads.v24.services.MutateAssetGroupListingGroupFilterResult
	6, // 6: google.ads.googleads.v24.services.MutateAssetGroupListingGroupFilterResult.asset_group_listing_group_filter:type_name -> google.ads.googleads.v24.resources.AssetGroupListingGroupFilter
	0, // 7: google.ads.googleads.v24.services.AssetGroupListingGroupFilterService.MutateAssetGroupListingGroupFilters:input_type -> google.ads.googleads.v24.services.MutateAssetGroupListingGroupFiltersRequest
	2, // 8: google.ads.googleads.v24.services.AssetGroupListingGroupFilterService.MutateAssetGroupListingGroupFilters:output_type -> google.ads.googleads.v24.services.MutateAssetGroupListingGroupFiltersResponse
...
func file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_init() {
	if File_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto = out.File
	file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_asset_group_listing_group_filter_service_proto_depIdxs = nil
}
...
func (c *assetGroupListingGroupFilterServiceClient) MutateAssetGroupListingGroupFilters(ctx context.Context, in *MutateAssetGroupListingGroupFiltersRequest, opts ...grpc.CallOption) (*MutateAssetGroupListingGroupFiltersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.AssetGroupListingGroupFilterService/MutateAssetGroupListingGroupFilters", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AssetGroupListingGroupFilterService_MutateAssetGroupListingGroupFilters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.AssetGroupListingGroupFilterService/MutateAssetGroupListingGroupFilters",
	}
...
var _AssetGroupListingGroupFilterService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/asset_group_listing_group_filter_service.proto",
}
