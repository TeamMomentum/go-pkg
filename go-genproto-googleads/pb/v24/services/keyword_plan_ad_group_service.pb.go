...
func (x *MutateKeywordPlanAdGroupsRequest) Reset() {
	*x = MutateKeywordPlanAdGroupsRequest{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_msgTypes[0]
...
func (*MutateKeywordPlanAdGroupsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordPlanAdGroupOperation) Reset() {
	*x = KeywordPlanAdGroupOperation{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordPlanAdGroupOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateKeywordPlanAdGroupsResponse) Reset() {
	*x = MutateKeywordPlanAdGroupsResponse{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlanAdGroupsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateKeywordPlanAdGroupResult) Reset() {
	*x = MutateKeywordPlanAdGroupResult{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlanAdGroupResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x32, 0x34, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x6b,
	...
	0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x4b, 0x65, 0x79, 0x77,
	...
	0x39, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x1e, 0x4b, 0x65, 0x79,
...
var (
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDescData = file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_goTypes = []any{
	(*MutateKeywordPlanAdGroupsRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupsRequest
	(*KeywordPlanAdGroupOperation)(nil),       // 1: google.ads.googleads.v24.services.KeywordPlanAdGroupOperation
	(*MutateKeywordPlanAdGroupsResponse)(nil), // 2: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupsResponse
	(*MutateKeywordPlanAdGroupResult)(nil),    // 3: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupResult
	(*fieldmaskpb.FieldMask)(nil),             // 4: google.protobuf.FieldMask
	(*resources.KeywordPlanAdGroup)(nil),      // 5: google.ads.googleads.v24.resources.KeywordPlanAdGroup
	(*status.Status)(nil),                     // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupsRequest.operations:type_name -> google.ads.googleads.v24.services.KeywordPlanAdGroupOperation
	4, // 1: google.ads.googleads.v24.services.KeywordPlanAdGroupOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.KeywordPlanAdGroupOperation.create:type_name -> google.ads.googleads.v24.resources.KeywordPlanAdGroup
	5, // 3: google.ads.googleads.v24.services.KeywordPlanAdGroupOperation.update:type_name -> google.ads.googleads.v24.resources.KeywordPlanAdGroup
	6, // 4: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 5: google.ads.googleads.v24.services.MutateKeywordPlanAdGroupsResponse.results:type_name -> google.ads.googleads.v24.services.MutateKeywordPlanAdGroupResult
	0, // 6: google.ads.googleads.v24.services.KeywordPlanAdGroupService.MutateKeywordPlanAdGroups:input_type -> google.ads.googleads.v24.services.MutateKeywordPlanAdGroupsRequest
	2, // 7: google.ads.googleads.v24.services.KeywordPlanAdGroupService.MutateKeywordPlanAdGroups:output_type -> google.ads.googleads.v24.services.MutateKeywordPlanAdGroupsResponse
...
func init() { file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_init() }
func file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_init() {
	if File_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto = out.File
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_keyword_plan_ad_group_service_proto_depIdxs = nil
}
...
func (c *keywordPlanAdGroupServiceClient) MutateKeywordPlanAdGroups(ctx context.Context, in *MutateKeywordPlanAdGroupsRequest, opts ...grpc.CallOption) (*MutateKeywordPlanAdGroupsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _KeywordPlanAdGroupService_MutateKeywordPlanAdGroups_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.KeywordPlanAdGroupService/MutateKeywordPlanAdGroups",
	}
...
var _KeywordPlanAdGroupService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/keyword_plan_ad_group_service.proto",
}
