...
func (x *MutateCustomAudiencesRequest) Reset() {
	*x = MutateCustomAudiencesRequest{}
	mi := &file_google_ads_googleads_v24_services_custom_audience_service_proto_msgTypes[0]
...
func (*MutateCustomAudiencesRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomAudienceOperation) Reset() {
	*x = CustomAudienceOperation{}
	mi := &file_google_ads_googleads_v24_services_custom_audience_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomAudienceOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomAudiencesResponse) Reset() {
	*x = MutateCustomAudiencesResponse{}
	mi := &file_google_ads_googleads_v24_services_custom_audience_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomAudiencesResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomAudienceResult) Reset() {
	*x = MutateCustomAudienceResult{}
	mi := &file_google_ads_googleads_v24_services_custom_audience_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomAudienceResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_custom_audience_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDesc = []byte{
	...
	0x22, 0x35, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
...
var (
	file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDescData = file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_custom_audience_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_custom_audience_service_proto_goTypes = []any{
	(*MutateCustomAudiencesRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateCustomAudiencesRequest
	(*CustomAudienceOperation)(nil),       // 1: google.ads.googleads.v24.services.CustomAudienceOperation
	(*MutateCustomAudiencesResponse)(nil), // 2: google.ads.googleads.v24.services.MutateCustomAudiencesResponse
	(*MutateCustomAudienceResult)(nil),    // 3: google.ads.googleads.v24.services.MutateCustomAudienceResult
	(*fieldmaskpb.FieldMask)(nil),         // 4: google.protobuf.FieldMask
	(*resources.CustomAudience)(nil),      // 5: google.ads.googleads.v24.resources.CustomAudience
}
var file_google_ads_googleads_v24_services_custom_audience_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateCustomAudiencesRequest.operations:type_name -> google.ads.googleads.v24.services.CustomAudienceOperation
	4, // 1: google.ads.googleads.v24.services.CustomAudienceOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.CustomAudienceOperation.create:type_name -> google.ads.googleads.v24.resources.CustomAudience
	5, // 3: google.ads.googleads.v24.services.CustomAudienceOperation.update:type_name -> google.ads.googleads.v24.resources.CustomAudience
	3, // 4: google.ads.googleads.v24.services.MutateCustomAudiencesResponse.results:type_name -> google.ads.googleads.v24.services.MutateCustomAudienceResult
	0, // 5: google.ads.googleads.v24.services.CustomAudienceService.MutateCustomAudiences:input_type -> google.ads.googleads.v24.services.MutateCustomAudiencesRequest
	2, // 6: google.ads.googleads.v24.services.CustomAudienceService.MutateCustomAudiences:output_type -> google.ads.googleads.v24.services.MutateCustomAudiencesResponse
...
func init() { file_google_ads_googleads_v24_services_custom_audience_service_proto_init() }
func file_google_ads_googleads_v24_services_custom_audience_service_proto_init() {
	if File_google_ads_googleads_v24_services_custom_audience_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_custom_audience_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_custom_audience_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_custom_audience_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_custom_audience_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_custom_audience_service_proto = out.File
	file_google_ads_googleads_v24_services_custom_audience_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_custom_audience_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_custom_audience_service_proto_depIdxs = nil
}
...
func (c *customAudienceServiceClient) MutateCustomAudiences(ctx context.Context, in *MutateCustomAudiencesRequest, opts ...grpc.CallOption) (*MutateCustomAudiencesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.CustomAudienceService/MutateCustomAudiences", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CustomAudienceService_MutateCustomAudiences_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.CustomAudienceService/MutateCustomAudiences",
	}
...
var _CustomAudienceService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/custom_audience_service.proto",
}
