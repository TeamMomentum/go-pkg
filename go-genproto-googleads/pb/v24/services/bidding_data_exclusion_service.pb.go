...
func (x *MutateBiddingDataExclusionsRequest) Reset() {
	*x = MutateBiddingDataExclusionsRequest{}
	mi := &file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_msgTypes[0]
...
func (*MutateBiddingDataExclusionsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *BiddingDataExclusionOperation) Reset() {
	*x = BiddingDataExclusionOperation{}
	mi := &file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BiddingDataExclusionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateBiddingDataExclusionsResponse) Reset() {
	*x = MutateBiddingDataExclusionsResponse{}
	mi := &file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateBiddingDataExclusionsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateBiddingDataExclusionsResult) Reset() {
	*x = MutateBiddingDataExclusionsResult{}
	mi := &file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateBiddingDataExclusionsResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDesc = []byte{
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x42, 0x69, 0x64, 0x64,
	...
	0x76, 0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x42, 0x69,
	0x64, 0x64, 0x69, 0x6e, 0x67, 0x44, 0x61, 0x74, 0x61, 0x45, 0x78, 0x63, 0x6c, 0x75, 0x73, 0x69,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x32, 0x34, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x20, 0x42, 0x69, 0x64,
...
var (
	file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDescData = file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_goTypes = []any{
	(*MutateBiddingDataExclusionsRequest)(nil),             // 0: google.ads.googleads.v24.services.MutateBiddingDataExclusionsRequest
	(*BiddingDataExclusionOperation)(nil),                  // 1: google.ads.googleads.v24.services.BiddingDataExclusionOperation
	(*MutateBiddingDataExclusionsResponse)(nil),            // 2: google.ads.googleads.v24.services.MutateBiddingDataExclusionsResponse
	(*MutateBiddingDataExclusionsResult)(nil),              // 3: google.ads.googleads.v24.services.MutateBiddingDataExclusionsResult
	...
	(*resources.BiddingDataExclusion)(nil),                 // 6: google.ads.googleads.v24.resources.BiddingDataExclusion
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateBiddingDataExclusionsRequest.operations:type_name -> google.ads.googleads.v24.services.BiddingDataExclusionOperation
	4, // 1: google.ads.googleads.v24.services.MutateBiddingDataExclusionsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.BiddingDataExclusionOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.BiddingDataExclusionOperation.create:type_name -> google.ads.googleads.v24.resources.BiddingDataExclusion
	6, // 4: google.ads.googleads.v24.services.BiddingDataExclusionOperation.update:type_name -> google.ads.googleads.v24.resources.BiddingDataExclusion
	7, // 5: google.ads.googleads.v24.services.MutateBiddingDataExclusionsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateBiddingDataExclusionsResponse.results:type_name -> google.ads.googleads.v24.services.MutateBiddingDataExclusionsResult
	6, // 7: google.ads.googleads.v24.services.MutateBiddingDataExclusionsResult.bidding_data_exclusion:type_name -> google.ads.googleads.v24.resources.BiddingDataExclusion
	0, // 8: google.ads.googleads.v24.services.BiddingDataExclusionService.MutateBiddingDataExclusions:input_type -> google.ads.googleads.v24.services.MutateBiddingDataExclusionsRequest
	2, // 9: google.ads.googleads.v24.services.BiddingDataExclusionService.MutateBiddingDataExclusions:output_type -> google.ads.googleads.v24.services.MutateBiddingDataExclusionsResponse
...
func init() { file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_init() }
func file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_init() {
	if File_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto = out.File
	file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_bidding_data_exclusion_service_proto_depIdxs = nil
}
...
func (c *biddingDataExclusionServiceClient) MutateBiddingDataExclusions(ctx context.Context, in *MutateBiddingDataExclusionsRequest, opts ...grpc.CallOption) (*MutateBiddingDataExclusionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.BiddingDataExclusionService/MutateBiddingDataExclusions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BiddingDataExclusionService_MutateBiddingDataExclusions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.BiddingDataExclusionService/MutateBiddingDataExclusions",
	}
...
var _BiddingDataExclusionService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/bidding_data_exclusion_service.proto",
}
