...
func (x *MutateSharedSetsRequest) Reset() {
	*x = MutateSharedSetsRequest{}
	mi := &file_google_ads_googleads_v24_services_shared_set_service_proto_msgTypes[0]
...
func (*MutateSharedSetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_shared_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *SharedSetOperation) Reset() {
	*x = SharedSetOperation{}
	mi := &file_google_ads_googleads_v24_services_shared_set_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SharedSetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_shared_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateSharedSetsResponse) Reset() {
	*x = MutateSharedSetsResponse{}
	mi := &file_google_ads_googleads_v24_services_shared_set_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateSharedSetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_shared_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateSharedSetResult) Reset() {
	*x = MutateSharedSetResult{}
	mi := &file_google_ads_googleads_v24_services_shared_set_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateSharedSetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_shared_set_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_shared_set_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_shared_set_service_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x34, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x68,
	...
	0xe4, 0x93, 0x02, 0x35, 0x3a, 0x01, 0x2a, 0x22, 0x30, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75,
...
var (
	file_google_ads_googleads_v24_services_shared_set_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_shared_set_service_proto_rawDescData = file_google_ads_googleads_v24_services_shared_set_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_shared_set_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_shared_set_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_shared_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_shared_set_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_shared_set_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_shared_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_shared_set_service_proto_goTypes = []any{
	(*MutateSharedSetsRequest)(nil),                        // 0: google.ads.googleads.v24.services.MutateSharedSetsRequest
	(*SharedSetOperation)(nil),                             // 1: google.ads.googleads.v24.services.SharedSetOperation
	(*MutateSharedSetsResponse)(nil),                       // 2: google.ads.googleads.v24.services.MutateSharedSetsResponse
	(*MutateSharedSetResult)(nil),                          // 3: google.ads.googleads.v24.services.MutateSharedSetResult
	...
	(*resources.SharedSet)(nil),                            // 6: google.ads.googleads.v24.resources.SharedSet
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v24_services_shared_set_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateSharedSetsRequest.operations:type_name -> google.ads.googleads.v24.services.SharedSetOperation
	4, // 1: google.ads.googleads.v24.services.MutateSharedSetsRequest.response_content_type:type_name -> google.ads.googleads.v24.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v24.services.SharedSetOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v24.services.SharedSetOperation.create:type_name -> google.ads.googleads.v24.resources.SharedSet
	6, // 4: google.ads.googleads.v24.services.SharedSetOperation.update:type_name -> google.ads.googleads.v24.resources.SharedSet
	7, // 5: google.ads.googleads.v24.services.MutateSharedSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 6: google.ads.googleads.v24.services.MutateSharedSetsResponse.results:type_name -> google.ads.googleads.v24.services.MutateSharedSetResult
	6, // 7: google.ads.googleads.v24.services.MutateSharedSetResult.shared_set:type_name -> google.ads.googleads.v24.resources.SharedSet
	0, // 8: google.ads.googleads.v24.services.SharedSetService.MutateSharedSets:input_type -> google.ads.googleads.v24.services.MutateSharedSetsRequest
	2, // 9: google.ads.googleads.v24.services.SharedSetService.MutateSharedSets:output_type -> google.ads.googleads.v24.services.MutateSharedSetsResponse
...
func init() { file_google_ads_googleads_v24_services_shared_set_service_proto_init() }
func file_google_ads_googleads_v24_services_shared_set_service_proto_init() {
	if File_google_ads_googleads_v24_services_shared_set_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_shared_set_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_shared_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_shared_set_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_shared_set_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_shared_set_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_shared_set_service_proto = out.File
	file_google_ads_googleads_v24_services_shared_set_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_shared_set_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_shared_set_service_proto_depIdxs = nil
}
...
func (c *sharedSetServiceClient) MutateSharedSets(ctx context.Context, in *MutateSharedSetsRequest, opts ...grpc.CallOption) (*MutateSharedSetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.SharedSetService/MutateSharedSets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SharedSetService_MutateSharedSets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.SharedSetService/MutateSharedSets",
	}
...
var _SharedSetService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/shared_set_service.proto",
}
