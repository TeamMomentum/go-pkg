...
func (x *MutateKeywordPlanCampaignKeywordsRequest) Reset() {
	*x = MutateKeywordPlanCampaignKeywordsRequest{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_msgTypes[0]
...
func (*MutateKeywordPlanCampaignKeywordsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordPlanCampaignKeywordOperation) Reset() {
	*x = KeywordPlanCampaignKeywordOperation{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordPlanCampaignKeywordOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateKeywordPlanCampaignKeywordsResponse) Reset() {
	*x = MutateKeywordPlanCampaignKeywordsResponse{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlanCampaignKeywordsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateKeywordPlanCampaignKeywordResult) Reset() {
	*x = MutateKeywordPlanCampaignKeywordResult{}
	mi := &file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlanCampaignKeywordResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDesc = []byte{
	...
	0x22, 0x41, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
...
var (
	file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDescData = file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDesc
)

func file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDescData
}

var file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_goTypes = []any{
	(*MutateKeywordPlanCampaignKeywordsRequest)(nil),  // 0: google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordsRequest
	(*KeywordPlanCampaignKeywordOperation)(nil),       // 1: google.ads.googleads.v24.services.KeywordPlanCampaignKeywordOperation
	(*MutateKeywordPlanCampaignKeywordsResponse)(nil), // 2: google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordsResponse
	(*MutateKeywordPlanCampaignKeywordResult)(nil),    // 3: google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordResult
	(*fieldmaskpb.FieldMask)(nil),                     // 4: google.protobuf.FieldMask
	(*resources.KeywordPlanCampaignKeyword)(nil),      // 5: google.ads.googleads.v24.resources.KeywordPlanCampaignKeyword
	(*status.Status)(nil),                             // 6: google.rpc.Status
}
var file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordsRequest.operations:type_name -> google.ads.googleads.v24.services.KeywordPlanCampaignKeywordOperation
	4, // 1: google.ads.googleads.v24.services.KeywordPlanCampaignKeywordOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v24.services.KeywordPlanCampaignKeywordOperation.create:type_name -> google.ads.googleads.v24.resources.KeywordPlanCampaignKeyword
	5, // 3: google.ads.googleads.v24.services.KeywordPlanCampaignKeywordOperation.update:type_name -> google.ads.googleads.v24.resources.KeywordPlanCampaignKeyword
	6, // 4: google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 5: google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordsResponse.results:type_name -> google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordResult
	0, // 6: google.ads.googleads.v24.services.KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords:input_type -> google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordsRequest
	2, // 7: google.ads.googleads.v24.services.KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords:output_type -> google.ads.googleads.v24.services.MutateKeywordPlanCampaignKeywordsResponse
...
func file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_init() {
	if File_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto != nil {
		return
	}
	file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto = out.File
	file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_rawDesc = nil
	file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_goTypes = nil
	file_google_ads_googleads_v24_services_keyword_plan_campaign_keyword_service_proto_depIdxs = nil
}
...
func (c *keywordPlanCampaignKeywordServiceClient) MutateKeywordPlanCampaignKeywords(ctx context.Context, in *MutateKeywordPlanCampaignKeywordsRequest, opts ...grpc.CallOption) (*MutateKeywordPlanCampaignKeywordsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v24.services.KeywordPlanCampaignKeywordService/MutateKeywordPlanCampaignKeywords", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _KeywordPlanCampaignKeywordService_MutateKeywordPlanCampaignKeywords_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v24.services.KeywordPlanCampaignKeywordService/MutateKeywordPlanCampaignKeywords",
	}
...
var _KeywordPlanCampaignKeywordService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "google/ads/googleads/v24/services/keyword_plan_campaign_keyword_service.proto",
}
