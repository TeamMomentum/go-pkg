...
func (AccountBudgetProposalTypeEnum_AccountBudgetProposalType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_enumTypes[0].Descriptor()
}

func (AccountBudgetProposalTypeEnum_AccountBudgetProposalType) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_enumTypes[0]
}
...
func (AccountBudgetProposalTypeEnum_AccountBudgetProposalType) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AccountBudgetProposalTypeEnum) Reset() {
	*x = AccountBudgetProposalTypeEnum{}
	mi := &file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_msgTypes[0]
...
func (*AccountBudgetProposalTypeEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v24_enums_account_budget_proposal_type_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDescData = file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDesc
)

func file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDescData
}

var file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_goTypes = []any{
	(AccountBudgetProposalTypeEnum_AccountBudgetProposalType)(0), // 0: google.ads.googleads.v24.enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType
	(*AccountBudgetProposalTypeEnum)(nil),                        // 1: google.ads.googleads.v24.enums.AccountBudgetProposalTypeEnum
}
var file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_init() }
func file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_init() {
	if File_google_ads_googleads_v24_enums_account_budget_proposal_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_enums_account_budget_proposal_type_proto = out.File
	file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_rawDesc = nil
	file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_goTypes = nil
	file_google_ads_googleads_v24_enums_account_budget_proposal_type_proto_depIdxs = nil
}
