...
func (InteractionEventTypeEnum_InteractionEventType) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v24_enums_interaction_event_type_proto_enumTypes[0].Descriptor()
}

func (InteractionEventTypeEnum_InteractionEventType) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v24_enums_interaction_event_type_proto_enumTypes[0]
}
...
func (InteractionEventTypeEnum_InteractionEventType) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *InteractionEventTypeEnum) Reset() {
	*x = InteractionEventTypeEnum{}
	mi := &file_google_ads_googleads_v24_enums_interaction_event_type_proto_msgTypes[0]
...
func (*InteractionEventTypeEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v24_enums_interaction_event_type_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x19, 0x49, 0x6e,
	0x74, 0x65, 0x72, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79,
...
var (
	file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDescData = file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDesc
)

func file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDescData
}

var file_google_ads_googleads_v24_enums_interaction_event_type_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v24_enums_interaction_event_type_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_enums_interaction_event_type_proto_goTypes = []any{
	(InteractionEventTypeEnum_InteractionEventType)(0), // 0: google.ads.googleads.v24.enums.InteractionEventTypeEnum.InteractionEventType
	(*InteractionEventTypeEnum)(nil),                   // 1: google.ads.googleads.v24.enums.InteractionEventTypeEnum
}
var file_google_ads_googleads_v24_enums_interaction_event_type_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v24_enums_interaction_event_type_proto_init() }
func file_google_ads_googleads_v24_enums_interaction_event_type_proto_init() {
	if File_google_ads_googleads_v24_enums_interaction_event_type_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_enums_interaction_event_type_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_enums_interaction_event_type_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v24_enums_interaction_event_type_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v24_enums_interaction_event_type_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_enums_interaction_event_type_proto = out.File
	file_google_ads_googleads_v24_enums_interaction_event_type_proto_rawDesc = nil
	file_google_ads_googleads_v24_enums_interaction_event_type_proto_goTypes = nil
	file_google_ads_googleads_v24_enums_interaction_event_type_proto_depIdxs = nil
}
