...
type LookalikeUserListInfo struct {
	...
	ExpansionLevel enums.LookalikeExpansionLevelEnum_LookalikeExpansionLevel `protobuf:"varint,2,opt,name=expansion_level,json=expansionLevel,proto3,enum=google.ads.googleads.v24.enums.LookalikeExpansionLevelEnum_LookalikeExpansionLevel" json:"expansion_level,omitempty"`
...
func (x *LookalikeUserListInfo) Reset() {
	*x = LookalikeUserListInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[0]
...
func (*LookalikeUserListInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{0}
}
...
func (x *SimilarUserListInfo) Reset() {
	*x = SimilarUserListInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SimilarUserListInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{1}
}
...
type CrmBasedUserListInfo struct {
	...
	UploadKeyType enums.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType `protobuf:"varint,2,opt,name=upload_key_type,json=uploadKeyType,proto3,enum=google.ads.googleads.v24.enums.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType" json:"upload_key_type,omitempty"`
	// Data source of the list. Default value is FIRST_PARTY.
	// Only customers on the allow-list can create third-party sourced CRM lists.
	DataSourceType enums.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType `protobuf:"varint,3,opt,name=data_source_type,json=dataSourceType,proto3,enum=google.ads.googleads.v24.enums.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType" json:"data_source_type,omitempty"`
}

func (x *CrmBasedUserListInfo) Reset() {
	*x = CrmBasedUserListInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CrmBasedUserListInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{2}
}
...
type UserListRuleInfo struct {
	...
	RuleType enums.UserListRuleTypeEnum_UserListRuleType `protobuf:"varint,1,opt,name=rule_type,json=ruleType,proto3,enum=google.ads.googleads.v24.enums.UserListRuleTypeEnum_UserListRuleType" json:"rule_type,omitempty"`
...
func (x *UserListRuleInfo) Reset() {
	*x = UserListRuleInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserListRuleInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{3}
}
...
func (x *UserListRuleItemGroupInfo) Reset() {
	*x = UserListRuleItemGroupInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserListRuleItemGroupInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{4}
}
...
func (x *UserListRuleItemInfo) Reset() {
	*x = UserListRuleItemInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserListRuleItemInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{5}
}
...
type UserListDateRuleItemInfo struct {
	...
	// rule item.
	Operator enums.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator `protobuf:"varint,1,opt,name=operator,proto3,enum=google.ads.googleads.v24.enums.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator" json:"operator,omitempty"`
...
func (x *UserListDateRuleItemInfo) Reset() {
	*x = UserListDateRuleItemInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserListDateRuleItemInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{6}
}
...
type UserListNumberRuleItemInfo struct {
	...
	// rule item.
	Operator enums.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator `protobuf:"varint,1,opt,name=operator,proto3,enum=google.ads.googleads.v24.enums.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator" json:"operator,omitempty"`
...
func (x *UserListNumberRuleItemInfo) Reset() {
	*x = UserListNumberRuleItemInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserListNumberRuleItemInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{7}
}
...
type UserListStringRuleItemInfo struct {
	...
	// rule item.
	Operator enums.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator `protobuf:"varint,1,opt,name=operator,proto3,enum=google.ads.googleads.v24.enums.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator" json:"operator,omitempty"`
...
func (x *UserListStringRuleItemInfo) Reset() {
	*x = UserListStringRuleItemInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserListStringRuleItemInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{8}
}
...
func (x *FlexibleRuleOperandInfo) Reset() {
	*x = FlexibleRuleOperandInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FlexibleRuleOperandInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{9}
}
...
type FlexibleRuleUserListInfo struct {
	...
	InclusiveRuleOperator enums.UserListFlexibleRuleOperatorEnum_UserListFlexibleRuleOperator `protobuf:"varint,1,opt,name=inclusive_rule_operator,json=inclusiveRuleOperator,proto3,enum=google.ads.googleads.v24.enums.UserListFlexibleRuleOperatorEnum_UserListFlexibleRuleOperator" json:"inclusive_rule_operator,omitempty"`
...
func (x *FlexibleRuleUserListInfo) Reset() {
	*x = FlexibleRuleUserListInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FlexibleRuleUserListInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{10}
}
...
type RuleBasedUserListInfo struct {
	...
	PrepopulationStatus enums.UserListPrepopulationStatusEnum_UserListPrepopulationStatus `protobuf:"varint,1,opt,name=prepopulation_status,json=prepopulationStatus,proto3,enum=google.ads.googleads.v24.enums.UserListPrepopulationStatusEnum_UserListPrepopulationStatus" json:"prepopulation_status,omitempty"`
	// Flexible rule representation of visitors with one or multiple actions. The
	// flexible user list is defined by two lists of operands – inclusive_operands
	// and exclusive_operands; each operand represents a set of users based on
...
func (x *RuleBasedUserListInfo) Reset() {
	*x = RuleBasedUserListInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RuleBasedUserListInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{11}
}
...
func (x *LogicalUserListInfo) Reset() {
	*x = LogicalUserListInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LogicalUserListInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{12}
}
...
type UserListLogicalRuleInfo struct {
	...
	Operator enums.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator `protobuf:"varint,1,opt,name=operator,proto3,enum=google.ads.googleads.v24.enums.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator" json:"operator,omitempty"`
...
func (x *UserListLogicalRuleInfo) Reset() {
	*x = UserListLogicalRuleInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserListLogicalRuleInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{13}
}
...
func (x *LogicalUserListOperandInfo) Reset() {
	*x = LogicalUserListOperandInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LogicalUserListOperandInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{14}
}
...
func (x *BasicUserListInfo) Reset() {
	*x = BasicUserListInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BasicUserListInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{15}
}
...
func (x *UserListActionInfo) Reset() {
	*x = UserListActionInfo{}
	mi := &file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UserListActionInfo) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP(), []int{16}
}
...
var File_google_ads_googleads_v24_common_user_lists_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_common_user_lists_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x6f, 0x6f, 0x6b, 0x61, 0x6c, 0x69,
	...
	0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2f, 0x76,
	0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6c, 0x69,
	...
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x75, 0x73,
	...
	0x64, 0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x75, 0x73, 0x65,
	...
	0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72,
	...
	0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x55,
	...
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x55, 0x73, 0x65,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x55, 0x73, 0x65, 0x72,
	...
	0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73,
	...
	0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73,
	...
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x46, 0x6c, 0x65, 0x78,
	...
	0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73,
	0x2e, 0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x55, 0x73, 0x65, 0x72,
	...
	0x64, 0x73, 0x2e, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x32, 0x34,
	...
	0x32, 0x34, 0x5c, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xea, 0x02, 0x23, 0x47, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41,
	0x64, 0x73, 0x3a, 0x3a, 0x56, 0x32, 0x34, 0x3a, 0x3a, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_ads_googleads_v24_common_user_lists_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_common_user_lists_proto_rawDescData = file_google_ads_googleads_v24_common_user_lists_proto_rawDesc
)

func file_google_ads_googleads_v24_common_user_lists_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_common_user_lists_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_common_user_lists_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_common_user_lists_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_common_user_lists_proto_rawDescData
}

var file_google_ads_googleads_v24_common_user_lists_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_google_ads_googleads_v24_common_user_lists_proto_goTypes = []any{
	(*LookalikeUserListInfo)(nil),                                                // 0: google.ads.googleads.v24.common.LookalikeUserListInfo
	(*SimilarUserListInfo)(nil),                                                  // 1: google.ads.googleads.v24.common.SimilarUserListInfo
	(*CrmBasedUserListInfo)(nil),                                                 // 2: google.ads.googleads.v24.common.CrmBasedUserListInfo
	(*UserListRuleInfo)(nil),                                                     // 3: google.ads.googleads.v24.common.UserListRuleInfo
	(*UserListRuleItemGroupInfo)(nil),                                            // 4: google.ads.googleads.v24.common.UserListRuleItemGroupInfo
	(*UserListRuleItemInfo)(nil),                                                 // 5: google.ads.googleads.v24.common.UserListRuleItemInfo
	(*UserListDateRuleItemInfo)(nil),                                             // 6: google.ads.googleads.v24.common.UserListDateRuleItemInfo
	(*UserListNumberRuleItemInfo)(nil),                                           // 7: google.ads.googleads.v24.common.UserListNumberRuleItemInfo
	(*UserListStringRuleItemInfo)(nil),                                           // 8: google.ads.googleads.v24.common.UserListStringRuleItemInfo
	(*FlexibleRuleOperandInfo)(nil),                                              // 9: google.ads.googleads.v24.common.FlexibleRuleOperandInfo
	(*FlexibleRuleUserListInfo)(nil),                                             // 10: google.ads.googleads.v24.common.FlexibleRuleUserListInfo
	(*RuleBasedUserListInfo)(nil),                                                // 11: google.ads.googleads.v24.common.RuleBasedUserListInfo
	(*LogicalUserListInfo)(nil),                                                  // 12: google.ads.googleads.v24.common.LogicalUserListInfo
	(*UserListLogicalRuleInfo)(nil),                                              // 13: google.ads.googleads.v24.common.UserListLogicalRuleInfo
	(*LogicalUserListOperandInfo)(nil),                                           // 14: google.ads.googleads.v24.common.LogicalUserListOperandInfo
	(*BasicUserListInfo)(nil),                                                    // 15: google.ads.googleads.v24.common.BasicUserListInfo
	(*UserListActionInfo)(nil),                                                   // 16: google.ads.googleads.v24.common.UserListActionInfo
	(enums.LookalikeExpansionLevelEnum_LookalikeExpansionLevel)(0),               // 17: google.ads.googleads.v24.enums.LookalikeExpansionLevelEnum.LookalikeExpansionLevel
	(enums.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType)(0),         // 18: google.ads.googleads.v24.enums.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType
	(enums.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType)(0),           // 19: google.ads.googleads.v24.enums.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType
	(enums.UserListRuleTypeEnum_UserListRuleType)(0),                             // 20: google.ads.googleads.v24.enums.UserListRuleTypeEnum.UserListRuleType
	(enums.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator)(0),     // 21: google.ads.googleads.v24.enums.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator
	(enums.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator)(0), // 22: google.ads.googleads.v24.enums.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator
	(enums.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator)(0), // 23: google.ads.googleads.v24.enums.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator
	(enums.UserListFlexibleRuleOperatorEnum_UserListFlexibleRuleOperator)(0),     // 24: google.ads.googleads.v24.enums.UserListFlexibleRuleOperatorEnum.UserListFlexibleRuleOperator
	(enums.UserListPrepopulationStatusEnum_UserListPrepopulationStatus)(0),       // 25: google.ads.googleads.v24.enums.UserListPrepopulationStatusEnum.UserListPrepopulationStatus
	(enums.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator)(0),       // 26: google.ads.googleads.v24.enums.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator
}
var file_google_ads_googleads_v24_common_user_lists_proto_depIdxs = []int32{
	17, // 0: google.ads.googleads.v24.common.LookalikeUserListInfo.expansion_level:type_name -> google.ads.googleads.v24.enums.LookalikeExpansionLevelEnum.LookalikeExpansionLevel
	18, // 1: google.ads.googleads.v24.common.CrmBasedUserListInfo.upload_key_type:type_name -> google.ads.googleads.v24.enums.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType
	19, // 2: google.ads.googleads.v24.common.CrmBasedUserListInfo.data_source_type:type_name -> google.ads.googleads.v24.enums.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType
	20, // 3: google.ads.googleads.v24.common.UserListRuleInfo.rule_type:type_name -> google.ads.googleads.v24.enums.UserListRuleTypeEnum.UserListRuleType
	4,  // 4: google.ads.googleads.v24.common.UserListRuleInfo.rule_item_groups:type_name -> google.ads.googleads.v24.common.UserListRuleItemGroupInfo
	5,  // 5: google.ads.googleads.v24.common.UserListRuleItemGroupInfo.rule_items:type_name -> google.ads.googleads.v24.common.UserListRuleItemInfo
	7,  // 6: google.ads.googleads.v24.common.UserListRuleItemInfo.number_rule_item:type_name -> google.ads.googleads.v24.common.UserListNumberRuleItemInfo
	8,  // 7: google.ads.googleads.v24.common.UserListRuleItemInfo.string_rule_item:type_name -> google.ads.googleads.v24.common.UserListStringRuleItemInfo
	6,  // 8: google.ads.googleads.v24.common.UserListRuleItemInfo.date_rule_item:type_name -> google.ads.googleads.v24.common.UserListDateRuleItemInfo
	21, // 9: google.ads.googleads.v24.common.UserListDateRuleItemInfo.operator:type_name -> google.ads.googleads.v24.enums.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator
	22, // 10: google.ads.googleads.v24.common.UserListNumberRuleItemInfo.operator:type_name -> google.ads.googleads.v24.enums.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator
	23, // 11: google.ads.googleads.v24.common.UserListStringRuleItemInfo.operator:type_name -> google.ads.googleads.v24.enums.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator
	3,  // 12: google.ads.googleads.v24.common.FlexibleRuleOperandInfo.rule:type_name -> google.ads.googleads.v24.common.UserListRuleInfo
	24, // 13: google.ads.googleads.v24.common.FlexibleRuleUserListInfo.inclusive_rule_operator:type_name -> google.ads.googleads.v24.enums.UserListFlexibleRuleOperatorEnum.UserListFlexibleRuleOperator
	9,  // 14: google.ads.googleads.v24.common.FlexibleRuleUserListInfo.inclusive_operands:type_name -> google.ads.googleads.v24.common.FlexibleRuleOperandInfo
	9,  // 15: google.ads.googleads.v24.common.FlexibleRuleUserListInfo.exclusive_operands:type_name -> google.ads.googleads.v24.common.FlexibleRuleOperandInfo
	25, // 16: google.ads.googleads.v24.common.RuleBasedUserListInfo.prepopulation_status:type_name -> google.ads.googleads.v24.enums.UserListPrepopulationStatusEnum.UserListPrepopulationStatus
	10, // 17: google.ads.googleads.v24.common.RuleBasedUserListInfo.flexible_rule_user_list:type_name -> google.ads.googleads.v24.common.FlexibleRuleUserListInfo
	13, // 18: google.ads.googleads.v24.common.LogicalUserListInfo.rules:type_name -> google.ads.googleads.v24.common.UserListLogicalRuleInfo
	26, // 19: google.ads.googleads.v24.common.UserListLogicalRuleInfo.operator:type_name -> google.ads.googleads.v24.enums.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator
	14, // 20: google.ads.googleads.v24.common.UserListLogicalRuleInfo.rule_operands:type_name -> google.ads.googleads.v24.common.LogicalUserListOperandInfo
	16, // 21: google.ads.googleads.v24.common.BasicUserListInfo.actions:type_name -> google.ads.googleads.v24.common.UserListActionInfo
...
func init() { file_google_ads_googleads_v24_common_user_lists_proto_init() }
func file_google_ads_googleads_v24_common_user_lists_proto_init() {
	if File_google_ads_googleads_v24_common_user_lists_proto != nil {
		return
	}
	file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[1].OneofWrappers = []any{}
	file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[2].OneofWrappers = []any{}
	file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[5].OneofWrappers = []any{
		(*UserListRuleItemInfo_NumberRuleItem)(nil),
		(*UserListRuleItemInfo_StringRuleItem)(nil),
		(*UserListRuleItemInfo_DateRuleItem)(nil),
	}
	file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[6].OneofWrappers = []any{}
	file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[7].OneofWrappers = []any{}
	file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[8].OneofWrappers = []any{}
	file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[9].OneofWrappers = []any{}
	file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[14].OneofWrappers = []any{}
	file_google_ads_googleads_v24_common_user_lists_proto_msgTypes[16].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_common_user_lists_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_common_user_lists_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_common_user_lists_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_common_user_lists_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_common_user_lists_proto = out.File
	file_google_ads_googleads_v24_common_user_lists_proto_rawDesc = nil
	file_google_ads_googleads_v24_common_user_lists_proto_goTypes = nil
	file_google_ads_googleads_v24_common_user_lists_proto_depIdxs = nil
}
