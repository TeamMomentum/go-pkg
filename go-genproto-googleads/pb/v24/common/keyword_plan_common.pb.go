...
type KeywordPlanHistoricalMetrics struct {
	...
	Competition enums.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel `protobuf:"varint,2,opt,name=competition,proto3,enum=google.ads.googleads.v24.enums.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel" json:"competition,omitempty"`
...
func (x *KeywordPlanHistoricalMetrics) Reset() {
	*x = KeywordPlanHistoricalMetrics{}
	mi := &file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[0]
...
func (*KeywordPlanHistoricalMetrics) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescGZIP(), []int{0}
}
...
func (x *HistoricalMetricsOptions) Reset() {
	*x = HistoricalMetricsOptions{}
	mi := &file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HistoricalMetricsOptions) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescGZIP(), []int{1}
}
...
type MonthlySearchVolume struct {
	...
	Month enums.MonthOfYearEnum_MonthOfYear `protobuf:"varint,2,opt,name=month,proto3,enum=google.ads.googleads.v24.enums.MonthOfYearEnum_MonthOfYear" json:"month,omitempty"`
...
func (x *MonthlySearchVolume) Reset() {
	*x = MonthlySearchVolume{}
	mi := &file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MonthlySearchVolume) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescGZIP(), []int{2}
}
...
type KeywordPlanAggregateMetrics struct {
	...
	AggregateMetricTypes []enums.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType `protobuf:"varint,1,rep,packed,name=aggregate_metric_types,json=aggregateMetricTypes,proto3,enum=google.ads.googleads.v24.enums.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType" json:"aggregate_metric_types,omitempty"`
}

func (x *KeywordPlanAggregateMetrics) Reset() {
	*x = KeywordPlanAggregateMetrics{}
	mi := &file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordPlanAggregateMetrics) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescGZIP(), []int{3}
}
...
func (x *KeywordPlanAggregateMetricResults) Reset() {
	*x = KeywordPlanAggregateMetricResults{}
	mi := &file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordPlanAggregateMetricResults) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescGZIP(), []int{4}
}
...
func (x *KeywordPlanDeviceSearches) Reset() {
	*x = KeywordPlanDeviceSearches{}
	mi := &file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordPlanDeviceSearches) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescGZIP(), []int{5}
}
...
func (x *KeywordAnnotations) Reset() {
	*x = KeywordAnnotations{}
	mi := &file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordAnnotations) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescGZIP(), []int{6}
}
...
func (x *KeywordConcept) Reset() {
	*x = KeywordConcept{}
	mi := &file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordConcept) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescGZIP(), []int{7}
}
...
type ConceptGroup struct {
	...
	Type enums.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType `protobuf:"varint,2,opt,name=type,proto3,enum=google.ads.googleads.v24.enums.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType" json:"type,omitempty"`
}

func (x *ConceptGroup) Reset() {
	*x = ConceptGroup{}
	mi := &file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ConceptGroup) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescGZIP(), []int{8}
}
...
var File_google_ads_googleads_v24_common_keyword_plan_common_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x1a, 0x2b, 0x67, 0x6f,
	...
	0x2f, 0x76, 0x32, 0x34, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6d, 0x6f, 0x6e, 0x74, 0x68,
	...
	0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4b, 0x65, 0x79, 0x77, 0x6f, 0x72, 0x64,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x4b, 0x65, 0x79,
	...
	0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x43, 0x6f, 0x6e, 0x63, 0x65,
	...
	0x64, 0x73, 0x2f, 0x76, 0x32, 0x34, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x3b, 0x63, 0x6f,
	...
	0x73, 0x2e, 0x56, 0x32, 0x34, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xca, 0x02, 0x1f, 0x47,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x41, 0x64, 0x73, 0x5c, 0x56, 0x32, 0x34, 0x5c, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0xea, 0x02,
	0x23, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x32, 0x34, 0x3a, 0x3a, 0x43, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescData = file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDesc
)

func file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDescData
}

var file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_google_ads_googleads_v24_common_keyword_plan_common_proto_goTypes = []any{
	(*KeywordPlanHistoricalMetrics)(nil),                                         // 0: google.ads.googleads.v24.common.KeywordPlanHistoricalMetrics
	(*HistoricalMetricsOptions)(nil),                                             // 1: google.ads.googleads.v24.common.HistoricalMetricsOptions
	(*MonthlySearchVolume)(nil),                                                  // 2: google.ads.googleads.v24.common.MonthlySearchVolume
	(*KeywordPlanAggregateMetrics)(nil),                                          // 3: google.ads.googleads.v24.common.KeywordPlanAggregateMetrics
	(*KeywordPlanAggregateMetricResults)(nil),                                    // 4: google.ads.googleads.v24.common.KeywordPlanAggregateMetricResults
	(*KeywordPlanDeviceSearches)(nil),                                            // 5: google.ads.googleads.v24.common.KeywordPlanDeviceSearches
	(*KeywordAnnotations)(nil),                                                   // 6: google.ads.googleads.v24.common.KeywordAnnotations
	(*KeywordConcept)(nil),                                                       // 7: google.ads.googleads.v24.common.KeywordConcept
	(*ConceptGroup)(nil),                                                         // 8: google.ads.googleads.v24.common.ConceptGroup
	(enums.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel)(0),       // 9: google.ads.googleads.v24.enums.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel
	(*YearMonthRange)(nil),                                                       // 10: google.ads.googleads.v24.common.YearMonthRange
	(enums.MonthOfYearEnum_MonthOfYear)(0),                                       // 11: google.ads.googleads.v24.enums.MonthOfYearEnum.MonthOfYear
	(enums.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType)(0), // 12: google.ads.googleads.v24.enums.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType
	(enums.DeviceEnum_Device)(0),                                                 // 13: google.ads.googleads.v24.enums.DeviceEnum.Device
	(enums.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType)(0),       // 14: google.ads.googleads.v24.enums.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType
}
var file_google_ads_googleads_v24_common_keyword_plan_common_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v24.common.KeywordPlanHistoricalMetrics.monthly_search_volumes:type_name -> google.ads.googleads.v24.common.MonthlySearchVolume
	9,  // 1: google.ads.googleads.v24.common.KeywordPlanHistoricalMetrics.competition:type_name -> google.ads.googleads.v24.enums.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel
	10, // 2: google.ads.googleads.v24.common.HistoricalMetricsOptions.year_month_range:type_name -> google.ads.googleads.v24.common.YearMonthRange
	11, // 3: google.ads.googleads.v24.common.MonthlySearchVolume.month:type_name -> google.ads.googleads.v24.enums.MonthOfYearEnum.MonthOfYear
	12, // 4: google.ads.googleads.v24.common.KeywordPlanAggregateMetrics.aggregate_metric_types:type_name -> google.ads.googleads.v24.enums.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType
	5,  // 5: google.ads.googleads.v24.common.KeywordPlanAggregateMetricResults.device_searches:type_name -> google.ads.googleads.v24.common.KeywordPlanDeviceSearches
	13, // 6: google.ads.googleads.v24.common.KeywordPlanDeviceSearches.device:type_name -> google.ads.googleads.v24.enums.DeviceEnum.Device
	7,  // 7: google.ads.googleads.v24.common.KeywordAnnotations.concepts:type_name -> google.ads.googleads.v24.common.KeywordConcept
	8,  // 8: google.ads.googleads.v24.common.KeywordConcept.concept_group:type_name -> google.ads.googleads.v24.common.ConceptGroup
	14, // 9: google.ads.googleads.v24.common.ConceptGroup.type:type_name -> google.ads.googleads.v24.enums.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType
...
func init() { file_google_ads_googleads_v24_common_keyword_plan_common_proto_init() }
func file_google_ads_googleads_v24_common_keyword_plan_common_proto_init() {
	if File_google_ads_googleads_v24_common_keyword_plan_common_proto != nil {
		return
	}
	file_google_ads_googleads_v24_common_dates_proto_init()
	file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[0].OneofWrappers = []any{}
	file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[1].OneofWrappers = []any{}
	file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[2].OneofWrappers = []any{}
	file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes[5].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_common_keyword_plan_common_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_common_keyword_plan_common_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_common_keyword_plan_common_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_common_keyword_plan_common_proto = out.File
	file_google_ads_googleads_v24_common_keyword_plan_common_proto_rawDesc = nil
	file_google_ads_googleads_v24_common_keyword_plan_common_proto_goTypes = nil
	file_google_ads_googleads_v24_common_keyword_plan_common_proto_depIdxs = nil
}
