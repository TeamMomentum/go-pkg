...
func (x *AdAssetPolicySummary) Reset() {
	*x = AdAssetPolicySummary{}
	mi := &file_google_ads_googleads_v24_common_asset_policy_proto_msgTypes[0]
...
func (*AdAssetPolicySummary) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_asset_policy_proto_rawDescGZIP(), []int{0}
}
...
type AssetLinkPrimaryStatusDetails struct {
	...
	Reason *enums.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason `protobuf:"varint,1,opt,name=reason,proto3,enum=google.ads.googleads.v24.enums.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason,oneof" json:"reason,omitempty"`
	// Provides the PrimaryStatus of this status detail.
	Status *enums.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus `protobuf:"varint,2,opt,name=status,proto3,enum=google.ads.googleads.v24.enums.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus,oneof" json:"status,omitempty"`
...
func (x *AssetLinkPrimaryStatusDetails) Reset() {
	*x = AssetLinkPrimaryStatusDetails{}
	mi := &file_google_ads_googleads_v24_common_asset_policy_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AssetLinkPrimaryStatusDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_asset_policy_proto_rawDescGZIP(), []int{1}
}
...
func (*AssetDisapproved) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_asset_policy_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v24_common_asset_policy_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_common_asset_policy_proto_rawDesc = []byte{
	...
	0x32, 0x34, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x4c, 0x69,
...
var (
	file_google_ads_googleads_v24_common_asset_policy_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_common_asset_policy_proto_rawDescData = file_google_ads_googleads_v24_common_asset_policy_proto_rawDesc
)

func file_google_ads_googleads_v24_common_asset_policy_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_common_asset_policy_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_common_asset_policy_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_common_asset_policy_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_common_asset_policy_proto_rawDescData
}

var file_google_ads_googleads_v24_common_asset_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v24_common_asset_policy_proto_goTypes = []any{
	(*AdAssetPolicySummary)(nil),                                                         // 0: google.ads.googleads.v24.common.AdAssetPolicySummary
	(*AssetLinkPrimaryStatusDetails)(nil),                                                // 1: google.ads.googleads.v24.common.AssetLinkPrimaryStatusDetails
	(*AssetDisapproved)(nil),                                                             // 2: google.ads.googleads.v24.common.AssetDisapproved
	(*PolicyTopicEntry)(nil),                                                             // 3: google.ads.googleads.v24.common.PolicyTopicEntry
	(enums.PolicyReviewStatusEnum_PolicyReviewStatus)(0),                                 // 4: google.ads.googleads.v24.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	(enums.PolicyApprovalStatusEnum_PolicyApprovalStatus)(0),                             // 5: google.ads.googleads.v24.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
	(enums.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason)(0),             // 6: google.ads.googleads.v24.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason
	(enums.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus)(0),                         // 7: google.ads.googleads.v24.enums.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus
	(enums.AssetOfflineEvaluationErrorReasonsEnum_AssetOfflineEvaluationErrorReasons)(0), // 8: google.ads.googleads.v24.enums.AssetOfflineEvaluationErrorReasonsEnum.AssetOfflineEvaluationErrorReasons
}
var file_google_ads_googleads_v24_common_asset_policy_proto_depIdxs = []int32{
	3, // 0: google.ads.googleads.v24.common.AdAssetPolicySummary.policy_topic_entries:type_name -> google.ads.googleads.v24.common.PolicyTopicEntry
	4, // 1: google.ads.googleads.v24.common.AdAssetPolicySummary.review_status:type_name -> google.ads.googleads.v24.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	5, // 2: google.ads.googleads.v24.common.AdAssetPolicySummary.approval_status:type_name -> google.ads.googleads.v24.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
	6, // 3: google.ads.googleads.v24.common.AssetLinkPrimaryStatusDetails.reason:type_name -> google.ads.googleads.v24.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason
	7, // 4: google.ads.googleads.v24.common.AssetLinkPrimaryStatusDetails.status:type_name -> google.ads.googleads.v24.enums.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus
	2, // 5: google.ads.googleads.v24.common.AssetLinkPrimaryStatusDetails.asset_disapproved:type_name -> google.ads.googleads.v24.common.AssetDisapproved
	8, // 6: google.ads.googleads.v24.common.AssetDisapproved.offline_evaluation_error_reasons:type_name -> google.ads.googleads.v24.enums.AssetOfflineEvaluationErrorReasonsEnum.AssetOfflineEvaluationErrorReasons
...
func init() { file_google_ads_googleads_v24_common_asset_policy_proto_init() }
func file_google_ads_googleads_v24_common_asset_policy_proto_init() {
	if File_google_ads_googleads_v24_common_asset_policy_proto != nil {
		return
	}
	file_google_ads_googleads_v24_common_policy_proto_init()
	file_google_ads_googleads_v24_common_asset_policy_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_common_asset_policy_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_common_asset_policy_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_common_asset_policy_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_common_asset_policy_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_common_asset_policy_proto = out.File
	file_google_ads_googleads_v24_common_asset_policy_proto_rawDesc = nil
	file_google_ads_googleads_v24_common_asset_policy_proto_goTypes = nil
	file_google_ads_googleads_v24_common_asset_policy_proto_depIdxs = nil
}
