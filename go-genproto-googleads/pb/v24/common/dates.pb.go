...
func (x *DateRange) Reset() {
	*x = DateRange{}
	mi := &file_google_ads_googleads_v24_common_dates_proto_msgTypes[0]
...
func (*DateRange) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_dates_proto_rawDescGZIP(), []int{0}
}
...
func (x *YearMonthRange) Reset() {
	*x = YearMonthRange{}
	mi := &file_google_ads_googleads_v24_common_dates_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*YearMonthRange) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_dates_proto_rawDescGZIP(), []int{1}
}
...
func (x *YearMonth) Reset() {
	*x = YearMonth{}
	mi := &file_google_ads_googleads_v24_common_dates_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*YearMonth) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_common_dates_proto_rawDescGZIP(), []int{2}
}
...
var File_google_ads_googleads_v24_common_dates_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_common_dates_proto_rawDesc = []byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x1a, 0x32,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x42, 0x0a,
...
var (
	file_google_ads_googleads_v24_common_dates_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_common_dates_proto_rawDescData = file_google_ads_googleads_v24_common_dates_proto_rawDesc
)

func file_google_ads_googleads_v24_common_dates_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_common_dates_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_common_dates_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_common_dates_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_common_dates_proto_rawDescData
}

var file_google_ads_googleads_v24_common_dates_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v24_common_dates_proto_goTypes = []any{
	(*DateRange)(nil),                      // 0: google.ads.googleads.v24.common.DateRange
	(*YearMonthRange)(nil),                 // 1: google.ads.googleads.v24.common.YearMonthRange
	(*YearMonth)(nil),                      // 2: google.ads.googleads.v24.common.YearMonth
	(enums.MonthOfYearEnum_MonthOfYear)(0), // 3: google.ads.googleads.v24.enums.MonthOfYearEnum.MonthOfYear
}
var file_google_ads_googleads_v24_common_dates_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v24.common.YearMonthRange.start:type_name -> google.ads.googleads.v24.common.YearMonth
	2, // 1: google.ads.googleads.v24.common.YearMonthRange.end:type_name -> google.ads.googleads.v24.common.YearMonth
	3, // 2: google.ads.googleads.v24.common.YearMonth.month:type_name -> google.ads.googleads.v24.enums.MonthOfYearEnum.MonthOfYear
...
func init() { file_google_ads_googleads_v24_common_dates_proto_init() }
func file_google_ads_googleads_v24_common_dates_proto_init() {
	if File_google_ads_googleads_v24_common_dates_proto != nil {
		return
	}
	file_google_ads_googleads_v24_common_dates_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_google_ads_googleads_v24_common_dates_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_common_dates_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_common_dates_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v24_common_dates_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_common_dates_proto = out.File
	file_google_ads_googleads_v24_common_dates_proto_rawDesc = nil
	file_google_ads_googleads_v24_common_dates_proto_goTypes = nil
	file_google_ads_googleads_v24_common_dates_proto_depIdxs = nil
}
