...
func (AudienceInsightsErrorEnum_AudienceInsightsError) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v24_errors_audience_insights_error_proto_enumTypes[0].Descriptor()
}

func (AudienceInsightsErrorEnum_AudienceInsightsError) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v24_errors_audience_insights_error_proto_enumTypes[0]
}
...
func (AudienceInsightsErrorEnum_AudienceInsightsError) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AudienceInsightsErrorEnum) Reset() {
	*x = AudienceInsightsErrorEnum{}
	mi := &file_google_ads_googleads_v24_errors_audience_insights_error_proto_msgTypes[0]
...
func (*AudienceInsightsErrorEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v24_errors_audience_insights_error_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDesc = []byte{
	...
	0x76, 0x32, 0x34, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x42, 0x1a, 0x41, 0x75, 0x64, 0x69,
	...
	0x32, 0x34, 0x5c, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x73, 0xea, 0x02, 0x23, 0x47, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41,
	0x64, 0x73, 0x3a, 0x3a, 0x56, 0x32, 0x34, 0x3a, 0x3a, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDescData = file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDesc
)

func file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDescData
}

var file_google_ads_googleads_v24_errors_audience_insights_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v24_errors_audience_insights_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_errors_audience_insights_error_proto_goTypes = []any{
	(AudienceInsightsErrorEnum_AudienceInsightsError)(0), // 0: google.ads.googleads.v24.errors.AudienceInsightsErrorEnum.AudienceInsightsError
	(*AudienceInsightsErrorEnum)(nil),                    // 1: google.ads.googleads.v24.errors.AudienceInsightsErrorEnum
}
var file_google_ads_googleads_v24_errors_audience_insights_error_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v24_errors_audience_insights_error_proto_init() }
func file_google_ads_googleads_v24_errors_audience_insights_error_proto_init() {
	if File_google_ads_googleads_v24_errors_audience_insights_error_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_errors_audience_insights_error_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_errors_audience_insights_error_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v24_errors_audience_insights_error_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v24_errors_audience_insights_error_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_errors_audience_insights_error_proto = out.File
	file_google_ads_googleads_v24_errors_audience_insights_error_proto_rawDesc = nil
	file_google_ads_googleads_v24_errors_audience_insights_error_proto_goTypes = nil
	file_google_ads_googleads_v24_errors_audience_insights_error_proto_depIdxs = nil
}
