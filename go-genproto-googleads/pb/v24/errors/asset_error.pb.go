...
func (AssetErrorEnum_AssetError) Descriptor() protoreflect.EnumDescriptor {
	return file_google_ads_googleads_v24_errors_asset_error_proto_enumTypes[0].Descriptor()
}

func (AssetErrorEnum_AssetError) Type() protoreflect.EnumType {
	return &file_google_ads_googleads_v24_errors_asset_error_proto_enumTypes[0]
}
...
func (AssetErrorEnum_AssetError) EnumDescriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_errors_asset_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AssetErrorEnum) Reset() {
	*x = AssetErrorEnum{}
	mi := &file_google_ads_googleads_v24_errors_asset_error_proto_msgTypes[0]
...
func (*AssetErrorEnum) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v24_errors_asset_error_proto_rawDescGZIP(), []int{0}
}

var File_google_ads_googleads_v24_errors_asset_error_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v24_errors_asset_error_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x34, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x42, 0x0f, 0x41,
...
var (
	file_google_ads_googleads_v24_errors_asset_error_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v24_errors_asset_error_proto_rawDescData = file_google_ads_googleads_v24_errors_asset_error_proto_rawDesc
)

func file_google_ads_googleads_v24_errors_asset_error_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_errors_asset_error_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_errors_asset_error_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_errors_asset_error_proto_rawDescData)
	})
	return file_google_ads_googleads_v24_errors_asset_error_proto_rawDescData
}

var file_google_ads_googleads_v24_errors_asset_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_google_ads_googleads_v24_errors_asset_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v24_errors_asset_error_proto_goTypes = []any{
	(AssetErrorEnum_AssetError)(0), // 0: google.ads.googleads.v24.errors.AssetErrorEnum.AssetError
	(*AssetErrorEnum)(nil),         // 1: google.ads.googleads.v24.errors.AssetErrorEnum
}
var file_google_ads_googleads_v24_errors_asset_error_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v24_errors_asset_error_proto_init() }
func file_google_ads_googleads_v24_errors_asset_error_proto_init() {
	if File_google_ads_googleads_v24_errors_asset_error_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_errors_asset_error_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_google_ads_googleads_v24_errors_asset_error_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v24_errors_asset_error_proto_depIdxs,
		EnumInfos:         file_google_ads_googleads_v24_errors_asset_error_proto_enumTypes,
		MessageInfos:      file_google_ads_googleads_v24_errors_asset_error_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v24_errors_asset_error_proto = out.File
	file_google_ads_googleads_v24_errors_asset_error_proto_rawDesc = nil
	file_google_ads_googleads_v24_errors_asset_error_proto_goTypes = nil
	file_google_ads_googleads_v24_errors_asset_error_proto_depIdxs = nil
}
