...
func (x *ShareablePreview) GetAssetGroup() string {
	if x, ok := x.GetIdentifier().(*ShareablePreview_AssetGroup); ok {
		return x.AssetGroup
	}
	return ""
}
...
func (x *ShareablePreviewResult) GetUiPreviewResult() *UiPreviewResult {
	if x, ok := x.GetResult().(*ShareablePreviewResult_UiPreviewResult); ok {
...
func (m *ShareablePreviewResult) GetIdentifier() isShareablePreviewResult_Identifier {
	if m != nil {
		return m.Identifier
	}
	return nil
...
func (x *ShareablePreviewResult) GetAdGroupAd() string {
	if x, ok := x.GetIdentifier().(*ShareablePreviewResult_AdGroupAd); ok {
		return x.AdGroupAd
	}
	return ""
}
...
func (x *ShareablePreviewResult) GetAssetGroup() string {
	if x, ok := x.GetIdentifier().(*ShareablePreviewResult_AssetGroup); ok {
		return x.AssetGroup
	}
	return ""
}
...
var file_google_ads_googleads_v24_actions_generate_shareable_previews_proto_rawDesc = []byte{
...
var (
	...
	file_google_ads_googleads_v24_actions_generate_shareable_previews_proto_rawDescData = file_google_ads_googleads_v24_actions_generate_shareable_previews_proto_rawDesc
)
...
func file_google_ads_googleads_v24_actions_generate_shareable_previews_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v24_actions_generate_shareable_previews_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v24_actions_generate_shareable_previews_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v24_actions_generate_shareable_previews_proto_rawDescData)
	})
...
func file_google_ads_googleads_v24_actions_generate_shareable_previews_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v24_actions_generate_shareable_previews_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_google_ads_googleads_v24_actions_generate_shareable_previews_proto_rawDesc = nil
