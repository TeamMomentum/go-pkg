...
var file_google_ads_googleads_v25_services_product_link_service_proto_rawDesc = []byte{
...
var (
	...
	file_google_ads_googleads_v25_services_product_link_service_proto_rawDescData = file_google_ads_googleads_v25_services_product_link_service_proto_rawDesc
)
...
func file_google_ads_googleads_v25_services_product_link_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v25_services_product_link_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v25_services_product_link_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v25_services_product_link_service_proto_rawDescData)
	})
...
func file_google_ads_googleads_v25_services_product_link_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v25_services_product_link_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_google_ads_googleads_v25_services_product_link_service_proto_rawDesc = nil
...
func (c *productLinkServiceClient) CreateProductLink(ctx context.Context, in *CreateProductLinkRequest, opts ...grpc.CallOption) (*CreateProductLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v25.services.ProductLinkService/CreateProductLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productLinkServiceClient) RemoveProductLink(ctx context.Context, in *RemoveProductLinkRequest, opts ...grpc.CallOption) (*RemoveProductLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v25.services.ProductLinkService/RemoveProductLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductLinkService_CreateProductLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v25.services.ProductLinkService/CreateProductLink",
	}
...
func _ProductLinkService_RemoveProductLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v25.services.ProductLinkService/RemoveProductLink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
