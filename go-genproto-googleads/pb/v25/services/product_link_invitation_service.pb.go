...
var file_google_ads_googleads_v25_services_product_link_invitation_service_proto_rawDesc = []byte{
...
var (
	...
	file_google_ads_googleads_v25_services_product_link_invitation_service_proto_rawDescData = file_google_ads_googleads_v25_services_product_link_invitation_service_proto_rawDesc
)
...
func file_google_ads_googleads_v25_services_product_link_invitation_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v25_services_product_link_invitation_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v25_services_product_link_invitation_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v25_services_product_link_invitation_service_proto_rawDescData)
	})
...
func file_google_ads_googleads_v25_services_product_link_invitation_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v25_services_product_link_invitation_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_google_ads_googleads_v25_services_product_link_invitation_service_proto_rawDesc = nil
...
func (c *productLinkInvitationServiceClient) CreateProductLinkInvitation(ctx context.Context, in *CreateProductLinkInvitationRequest, opts ...grpc.CallOption) (*CreateProductLinkInvitationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v25.services.ProductLinkInvitationService/CreateProductLinkInvitation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productLinkInvitationServiceClient) UpdateProductLinkInvitation(ctx context.Context, in *UpdateProductLinkInvitationRequest, opts ...grpc.CallOption) (*UpdateProductLinkInvitationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v25.services.ProductLinkInvitationService/UpdateProductLinkInvitation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *productLinkInvitationServiceClient) RemoveProductLinkInvitation(ctx context.Context, in *RemoveProductLinkInvitationRequest, opts ...grpc.CallOption) (*RemoveProductLinkInvitationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v25.services.ProductLinkInvitationService/RemoveProductLinkInvitation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProductLinkInvitationService_CreateProductLinkInvitation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v25.services.ProductLinkInvitationService/CreateProductLinkInvitation",
	}
...
func _ProductLinkInvitationService_UpdateProductLinkInvitation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v25.services.ProductLinkInvitationService/UpdateProductLinkInvitation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProductLinkInvitationService_RemoveProductLinkInvitation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v25.services.ProductLinkInvitationService/RemoveProductLinkInvitation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
