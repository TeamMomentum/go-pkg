...
var file_google_ads_googleads_v23_services_asset_generation_service_proto_rawDesc = []byte{
...
var (
	...
	file_google_ads_googleads_v23_services_asset_generation_service_proto_rawDescData = file_google_ads_googleads_v23_services_asset_generation_service_proto_rawDesc
)
...
func file_google_ads_googleads_v23_services_asset_generation_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v23_services_asset_generation_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v23_services_asset_generation_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v23_services_asset_generation_service_proto_rawDescData)
	})
...
func file_google_ads_googleads_v23_services_asset_generation_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v23_services_asset_generation_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   11,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_google_ads_googleads_v23_services_asset_generation_service_proto_rawDesc = nil
...
func (c *assetGenerationServiceClient) GenerateText(ctx context.Context, in *GenerateTextRequest, opts ...grpc.CallOption) (*GenerateTextResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v23.services.AssetGenerationService/GenerateText", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *assetGenerationServiceClient) GenerateImages(ctx context.Context, in *GenerateImagesRequest, opts ...grpc.CallOption) (*GenerateImagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v23.services.AssetGenerationService/GenerateImages", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AssetGenerationService_GenerateText_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v23.services.AssetGenerationService/GenerateText",
	}
...
func _AssetGenerationService_GenerateImages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v23.services.AssetGenerationService/GenerateImages",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
