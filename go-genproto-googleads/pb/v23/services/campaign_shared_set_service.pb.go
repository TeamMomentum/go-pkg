...
func (x *MutateCampaignSharedSetsRequest) Reset() {
	*x = MutateCampaignSharedSetsRequest{}
	mi := &file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_msgTypes[0]
...
func (*MutateCampaignSharedSetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CampaignSharedSetOperation) Reset() {
	*x = CampaignSharedSetOperation{}
	mi := &file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CampaignSharedSetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCampaignSharedSetsResponse) Reset() {
	*x = MutateCampaignSharedSetsResponse{}
	mi := &file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignSharedSetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCampaignSharedSetResult) Reset() {
	*x = MutateCampaignSharedSetResult{}
	mi := &file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCampaignSharedSetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v23_services_campaign_shared_set_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDescData = file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDesc
)

func file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDescData)
	})
	return file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDescData
}

var file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_goTypes = []any{
...
var file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_init() }
func file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_init() {
	if File_google_ads_googleads_v23_services_campaign_shared_set_service_proto != nil {
		return
	}
	file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v23_services_campaign_shared_set_service_proto = out.File
	file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_rawDesc = nil
	file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_goTypes = nil
	file_google_ads_googleads_v23_services_campaign_shared_set_service_proto_depIdxs = nil
}
...
func (c *campaignSharedSetServiceClient) MutateCampaignSharedSets(ctx context.Context, in *MutateCampaignSharedSetsRequest, opts ...grpc.CallOption) (*MutateCampaignSharedSetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v23.services.CampaignSharedSetService/MutateCampaignSharedSets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CampaignSharedSetService_MutateCampaignSharedSets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v23.services.CampaignSharedSetService/MutateCampaignSharedSets",
	}
