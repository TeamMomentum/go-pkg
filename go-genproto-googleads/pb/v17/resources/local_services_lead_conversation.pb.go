...
func (x *LocalServicesLeadConversation) Reset() {
	*x = LocalServicesLeadConversation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_msgTypes[0]
...
func (*LocalServicesLeadConversation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDescGZIP(), []int{0}
}
...
func (x *PhoneCallDetails) Reset() {
	*x = PhoneCallDetails{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PhoneCallDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDescGZIP(), []int{1}
}
...
func (x *MessageDetails) Reset() {
	*x = MessageDetails{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MessageDetails) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDescGZIP(), []int{2}
}
...
var file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDescData = file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDesc
)

func file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDescData)
	})
	return file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDescData
}

var file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_goTypes = []any{
...
var file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_depIdxs = []int32{
...
func init() { file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_init() }
func file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_init() {
	if File_google_ads_googleads_v17_resources_local_services_lead_conversation_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v17_resources_local_services_lead_conversation_proto = out.File
	file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_rawDesc = nil
	file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_goTypes = nil
	file_google_ads_googleads_v17_resources_local_services_lead_conversation_proto_depIdxs = nil
}
