...
func (x *AndroidPrivacySharedKeyGoogleCampaign) Reset() {
	*x = AndroidPrivacySharedKeyGoogleCampaign{}
	if protoimpl.UnsafeEnabled {
		mi := &file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_msgTypes[0]
...
func (*AndroidPrivacySharedKeyGoogleCampaign) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_rawDescGZIP(), []int{0}
}
...
var file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_rawDesc = []byte{
...
var (
	file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_rawDescData = file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_rawDesc
)

func file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_rawDescData = protoimpl.X.CompressGZIP(file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_rawDescData)
	})
	return file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_rawDescData
}

var file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_goTypes = []any{
...
var file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_depIdxs = []int32{
...
func init() {
	file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_init()
}
func file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_init() {
	if File_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_goTypes,
	...
	File_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto = out.File
	file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_rawDesc = nil
	file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_goTypes = nil
	file_google_ads_googleads_v17_resources_android_privacy_shared_key_google_campaign_proto_depIdxs = nil
}
