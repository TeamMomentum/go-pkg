...
var file_google_ads_googleads_v17_common_value_proto_goTypes = []any{
...
func file_google_ads_googleads_v17_common_value_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_common_value_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Value); i {
			case 0:
				return &v.state
			case 1:
	...
	file_google_ads_googleads_v17_common_value_proto_msgTypes[0].OneofWrappers = []any{
