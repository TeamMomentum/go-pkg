...
var file_google_ads_googleads_v17_common_criterion_category_availability_proto_goTypes = []any{
...
func file_google_ads_googleads_v17_common_criterion_category_availability_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_common_criterion_category_availability_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v17_common_criterion_category_availability_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v17_common_criterion_category_availability_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	file_google_ads_googleads_v17_common_criterion_category_availability_proto_msgTypes[1].OneofWrappers = []any{}
	file_google_ads_googleads_v17_common_criterion_category_availability_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
