...
var file_google_ads_googleads_v17_common_custom_parameter_proto_goTypes = []any{
...
func file_google_ads_googleads_v17_common_custom_parameter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_common_custom_parameter_proto_msgTypes[0].Exporter = func(v any, i int) any {
	...
	file_google_ads_googleads_v17_common_custom_parameter_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
