...
var file_google_ads_googleads_v17_services_identity_verification_service_proto_goTypes = []any{
...
func file_google_ads_googleads_v17_services_identity_verification_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_services_identity_verification_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v17_services_identity_verification_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v17_services_identity_verification_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v17_services_identity_verification_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v17_services_identity_verification_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_google_ads_googleads_v17_services_identity_verification_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	file_google_ads_googleads_v17_services_identity_verification_service_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
