...
var file_google_ads_googleads_v17_enums_target_frequency_time_unit_proto_goTypes = []any{
...
func file_google_ads_googleads_v17_enums_target_frequency_time_unit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_enums_target_frequency_time_unit_proto_msgTypes[0].Exporter = func(v any, i int) any {
