...
var file_google_ads_googleads_v17_enums_asset_performance_label_proto_goTypes = []any{
...
func file_google_ads_googleads_v17_enums_asset_performance_label_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_enums_asset_performance_label_proto_msgTypes[0].Exporter = func(v any, i int) any {
