...
var file_google_ads_googleads_v17_enums_asset_link_primary_status_proto_goTypes = []any{
...
func file_google_ads_googleads_v17_enums_asset_link_primary_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_enums_asset_link_primary_status_proto_msgTypes[0].Exporter = func(v any, i int) any {
