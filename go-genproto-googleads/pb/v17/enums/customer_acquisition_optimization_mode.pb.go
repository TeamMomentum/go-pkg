...
var file_google_ads_googleads_v17_enums_customer_acquisition_optimization_mode_proto_goTypes = []any{
...
func file_google_ads_googleads_v17_enums_customer_acquisition_optimization_mode_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_ads_googleads_v17_enums_customer_acquisition_optimization_mode_proto_msgTypes[0].Exporter = func(v any, i int) any {
